...
game.import('character', function (lib, game, ui, get, ai, _status) {
	const QQQ = {
		...
		translate: {
			...
			txhj_shiyuan: '尸怨',
			txhj_shiyuan_info: '锁定技,你造成的伤害+1;当你进入濒死状态时,你死亡;你击杀的角色复活为【长怨尸兵】并加入你的阵营.',
			txhj_zhuhun: '注魂',
			...
			txhj_beiming: '悲鸣',
			txhj_beiming_info: '锁定技,你死亡时,击杀你的角色弃置所有手牌.',
			txhj_kuangbao: '狂暴',
			txhj_add: '狂暴',
			txhj_clear: '狂暴',
			...
			diychunxiao: '春晓',
			//"diychunxiao_info":"你的回合结束时,你若为受伤状态,额外有50%的几率回复至满体力值.",
			diycuidu: '淬毒',
			...
			txleizhen: '震雷',
			txleizhen_info: '锁定技,你死亡时,击杀你的角色受到1点无来源的雷属性伤害.',
			txxiebi: '邪庇',
			...
			/*部分装备技能转普通技能*/
			txfeilong: '飞龙',
			txfeilong_info: '当你击杀角色后,若对局未结束,你令其复活成为你的队友并将体力和体力上限调整至3.',
			txshenfu: '神符',
			...
			lvbuwei_baixiang: '拜相',
			lvbuwei_baixiang_info: '觉醒技,你的回合开始时,若你的手牌数大于等于你当前体力的3倍,则你将体力回复至体力上限,并获得<仲父>技能.',
			lvbuwei_zhongfu: '仲父',
