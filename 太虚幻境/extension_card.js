...
game.import('card', function (lib, game, ui, get, ai, _status) {
    const txhj_cardPack = {
        ...
        translate: {
            ...
            txhj_feilong: '飞龙夺凤',
            txhj_feilong_info: `当你击杀角色后,若对局未结束,你令其复活成为你的队友并将体力和体力上限调整至3.<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img style=width:63px src=extension/太虚幻境/image/buff/buff_txhj_pozhenzhifeng.png><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style='font-family: shousha;text-align: center'>破阵之锋</span><br><span class='bluetext' style='color:gold'>出牌阶段,若你的装备区内有武器牌,敌方角色的防具无效.</span>`,
