...
const skillTranslation = {
	...
	PSsp_shadiao: '鲨雕',
	PSsp_shadiao_info: '你可以弃置X张花色不同的牌视为使用或打出任意即时牌(X为此技能发动的次数).当X=4时,你可以摸两张牌,重置X的发动次数.锁定技,当X>4时,你对所有其他角色各造成1点伤害并摸造成伤害数的牌,重置X的发动次数.',
	PSsp_echou: '恶臭',
	PSsp_echou_info: '当你造成伤害时,你可以将伤害值改为999.',
	PSsp_echou_1: '恶臭·升级',
	PSsp_echou_1_info: '当你造成伤害时,你可以将伤害值改为999,令目标角色的非锁定技和防具失效,直到伤害结算完毕.',
	PSsp_juexing: '撅醒',
