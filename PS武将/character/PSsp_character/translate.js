...
const skillTranslation = {
	...
	PSsp_shadiao: "鲨雕",
	PSsp_shadiao_info:
		"你可以弃置X张花色不同的牌视为使用或打出任意即时牌(X为此技能发动的次数).当X=4时,你可以摸两张牌,重置X的发动次数.锁定技,当X>4时,你对所有其他角色各造成1点伤害并摸造成伤害数的牌,重置X的发动次数.",
	PSsp_echou: "恶臭",
	PSsp_echou_info: "当你造成伤害时,你可以将伤害值改为999.",
	PSsp_echou_1: "恶臭·升级",
	PSsp_echou_1_info:
		"当你造成伤害时,你可以将伤害值改为999,令目标角色的非锁定技和防具失效,直到伤害结算完毕.",
	PSsp_juexing: "撅醒",
	PSsp_juexing_info:
	...
	PSsp_mingshu: "命数",
	PSsp_mingshu_info: "狐狸技,当你即将受到伤害时,你可以获得一枚<屑>标记,并防止此次伤害.你的回合结束时,你移去所有的<屑>标记并弃置X张牌,若你弃置的牌数不足X,你失去Y点体力(X为<屑>标记数,Y为X与弃置牌数之差).",
	PSsp_jiuming: "九命",
	PSsp_jiuming_info: "限定技,当你进入濒死状态时,你可以移去所有的<屑>标记并弃置所有手牌,增加一点体力上限,回复所有体力并摸三张牌.",
}
