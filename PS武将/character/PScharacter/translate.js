...
const skillTranslation = {
	...
	PSlingbao: '凌暴',
	PSlingbao_info: '每阶段限一次,当你于出牌阶段内使用♣️️或♠️️牌时,若此牌花色与你于此阶段使用的上一张牌花色相同,你可以令此牌额外结算一次.',
	PSjiuchi: '酒池',
	PSjiuchi_info: '你可以将一张♠️️牌当【酒】 使用,你使用【酒】无次数限制.',
	PSzongyu: '纵欲',
	...
	PSleiji: '雷击',
	PSleiji_info: '当一名角色使用或打出一张【闪】时,你可令一名其他角色进行一次判定:若结果为♣️️,其受到一点雷电伤害,你回复一点体力;若结果为♠️️,其受到两点雷电伤害.',
	PSqiangxi: '强袭',
	...
	PSshenwu: '神武',
	PSshenwu_info: '锁定技,你的♥️️牌均视为【桃】;你的【桃】可以对其他角色使用.',
	PShunwu: '魂武',
	...
	PSluoying: '落英',
	PSluoying_info: '锁定技:你立即获得任何方式进入弃牌堆的♣️️牌(自己的牌除外),以此法获得牌不计入手牌上限.',
	PSbaiban: '白板',
	...
	PSdingjun: '定军',
	PSdingjun_info: '每当你使用【杀】指定唯一目标时,你根据此【杀】的花色获得以下效果:<br/>♠️️,此【杀】伤害＋X ;<br/>♣️️,本回合使用【杀】次数＋X ;<br/>♦️️,摸X张牌;<br/>♥️️,获得X点护甲;<br/>X为此【杀】的点数.',
	PShuishi: '慧识',
	...
	PSwusheng: '武圣',
	PSwusheng_info: '你可以将一张红色牌当做【杀】使用或打出.你使用的♦️️杀没有距离限制且可以获得对方一张牌;你使用的♥️️杀造成伤害+1,且目标需要连续使用两张【闪】才能抵消.',
	PSmashu: '马术',
