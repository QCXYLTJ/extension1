...
const skillTranslation = {
	PSshelian: '奢敛',
	PSshelian_info: '出牌阶段限一次,你可以展示至少1张手牌,亮出牌堆顶至多8张牌,对比其中的花色数:若展示牌的花色数大于亮出牌的花色数,你摸X张牌(X为此次亮出的牌数);否则,你失去一点体力.',
	PSjixi: '觊玺',
	PSjixi_info: '觉醒技,结束阶段,若你连续三回合没有因〖奢敛〗而失去过体力,则你增加1点体力上限并回复1点体力,选择一项:获得技能〖妄尊〗:摸两张牌并获得当前主公的主公技.',
	PSshen_huashen: '化身',
	PSshen_huashen_info: '游戏开始时,你将剩余武将牌堆的两张牌置于武将牌上,称为<魂>,你可将一张<魂>作为你的表象武将展示;若表象角色未阵亡,则回合开始前或回合结束后,你可以用一张其他<魂>替换表象角色;若表象角色已阵亡,你可以展示一张武将牌上的<魂>并将其置入剩余武将牌堆,视为使用一张本回合内未以此法使用过的基本牌或普通锦囊牌.',
	PSshen_jihun: '汲魂',
	PSshen_jihun_info: '当[你受到伤害后],或[其他角色脱离濒死状态后],你可以将剩余武将牌堆的一张牌置于武将牌上,称为<魂>',
	PSshen_xinsheng: '新生',
	PSshen_xinsheng_info: '锁定技,当你即将阵亡时,你须选择一项:①将表象角色置入剩余武将牌堆,并变为本体武将;②删去〖汲魂〗第一个获得<魂>的途径;③删去〖汲魂〗第二个获得<魂>的途径.终止阵亡结算并回复体力至剩余选项数+1.',
	PSwushuang: '无双',
	PSwushuang_info: '锁定技.①若你有空置的武器栏,则视为你装备【无双方天戟】.②当你使用【杀】或【决斗】指定目标后,你令此牌需要依次使用或打出两张【闪】或【杀】响应.',
	PSbaifu: '拜父',
	PSbaifu_info: '当你对一名其他角色A造成伤害时,若其不是<义父>,你可以防止此伤害.若如此做,你对场上的<义父>B造成一点伤害并移去B的<义父>标记,你获得A的一张牌并令A获得<义父>标记.',
	'#PSbaifu1': '公若不弃,布愿拜为义父.',
	'#PSbaifu2': '飘零半生,只恨未逢明主.',
	PSpanshi: '叛弑',
	PSpanshi_info: '锁定技.①当<义父>于一回合内首次使用伤害类牌前,若你不是此牌的唯一目标,此牌的目标排除你.若你满足使用此牌的合法性,你成为此牌的使用者.②当你对<义父>造成伤害时,此伤害+1.',
	PSqianxun: '谦逊',
	PSqianxun_info: '锁定技,你不能成为【过河拆桥】、【顺手牵羊】和延时锦囊牌的目标.',
	PSlianying: '连营',
	PSlianying_info: '当你使用或打出牌时,你可以摸X张牌(X为4-你的手牌花色数).',
	PShuaiju: '怀橘',
	PShuaiju_info: '锁定技,游戏开始时,你获得3个<橘>标记.(有<橘>的角色受到伤害时,防止此伤害,移去一个<橘>;有<橘>的角色摸牌时额外摸其拥有的<橘>标记数张牌)',
	PSzhenglun: '整论',
	PSzhenglun_info: '你可以跳过摸牌阶段获得一个<橘>.',
	PSzhuiming: '追命',
	PSzhuiming_info: '当你使用【杀】指定距离为1的目标时,你可以令目标角色选择一项:1.此【杀】令其防具无效、不可响应且对其造成伤害+1;2.其获得此【杀】对应的实体牌,你获得其两张牌.',
	PSjinge: '金戈',
	PSjinge_info: '锁定技,你计算与其他角色的距离时-2.你的牌名数为2的牌均视为不计入次数且无次数限制【杀】.',
	PStieji: '铁骑',
	PStieji_info: '当你使用【杀】指定其他角色为目标后,你可以令目标角色不能响应此【杀】,且其非锁定技失效直到回合结束.你与其进行谋弈.<br>若你赢,你本回合使用的【杀】次数上限+1,且其非锁定技失效的效果延续至其回合结束.你选择的选项为:<直取敌营>,则你获得其一张牌:<扰阵疲敌>,你摸两张牌.<br>若你没赢,你可以执行你选择的另一项,若如此做,你本回合对其发动此技能时不能与其进行谋弈.',
	PScema: '策马',
	...
	PSdangxian: '当先',
	PSdangxian_info: '锁定技,回合开始时,你执行一个额外的摸牌阶段和出牌阶段.摸牌阶段和出牌阶段开始时,你从牌堆中获得一张不计入手牌上限【杀】并记录之.结束阶段,若你有<当先>记录过的杀,弃置之并失去X点体力,视为使用一张伤害类锦囊牌.(X为<当先<记录过的杀的数量)',
	PSfuli: '伏枥',
	PSfuli_info: '每轮限一次,当你处于濒死状态时,你可以减一点体力上限并弃置<当先>记录过的【杀】,再将体力回复至体力上限,随机抽取五张武将牌并获得其中一个技能.最后若你的武将牌正面朝上,你翻面.',
	PSshiming: '拾命',
	...
	PSbaiyin: '拜印',
	PSbaiyin_info: '觉醒技,当你因〖忍戒〗获得技能后,若你拥有〖忍戒〗的所有衍生技,你减1点体力上限,失去技能〖忍戒〗,获得〖连破〗.',
	PSxujin: '蓄劲',
	PSxujin_info: '锁定技,若X:<br>不小于1,你使用【杀】无距离限制;<br>不小于2,你使用【杀】不可被响应;<br>不小于3,你使用【杀】造成伤害+Y.<br>当你使用【杀】结算后,若X不小于4,你将手牌摸至体力上限,记录Z为此时本回合使用过的牌数,本回合X修改为本回合使用过的牌数-Z. (X为本回合使用过的牌数,Y为本回合使用过的花色数-1)',
	PSrepaoxiao: '咆哮',
	...
	PSlingbao: '凌暴',
	PSlingbao_info: '每阶段限一次,当你于出牌阶段内使用♣️️️或♠️️️牌时,若此牌花色与你于此阶段使用的上一张牌花色相同,你可以令此牌额外结算一次.',
	PSjiuchi: '酒池',
	PSjiuchi_info: '你可以将一张♠️️️牌当【酒】 使用,你使用【酒】无次数限制.',
	PSzongyu: '纵欲',
	PSzongyu_info: '锁定技,①当一名女性角色受到伤害后,你获得其一张牌.②结束阶段,若场上有存活的女性角色,你须减一点体力或体力上限.',
	PSdangkou: '荡寇',
	PSdangkou_info: '出牌阶段限一次,你可以选择一项:1.失去一点体力并增加一点体力上限,视为使用一张【杀】(不计入使用次数);2.回复一点体力并减一点体力上限,摸两张牌.',
	PSbaima: '白马',
	...
	PShanzhan: '酣战',
	PShanzhan_info: '每回合限一次,当一名角色进入濒死状态时,你可以弃置至多两张牌,回复等量的装备栏,你将手牌摸至4张.',
	PSlongwei: '龙威',
	...
	PSqingbei: '擎北',
	PSqingbei_info: '一轮游戏开始时,你可以选择任意种花色.你本轮使用牌后,若此牌的花色与你以此法选择花色均不相同,你摸X张牌,否则你须弃置X张牌(X为你本轮以此法选择过的花色数).',
	PStunchu: '屯储',
	PStunchu_info: '①锁定技,游戏开始时,你摸两张牌,将两张手牌置于武将牌上,称为「粮」;<br/>②摸牌阶段,你额外摸X张牌,你的手牌上限+X(X为你的「粮」数);<br/>③摸牌阶段结束时,若你的<粮>数不大于Y,你可以将至多Y张手牌置于武将牌上(Y为你的体力上限,且至多为3).',
	PSshuliang: '输粮',
	PSshuliang_info: '一名角色的结束阶段开始时,若其手牌数少于手牌上限,你可以移去一张「粮」,该角色摸两张牌.',
	PSxionghuo: '凶镬',
	...
	PSshajue: '杀绝',
	PSshajue_info: '锁定技,其他角色进入濒死状态时,你获得一个<暴戾>标记.若其体力值小于0,你获得使其进入濒死状态的牌.',
	PSreqianxun: '谦逊',
	PSreqianxun_info: '每当一张延时类锦囊牌或其他角色使用的普通锦囊牌生效时,若你是此牌的唯一目标,你可以将所有手牌置于你的武将牌上,你可以如手牌般使用或打出以此法置于武将牌上的牌.若如此做,此回合结束时,你获得你武将牌上的所有牌.',
	PSrelianying: '连营',
	PSrelianying_info: '①当你失去最后的手牌时,你可以令至多X名角色各摸一张牌(X为你此次失去的手牌数).<br>②当你使用或打出牌后,你可以弃置当前回合角色一张手牌,摸一张牌.',
	PSjushou: '据守',
	PSjushou_info: '一名角色回合开始时或当你需要使用非延时锦囊牌时,若你的武将牌正面朝上,你可以翻面并视为你使用一张你需要的非延时锦囊牌.当你翻面后,你可以弃置一张牌选择:1．回复一点体力:2．移动场上一张牌.',
	PSbianzhen: '变阵',
	PSbianzhen_info: '锁定技,当你受到伤害后,若你的手牌数:不大于X,你摸X张牌;不小于X,你摸1张牌(X为你的体力上限).若你的武将牌背面朝上,你翻面.',
	PStishen: '替身',
	PStishen_info: '锁定技,准备阶段开始时,你获得一张点数随机、花色随机、包含所有属性的【杀】,你将此【杀】添加<替身>标记.当你失去一张<替身牌>后,你回复1点体力并摸两张牌.你的手牌上限+X(X为你拥有的<替身牌>数量).',
	PSrende: '仁德',
	PSrende_info: '出牌阶段,你可以令一名角色将至少一张手牌交给由你指定的其他角色,本阶段你不能再对该角色发动〖仁德〗;若其交出的牌不少于两张,其可以视为使用一张基本牌.',
	PSdujin: '独进',
	...
	PSpingnan: '平南',
	PSpingnan_info: '出牌阶段限一次,你可以对至多三名角色造成1点伤害,获得其中一名角色区域内的一张牌.',
	PShuoshou: '祸首',
	...
	PSshixian_ze: '仄',
	PSliangzhu: '良助',
	PSliangzhu_info: '当一名角色回复体力后,你可以摸一张牌,你可以弃置一张牌令其摸两张牌.',
	PSfanxiang: '返乡',
	PSfanxiang_info: '觉醒技,准备阶段开始时,若场上有已受伤且你发动过〖良助〗令其摸牌的角色,则你选择一项:1.增加一点体力上限并回复一点体力;2.获得技能〖枭姬〗;3.背水:失去技能〖良助〗,依次执行上述所有选项.',
	PSzongheng: '纵横',
	...
	PSchengchen: '称臣',
	PSchengchen_info: '觉醒技,当你击杀一名角色后,你将所有手牌交给一名其他<魏>势力角色,将势力改为<魏>,失去技能〖纵横〗,获得技能〖制衡〗.',
	PSjiuxian: '酒仙',
	...
	PSpaiyi_backup: '权术',
	PSquanshu: '权术',
	PSquanshu_info: '当你造成或受到伤害后,你可以摸Y张牌,将一张手牌置于你的武将牌上,称为<权>,你的手牌上限+Z(Y为你已损失的体力值,Z为<权>的数量).',
	PSpaiyi: '排异',
	PSpaiyi_info: '出牌阶段限一次,你可以移去一张<权>并令一名角色摸Z张牌,其对至多Z名角色各造成1点伤害(Z为<权>的数量且至少为1)',
	PSjuanjia: '捐甲',
	PSjuanjia_info: '锁定技,游戏开始时,你废除一个宝物栏、防具栏、攻击马栏和防御马栏,获得等量的额外武器栏.',
	PSbolan: '博览',
	PSbolan_info: '锁定技,摸牌阶段,你改为摸与你体力值相等的牌,你记录本次以此法摸的牌为X,你获得X-2个<识>标记.每有一个<识>,你的手牌上限+1,计算与其他角色的距离-1.准备阶段,若你的<识>不小于5,你获得〖攻心〗.',
	PSgongxin: '攻心',
	PSgongxin_info: '转换技,出牌阶段限一次.阳:你可以观看一名其他角色的手牌,获得其中任意张花色相同的牌.阴:你可以观看一名其他角色的手牌,选择获得其中任意张花色不同的牌.每以此法获得一张牌,你移去一个<识>.结束阶段,若你的<识>小于5,你失去〖攻心〗.',
	PSyuheng: '驭衡',
	PSyuheng_info: '①回合开始时,你可以弃置任意张花色不同的牌,摸等量的牌并获得等量吴势力的技能.②回合结束时,你可以选择失去任意个因〖驭衡①〗获得的技能,摸等量的牌.',
	PSdili: '帝力',
	PSdili_info: '觉醒技,当你因〖驭衡①〗获得的技能数大于你的体力上限时,你失去技能〖驭衡〗,获得技能〖圣质〗、〖权道〗、〖持纲〗.',
	PSfenyin: '奋音',
	...
	PSshuangquan: '双全',
	PSshuangquan_info: '锁定技.<br/>①你视为拥有技能〖马术〗〖飞影〗和〖无双〗.<br/>②你使用【杀】可以额外指定一名目标.<br/>③你造成的所有伤害翻倍,你受到的所有伤害减半(向上取整).<br/>④你拥有双倍的初始手牌.摸牌阶段,你额外摸等量的牌.<br/>⑤你使用牌后,额外使用对应实体卡牌(不嵌套触发).<br/>⑥当你不因此技能获得的回合结束后,你执行一个额外的回合.<br/>⑦限定技,当你即将阵亡时,终止此次结算,你将体力上限调整为8,再将体力值回复至体力上限.<br/>⑧游戏开始时,你获得等量的装备区副类别栏.<br/>⑨你回复体力时,回复效果翻倍.<br/>⑩你使用【铁索连环】时可额外指定两名目标,使用单体普通锦囊牌时可额外指定一名目标.',
	PSpojun: '破军',
	...
	PSleiji: '雷击',
	PSleiji_info: '当一名角色使用或打出一张【闪】时,你可令一名其他角色进行一次判定:若结果为♣️️️,其受到一点雷电伤害,你回复一点体力;若结果为♠️️️,其受到两点雷电伤害.',
	PSqiangxi: '强袭',
	PSqiangxi_info: '出牌阶段限两次.你可以弃置一张武器牌或受到1点无来源伤害,对一名本回合内未成为过〖强袭〗目标的其他角色造成X点伤害.(X为你本局游戏发动此技能的次数)',
	PSsizhan: '死战',
	PSsizhan_info: '使命技.①每回合限一次,当你受到伤害时,若你本局发动过〖强袭〗的次数不为0,你可以令此伤害-1,本局游戏〖强袭〗发动次数-1.②使命:击杀一名角色.③成功:你减2点体力上限,获得技能〖不屈〗和〖绝境〗.④失败:当你于使命达成前进入濒死状态,你将体力值回复至体力上限,重置〖强袭〗的发动次数.',
	PSranshang: '燃伤',
	...
	PSjiwei: '继位',
	PSjiwei_info: '锁定技,当你对主公使用【杀】造成伤害后,若你的身份不是主公,你与主公交换身份,增加一点体力上限并回复一点体力.',
	PSqiaobian: '巧变',
	PSqiaobian_info: '你可以摸一张牌并跳过自己的一个阶段(准备阶段和结束阶段除外);若你以此法跳过了摸牌阶段,则你可以获得至多两名其他角色的各一张手牌;若你以此法跳过了出牌阶段,则你可以移动场上的一张牌.',
	PSkurou: '苦肉',
	PSkurou_info: '出牌阶段,你可以弃置一张牌,失去1点体力.',
	PSpingjian: '评荐',
	PSpingjian_info: '准备阶段开始时/摸牌阶段开始时/结束阶段开始时/当你受到伤害后/当你进入濒死状态时/出牌阶段限一次,你可以令系统随机从剩余武将牌堆中检索出三张拥有发动时机为准备阶段开始时/摸牌阶段开始时/结束阶段开始时/当你受到伤害后/进入濒死状态时/出牌阶段的技能的武将牌.你可以选择尝试发动其中一个技能.每个技能每局只能选择一次.',
	PSqianju: '千驹',
	...
	PSqixing: '七星',
	PSqixing_info: '游戏开始时/准备阶段开始时,若你的<星>少于7,你将牌堆顶的牌至于你的武将牌上,称之为<星>,你的<星>至多为7./摸牌阶段结束后,你可用任意数量的手牌等量交换这些<星>.',
	PSkuangfeng: '狂风',
	...
	PSjizhi: '集智',
	PSjizhi_info: '锁定技,当你使用字数不小于3的牌时,你展示牌堆顶两张牌,获得其中字数较多的一张,若字数相同则改为随机获得其中一张,将其余的牌置入弃牌堆.',
	PSqicai: '奇才',
	PSqicai_info: '锁定技,你使用字数不小于2的牌无距离限制,使用字数不小于1的牌无次数限制,你的手牌上限+X.(X为本回合不因使用而进入弃牌堆的牌数)',
	PSjieying: '劫营',
	PSjieying_info: '回合开始时,若场上没有拥有<营>标记的角色,你获得1个<营>标记;结束阶段,你可以将你的一个<营>标记交给一名角色;有<营>标记的角色摸牌阶段多摸一张牌,出牌阶段使用【杀】的次数上限+1,手牌上限+1.有<营>的其他角色出牌阶段开始时,其移去<营>标记,你获得其所有手牌.',
	PSfushi: '扶世',
	PSfushi_info: '结束阶段开始时,你可以移去所有<梅影>标记并摸等量张牌,从8张武将牌中选择并获得至多3个技能.若此时你是体力值最低的角色,你回复1点体力.',
	// "PSfushi_append": '<span style="font-family: yuanli">开启扩展<天牢令>体验更佳</span>',
	PSdunshi: '遁世',
	PSdunshi_info: '每回合限一次.你可以视为使用或打出一张即时牌,当前回合角色于本回合内下一次造成伤害时,你选择两项:<br/>⒈防止此伤害.系统从技能描述中包含<出牌/受伤/结束>字样的技能中随机选择4个其未拥有的技能,你令当前回合角色获得其中一个技能.<br/>⒉从〖遁世〗中删除你本次使用或打出的牌并获得一个<席>.<br/>⒊减1点体力上限并摸X张牌(X为你的<席>数).',
	PSjueyan: '决堰',
	PSjueyan_info: '出牌阶段限一次,你可以废除一种装备栏,执行对应一项:武器栏,你使用【杀】的次数上限+3;防具栏,你摸三张牌,且手牌上限+3;坐骑栏,你使用牌无距离限制;宝物栏,你获得〖集智〗.',
	PSjuece: '绝策',
	PSjuece_info: '出牌阶段,你可以弃置一张【火杀】或【火攻】,重置技能〖焚城〗.结束阶段,你可以对一名本回合内失去过牌的角色造成1点伤害.',
	PSkangkai: '慷慨',
	PSkangkai_info: '当一名角色成为伤害类牌的目标后,你可以摸一张牌.若如此做,你选择一名除其外的角色,除非该角色交一张牌给对方,否则失去一点体力.若交出的是装备牌,该角色可以使用此牌.',
	PSjiwu: '极武',
	PSjiwu_info: '出牌阶段,你可以弃置一张牌,选择获得【强袭】、【铁骑】、【旋风】、【完杀】中的一项技能直到回合结束.',
	PSshenqu: '神躯',
	...
	PShuashen: '化身',
	PShuashen_info: '①游戏开始时,你随机获得三张未加入游戏的武将牌(均称为<化身牌>),你选择一项:1、制衡化身:弃置至多两张化身牌并获得等量+1张化身牌;2、更换技能:移除上次因化身获得的所有技能(若有),重新挑选化身牌上的至多三个技能.准备阶段或回合结束阶段开始时,你可以选择<制衡化身>或<更换技能>.<br/>②出牌阶段限一次,你可以将性别和势力改为与一张<化身牌>相同.',
	PSxinsheng: '新生',
	...
	PSzanhe: '暂和',
	PSzanhe_info: '①你于回合内使用牌或于回合外失去牌后,可以重铸两张牌;<br/>②你每阶段使用杀的次数＋5且目标＋1,你使用普通锦囊牌时目标可以指定任意名角色;<br/>③每轮结束时,若你击杀过其他角色,则你须流失一点体力或弃置两张牌.',
	PSshengshi: '盛世',
	PSshengshi_info: '锁定技,每当有角色回复体力后,若场上没有处于濒死状态的角色,你令每名角色失去一点体力并弃置其一张牌(若其没有牌,则改为其失去一点体力).',
	PSluanshi: '乱世',
	PSluanshi_info: '锁定技,每当你成为伤害类牌的目标后,展示并弃置牌堆顶三张牌,若点数之和:<br/>① 大于21,你回复一点体力;<br/>②等于21 ,你流失一点体力;<br/>③小于21,你令来源承受此效果.',
	PSshanrang: '禅让',
	...
	PSshenwu: '神武',
	PSshenwu_info: '锁定技,你的♥️️️牌均视为【桃】;你的【桃】可以对其他角色使用.',
	PShunwu: '魂武',
	...
	PSxiantu: '献图',
	PSxiantu_info: '一名其他角色的出牌阶段开始时,你可以摸两张牌,交给其一张牌,再获得其两张牌.若如此做,此阶段结束时,若该角色未于此阶段内击杀过角色,则你失去1点体力.',
	PShengzhi: '衡制',
	PShengzhi_info: '出牌阶段限X次,你可以摸你手牌区和装备区牌数量的牌,弃置等量的牌.(X为你已损失的体力值且至少为1)',
	PSnengwan: '能玩',
	...
	PSyuqi: '隅泣',
	PSyuqi_info: '每回合限三次.当有角色受到伤害后,若你至其的距离不大于<span class=thundertext>0</span>,则你可以观看牌堆顶的<span class=firetext>3</span>张牌.你将其中至多<span class=greentext>1</span>张牌交给受伤角色,可以获得剩余牌中的至多<span class=yellowtext>1</span>张牌,并将其余牌以原顺序放回牌堆顶.',
	PSshanshen: '善身',
	PSshanshen_info: '当有角色死亡时,你可令你的〖隅泣〗中的所有数字+2.若你未对该角色造成过伤害,则你回复1点体力.',
	PSxianjing: '娴静',
	...
	PSreshanjia: '缮甲',
	PSreshanjia_info: '出牌阶段开始时,你可以摸3张牌,弃置3张牌,若弃置的牌包含:基本牌,视为对一名角色使用一张【杀】(无距离限制且不计入次数);锦囊牌,视为使用一张不能被无懈的普通锦囊牌;装备牌,<缮甲>摸牌数+1.',
	PSxiaorui: '骁锐',
	PSxiaorui_info: '出牌阶段限一次,你可以失去一点体力获得一名角色两张牌并对其造成一点伤害,若获得牌中有装备你回复一点体力.',
	PSshanjia: '缮甲',
	PSshanjia_info: '出牌阶段开始时,你可以摸三张牌,弃置3-X张牌(X为你本局游戏内不因使用而失去过的装备牌的数目且至多为3).若你没有以此法弃置延时锦囊牌,则你可以视为使用了一张无距离限制且不计入出牌阶段使用次数且无视防具的【杀】,若此杀造成伤害,本局游戏<缮甲>摸牌数和伤害+1.',
	PStuogu: '托孤',
	PStuogu_info: '一名角色死亡时,你可以获得其武将牌上的一个技能.',
	PSjiushi: '酒诗',
	PSjiushi_info: '锁定技,你永久处于喝酒状态,你可以将一张牌当『酒』使用,你使用『酒』无次数限制',
	PSluoying: '落英',
	PSluoying_info: '锁定技:你立即获得任何方式进入弃牌堆的♣️️️牌(自己的牌除外),以此法获得牌不计入手牌上限.',
	PSbaiban: '白板',
	...
	PSbb_yinghun: '英魂',
	PSbb_yinghun_info: '准备阶段开始时,你可令一名角色执行一项:摸X张牌,弃置一张牌;或摸一张牌,弃置X张牌(X为你的体力上限).',
	PSmiewu: '灭吴',
	PSmiewu_info: '每回合限一次,你可以将一张牌当做任意一张基本牌或锦囊牌使用或打出,你摸一张牌.',
	PSqiyang: '弃养',
	...
	PSmn_paiyi: '排异',
	PSmn_paiyi_info: '出牌阶段限X次,你可以移去一张<权>并选择一名角色,令其摸两张牌,若其手牌数大于你,你对其造成1伤害.(X为场上与你距离不大于1的角色数)',
	PSjiufa: '九伐',
	...
	PSbaguan1: '霸关',
	PSbaguan1_info: '锁定技,你的初始手牌数为8,游戏开始时,你将四张虎牢关专属装备置入牌堆,每名角色回合结束后,你执行一个额外回合,你无法因此连续行动两个回合.当你的体力值不大于已损失体力值/游戏第二轮开始时/你将要阵亡时,终止阵亡结算,选择将武将牌替换为<暴怒战神>、<神鬼无前>或<炼狱修罗>,将体力值和体力上限调整为6并立即开始你的回合.',
	PSaozhan1: '鏖战',
	PSaozhan1_info: '锁定技,若你装备区内有:武器牌,你可以多使用一张【杀】;防具牌,你受到的伤害始终为一;坐骑牌,摸牌阶段多摸一张牌;宝物牌,跳过你的判定阶段,且你无法被翻面.',
	PSshenwei2: '神威',
	PSshenwei2_info: '锁定技,判定阶段,若你的判定区有牌,则你须弃置两张牌,弃置自己判定区内的所有牌;摸牌阶段,你额外摸三张牌,你的手牌上限为你的体力上限.',
	PSshenji2: '神戟',
	PSshenji2_info: '出牌阶段限两次,你可以弃置一张牌,获得未拥有的一项效果直到回合结束:<br/>一、使用【杀】可以额外指定两名目标.<br/>二、使用【杀】无距离限制,且次数+1.<br/>三、使用【杀】造成伤害+1.<br/>四、使用【杀】指定目标时,目标须弃置一张牌.',
	PSshenzhu: '神铸',
	PSshenzhu_info: '出牌阶段,你可以将两张装备牌合成一张装备牌.',
	PSwantian: '挽天',
	PSwantian_info: '出牌阶段限一次,你可以将体力上限调整为一,你每以此法失去一点体力或体力上限摸一张牌.',
	PStaoluan: '滔乱',
	PStaoluan_info: '每回合每种牌名限一次,你可以将一张牌当做任意一张基本牌或锦囊牌使用或打出,你摸一张牌.',
	PSbaguan2: '霸关',
	...
	PSjiwu3: '极武',
	PSjiwu3_info: '出牌阶段限两次,你可以弃置一张牌,选择获得【强袭】、【铁骑】、【旋风】、【完杀】中的一项技能直到回合结束.',
	PSkuangbao4: '狂暴',
	...
	PSzengxi: '赠玺',
	PSzengxi_info: '觉醒技,准备阶段,若你装备区的牌数不少于2,你加一点体力上限并回复一点体力,将装备区的所有牌交给一名其他角色,其将一半手牌(向下取整)交给你,你获得技能〖虎踞〗.',
	PShuju: '虎踞',
	PShuju_info: '你使用牌无距离限制.出牌阶段,你可以摸等同于自身已损失体力值的牌,减一点体力上限,本回合使用牌的伤害基数和回复基数+1.',
	PSluansha: '乱杀',
	PSluansha_info: '锁定技,当你使用牌结算后,若此牌没有造成伤害,你摸等同于此牌目标数的牌.',
	PShengce: '衡策',
	PShengce_info: '准备阶段,你可以从以下选项中选择一项:<br/> 1.对一名角色造成两点伤害 <br/>2.令一名角色摸四张牌 <br/>3.令一名角色弃四张牌<br/> 4.获得一名角色两张牌 <br/>5.令一名角色回复两点体力 <br/>6.令一名角色增加两点体力上限',
	PSdwww_zhiheng: '制衡',
	PSdwww_zhiheng_info: '出牌阶段限一次,你可以摸 X+1张牌,弃置 X张牌  ,若你以此法弃置的牌中包含:1．锦囊牌,本回合你可以将制衡修改为出牌阶段限两次;2．装备牌,你本回合使用牌没有距离限制.( x 为你的手牌数且最少为 1)',
	PSxiangong: '献贡',
	PSxiangong_info: '魏势力技,锁定技,当你不于弃牌阶段弃置牌时,你将弃置的牌置于一名没有【贡】武将上,称之为【贡】.当你受到伤害时,你选择有【贡】且【贡】数量不小于伤害值的角色,其获得等量的【贡】将你此伤害转移给该角色.',
	PScuicheng: '摧城',
	PScuicheng_info: '吴势力技,觉醒技,准备阶段开始时,若你本局游戏造成过伤害且发动过至少三次【制衡】,你回复一点体力并摸一张牌,从你已开通的吴势力武将中挑选四名武将,并选择三个技能获得之.',
	...
	PSshenfen4: '神愤',
	PSshenfen4_info: '出牌阶段限两次,你可以弃置一定数量的<狂暴>标记,执行一项效果: <br/>一枚:你选择回复一点体力或令一名其他角色失去一点体力<br/>两枚:你使用的下一张非延时锦囊牌可额外指定两名角色为目标(铁锁连环改为增加一个目标),若该锦囊牌的目标包括自己,你收回此牌<br/>三枚:你摸三张牌并弃置场上所有其他角色四张手牌和装备区内的所有牌<br/>四枚:所有其他角色受到一点无来源伤害,你获得X枚<狂暴>标记( X为场上受到伤害的角色数,以此法获得的<狂暴>标记最多为3 )',
	PSdingjun: '定军',
	PSdingjun_info: '每当你使用【杀】指定唯一目标时,你根据此【杀】的花色获得以下效果:<br/>♠️️️,此【杀】伤害＋X ;<br/>♣️️️,本回合使用【杀】次数＋X ;<br/>♦️️️,摸X张牌;<br/>♥️️️,获得X点护甲;<br/>X为此【杀】的点数.',
	PShuishi: '慧识',
	PShuishi_info: '出牌阶段限一次.你可进行判定牌不置入弃牌堆的判定.若判定结果与本次发动技能时的其他判定结果的点数均不相同,则你加1点体力上限(若你的体力上限不小于10则不加),且可以重复此流程.你将所有位于处理区的判定牌交给一名角色.若其手牌数为全场最多,则你减1点体力上限.',
	PSluoshen: '洛神',
	...
	PSjuezhi: '爵制',
	PSjuezhi_info: '出牌阶段限一次,你可以弃置两张牌,摸两张牌,令〖行图〗②重新生效.',
	PSlongnu: '龙怒',
	PSlongnu_info: '转换技,锁定技,阳:出牌阶段开始时,你失去1点体力并摸一张牌,本阶段内你视为拥有技能〖怒斩〗,且你的红色手牌均视为火【杀】且无距离限制.阴:出牌阶段开始时,你减1点体力上限并摸一张牌,本阶段内你本阶段内你视为拥有技能〖厉勇〗,且你的锦囊牌均视为雷【杀】且无使用次数限制.',
	PSlb_jieying: '结营',
	PSlb_jieying_info: '锁定技,游戏开始时或当你的武将牌重置时,你横置;所有已横置的角色手牌上限+2;当你的体力或体力上限变化后,你摸一张牌,横置一名其他角色.',
	PSsanchen: '三陈',
	PSsanchen_info: '出牌阶段限三次,你可以摸3张牌,观看一名其他角色的手牌,从中弃置任意张花色不同的牌.',
	PSzhaotao: '诏讨',
	PSzhaotao_info: '觉醒技,结束阶段开始时,若你本局游戏已发动两次以上〖三陈〗,你增加一点体力上限并回复一点体力,废除判定区,获得〖灭吴〗.',
	PSpozhu: '破竹',
	PSpozhu_info: '出牌阶段,你可以弃置两张牌,对一名其他角色造成一点伤害.',
	PSjin_miewu: '灭吴',
	PSjin_miewu_info: '锁定技,若你的判定区已废除,则你的判定阶段视为摸牌阶段.',
	PSsb_pingjian: '评荐',
	PSsb_pingjian_info: '结束阶段开始时/当你受到伤害后/出牌阶段限一次,你可以令系统随机从剩余武将牌堆中检索出6张拥有发动时机为结束阶段开始时/当你受到伤害后/出牌阶段的技能的武将牌.你可以选择尝试发动其中2个技能.每个技能每局只能选择一次.(村:受到伤害后不会失去已获得的<评鉴技能>)',
	// "PSsb_pingjian_append": '<span style="font-family: yuanli">开启扩展<天牢令>体验更佳</span>',
	PSwengua: '问卦',
	PSwengua_info: '其他角色/你的出牌阶段限一次,其可以交给你一张牌,(若当前回合角色为你,则跳过此步骤),你可以将此牌/一张牌置于牌堆顶或牌堆底,你与其/你从另一端摸一张牌',
	PSwengua_1: '问卦·升级',
	PSfuzhu_info: '使命技.①一名男性角色的结束阶段,若牌堆剩余牌数不大于你体力值的十倍,则你可以依次对其使用牌堆中所有的【杀】(不能超过游戏人数),洗牌.②成功:当你因〖伏诛〗①击杀该角色后,你摸Y张牌,升级〖问卦〗(Y为你发动〖伏诛〗①造成伤害数的一半,向上取整).③失败:当你发动〖伏诛〗①没有击杀该角色,你回复一点体力(若体力值已满,则摸一张牌).',
	PSfuzhu: '伏诛',
	PSwengua_1_info: '其他角色/你的出牌阶段限一次,其可以交给你一张牌,(若当前回合角色为你,则跳过此步骤),你与其/你从牌堆顶或牌堆底摸一张牌.你的问卦牌不计入手牌上限,当你失去问卦牌时,你摸一张牌.',
	PSluanwu: '乱武',
	PSluanwu_info: '出牌阶段限一次.你可以选择至少两名角色,每名你选择的角色依次视为对这些角色中与其逆时针座次最近的另一名角色使用一张不计入次数的【杀】.',
	PSwansha: '完杀',
	PSwansha_info: '锁定技,你的回合内,除你以外,进入濒死状态的角色立即死亡,且使其进入濒死状态的角色视为击杀其的角色.',
	PSduorui: '夺锐',
	PSduorui_info: '出牌阶段,你可以废除一个装备栏,获得场上的一个技能.当你于出牌阶段内对一名其他角色造成伤害后,你可以令该角色的一个技能失效直到其回合结束.',
	// "PSduorui_append": '<span style="font-family: yuanli">开启扩展<天牢令>体验更佳</span>',
	PSwusheng: '武圣',
	PSwusheng_info: '你可以将一张红色牌当做【杀】使用或打出.你使用的♦️️️杀没有距离限制且可以获得对方一张牌;你使用的♥️️️杀造成伤害+1,且目标需要连续使用两张【闪】才能抵消.',
	PSmashu: '马术',
	...
	PSshencai: '神裁',
	PSshencai_info: '出牌阶段限一次,你可以令一名其他角色进行判定.你获得此判定牌,若此判定牌:包含以下要素中的任意一个,获得对应的效果:{⒈体力:当其受到伤害后,其失去等量的体力、⒉武器:其不能使用牌响应杀、⒊打出:当其失去手牌后,其再随机弃置一张手牌(不嵌套触发)、⒋距离:其的结束阶段开始时,其翻面};若均不包含,你获得其区域里的一张牌,其获得一枚<死>并获得如下效果:其的角色手牌上限-X、其的回合结束时,若X大于场上存活人数,则其死亡(X为其<死>标记数).',
	PSxunshi: '巡使',
	PSxunshi_info: '锁定技.①你手牌区内所有的多目标锦囊牌均视为花色为none的普【杀】.②你使用颜色为none的牌无距离和次数限制.③当你使用🃏的牌选择目标后,你令你的〖神裁〗的发动次数上限+1(至多为5),可以为此牌增加任意个目标.',
	PStaoyuan: '桃园',
	PStaoyuan_info: '锁定技,当你体力减少后,你从牌堆顶亮出X张牌,若亮出的牌颜色不全为黑色,则你将体力回复到1,你指定一名角色,令其从三张未登场的蜀势力武将牌中选择一名获得上面所有技能.(X为场上蜀势力角色的数量)',
	PSshiren: '识人',
	...
	PSxianjin: '险进',
	PSxianjin_info: '锁定技,每轮开始时/当你造成或受到2次伤害后,你激活一个副区域,若你区域均已开发,则改为下回合开始前你执行一个回合,摸X张牌(X为已开发的副区域数).',
	PSqijing: '奇径',
	PSqijing_info: '觉醒技,每轮结束后,若你的手牌副区域均已开发,你减1体力上限,获得〖摧心〗,将座次移动至除你以外的两名相邻角色之间.',
	PSlingce: '灵策',
	PSlingce_info: '锁定技,当牌堆洗牌时,你观看牌堆顶8张牌,并从中获得牌名不同的牌,剩余的牌进入弃牌堆.',
	PStianzuo: '天佐',
	PStianzuo_info: '出牌阶段限一次/当你受到一点伤害后/回合结束时,若弃牌堆有牌,你可以令牌堆洗牌.',
	PSdinghan: '定汉',
	PSdinghan_info: '觉醒技,当你本局游戏至少发动过三次〖天佐〗,你增加一点体力上限并回复一点体力,获得技能〖佐定〗,将〖灵策〗中<获得牌名不同的牌>修改为< 获得其中至多六张牌>.',
	PSzuoding: '佐定',
	PSzuoding_info: '出牌阶段限三次,你可以将一张牌当【奇正相生】使用.',
	PSzhengu: '镇骨',
	PSzhengu_info: '结束阶段,你可以选择一名其他角色,你令你或其成为<高达>(<高达>效果:手牌数始终保持与对方一致,直到下回合结束时.一名角色不能重复成为<高达>).',
	PSchenglve: '成略',
	PSchenglve_info: '转换技,出牌阶段限一次,阴:你可以摸一张牌,弃置两张手牌.阳:你可以摸两张牌,弃置一张手牌.若如此做,直到本回合结束,你使用与弃置牌花色相同的牌无距离和次数限制,且当你使用/打出/弃置与弃置牌花色相同的牌后,你摸一张牌.',
	PSshicai: '恃才',
	PSshicai_info: '当你使用牌时,若此牌与你本回合使用的牌名均不同,则你可以将此牌置于牌堆顶,摸一张牌.',
	PSpingjian_use: '评荐',
	PSlvli: '膂力',
	PSlvli_info: '每回合限一次,当你造成伤害后,你可以将手牌摸至与体力值相同或将体力回复至与手牌数相同.',
	PSchoujue: '仇决',
	PSchoujue_info: '觉醒技,每个回合结束时,若你的体力上限大于4,你获得技能〖背水〗,删去〖膂力〗描述中的<每回合限一次.',
	PSbeishui: '背水',
	PSbeishui_info: '觉醒技,准备阶段,若你的体力值不小于3,你获得〖清剿〗,将〖膂力〗改为受到伤害后也可以发动.',
	PSqingjiao: '清剿',
	...
	PSdaogu: '道骨',
	PSdaogu_info: '锁定技,你每发动过【3】次技能(〖道骨〗除外),你选择一项:1、失去你的一个技能,将〖道骨〗描述中【】内的数字减1(至少为1).2、重置或回复场上的一个技能(若为〖南斗〗或〖北斗〗,则改为重置并失去限定技标签).3、随机获得场上的一个技能,直到你下回合结束.',
	PSfaxiao: '发笑',
	...
	PSshouye: '守邺',
	PSshouye_info: '每一轮开始时,你获得技能〖协守〗并且可以令一名角色获得技能〖协守〗直到下一轮开始.当一名角色失去技能〖协守〗时,其回复一点体力.',
	PSliezhi: '烈直',
