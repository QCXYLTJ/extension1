    ...
    return {
        ...
        content(config, pack) {
                    ...
                    content() {
                        if (event.isMine()) {
                            game.broadcastAll(function (player) {
                                ...
                                Animation.setBackgroundImage('extension/文武英杰/image/wwyj_newtujianicon.png');
            ...
            game.wwyj_background = function () {
                var Animation = ui.create.div();
                Animation.setBackgroundImage('extension/文武英杰/image/wwyj_diaochan.png');
                    ...
                    content() {
                        if (player.isLinked()) {
                            game.broadcastAll(function (player) {
                                ...
                                img.setBackgroundImage('extension/文武英杰/image/wwyj_tiesuolianhuan.png');
                                img.style.width = '100%';
            ...
            if (config.wwyj_lebusishu) {
                lib.skill._lebusishu = {
                    ...
                    content() {
                        game.broadcastAll(function (player) {
                            img = document.createElement('div');
                            img.setBackgroundImage('extension/文武英杰/image/wwyj_lebusishu.png');
                            img.style.backgroundSize = 'cover';
                            img.style.width = '100%';
                            img.style.height = '100%';
            ...
            game.playwwyj = function (fn, dir, sex) {
                if (dir && sex) {
                    ...
                    game.playAudio('../extension/文武英杰/audio', fn);
                }
            };
            if (config.wwyj_huanleyinxiao) {
                ...
                lib.skill._diechat = {
                    ...
                    content() {
                        ...
                        game.playAudio('../extension/文武英杰/audio/wwyj_zhenwang.mp3');
            ...
            lib.skill._wwyj_zhwpy = {
                ...
                content() {
                    if (get.mode() == 'guozhan') {
                        game.playAudio('../extension/文武英杰/audio', player.name1);
                    } else game.playAudio('../extension/文武英杰/audio', player.name);
                    setTimeout(function () {
                        game.playAudio('../extension/文武英杰/audio', player.name2);
                    }, 3600);
                },
            };
            //以下部分代码借鉴<玄武江湖>扩展
                ...
                lib.skill._wwyj_kaichangtexiao = {
                    ...
                    content() {
                        if (player == game.me) {
                            //game.broadcastAll(function(player){
                            var Animation = ui.create.div();
                            Animation.setBackgroundImage('extension/文武英杰/image/wwyj_kaichangtexiao.png');
                            Animation.style.backgroundSize = 'cover';
            ...
            if (config.wwyj_jiexiantupo) {
                lib.arenaReady.push(function () {
                    lib.skill.wwyj_gainian = {
                        ...
                        content() {
                            ...
                            player
                                .chooseButton([get.prompt('wwyj_gainian'), [list1.concat(list2), 'vcard']])
                                ...
                                .set('ai', function (button) {
                                    switch (button.link[2]) {
                                        ...
                                        case 'tao':
                                            return 5.5 + 9 * Math.random();
                                        case 'jiu':
                                            return 3 + 9 * Math.random();
                                        case 'shan':
                                            return 4 + 9 * Math.random();
                                        case 'wuzhong':
                                            return 4.5 + 9 * Math.random();
                                        case 'shunshou':
                                            return 4.5 + 9 * Math.random();
                                        case 'nanman':
                                            return 3 + 9 * Math.random();
                    ...
                    lib.translate.wwyj_gainian_info = '回合结束时,你可声明一张基本牌或普通锦囊牌,若如此做,若你未发动技能【黑猫】,你须失去一点体力并翻面,令场上所有其他角色弃置一张与你所声明的牌名字相同的手牌,否则你摸一张牌 <font color=#F0F>已突破</font>';
                });
                lib.arenaReady.push(function () {
                ...
                lib.arenaReady.push(function () {
                    lib.skill.wwyj_chaoyue = {
                        ...
                        audio: ['refenyin', 2],
                        filter(event, player) {
                            return event.card && event.card.name == 'sha' && !event.player.isTurnedOver();
                        },
                        content() {
                            trigger.num++;
                ...
                lib.arenaReady.push(function () {
                    lib.skill.wwyj_jieyuan = {
                        ...
                        selectCard() {
                            var num1 = _status.currentPhase && _status.currentPhase.countCards('he', { color: 'black' });
                ...
                lib.arenaReady.push(function () {
                    lib.skill.wwyj_bohe2 = {
                        ...
                        //audio:"ext:文武英杰/audio:1",
                        filter(event, player) {
                            return event.card && get.type(event.card) == player.storage.wwyj_bohe;
                        },
                        content() {
                            'step 0';
                    ...
                    lib.translate.wwyj_bohe_info = '出牌阶段限一次,你可声明一种类别的牌,直到你的下回合开始,每名角色的回合限一次,每当一名角色使用一张类别与该类别相同的非转化的牌时(不包括延时性锦囊牌),其可令你摸一张牌 <font color=#F0F>已突破</font>';
                });
                lib.arenaReady.push(function () {
                    ...
                    lib.translate.wwyj_lunpo_info = '</font><font color=#f00>锁定技</font> 任意有<丸>标记的角色弃牌阶段弃牌时,若其弃置的牌均为不同花色的牌时,你回复一点体力,摸一张牌并令该角色受到你造成的一点伤害,其弃置<丸>标记';
                });
                lib.arenaReady.push(function () {
                    lib.skill.wwyj_kazhan = {
                        ...
                        content() {
                            ...
                            player
                                .chooseCardButton(get.prompt('wwyj_kazhan'), list1.concat(list2))
                                .set('filterButton', function (button) {
                                ...
                                .set('ai', function (button) {
                                    ...
                                    switch (button.link.name) {
                                        case 'tengjia':
                                            return 0;
                                        case 'bagua':
                                            return 9 + 23 * Math.random();
                                        case 'renwang':
                                            return 10 + 23 * Math.random();
                                        case 'dilu':
                                            return 6 + 23 * Math.random();
                                        case 'dawan':
                                            return 4 + 23 * Math.random();
                                        case 'cixiong':
                                            return 4.5 + 23 * Math.random();
                                        case 'qinggang':
                                            return 5 + 23 * Math.random();
                                        case 'qinglong':
                                            return 5 + 23 * Math.random();
                                        case 'guding':
                                            return 5 + 23 * Math.random();
                                        ...
                                        case 'guanshi':
                                            return 6 + 23 * Math.random();
                                        case 'hanbing':
                                            return 3.5 + 23 * Math.random();
                                        case 'hualiu':
                                            return 5.5 + 23 * Math.random();
                                        case 'jueying':
                                            return 6 + 23 * Math.random();
                                        case 'muniu':
                                            return 5 + 23 * Math.random();
                ...
                lib.arenaReady.push(function () {
                    ...
                    lib.translate.wwyj_xuanxia_info = '每两轮限一次,当你进入濒死状态时,你可回复体力至场上<星>的数量,获得场上所有的<星>,并分别视为对这些角色使用一张【杀】 <font color=#F0F>已突破</font>';
                });
                lib.arenaReady.push(function () {
                ...
                lib.arenaReady.push(function () {
                    ...
                    lib.skill.wwyj_meihua = {
                        ...
                        content() {
                            ...
                            ('step 1');
                            player
                                .chooseCardButton(event.cards, 1, '选择使用一张牌代替' + get.translation(trigger.player) + '所使用的牌')
                                .set('filterButton', function (button) {
                ...
                lib.arenaReady.push(function () {
                    lib.skill.wwyj_duange = {
                        ...
                        content() {
                            ...
                            player.chooseCardButton('短歌:选择获得一组点数连续的牌', event.cards, [1, 9]).set('filterButton', function (button) {
                                ...
                                var ns = bs.map(function (i) {
                                    return i.link.number;
                                });
                    ...
                    lib.translate.wwyj_duange_info = '摸牌阶段开始时,你可以放弃摸牌,改为观看牌堆顶的九张牌,获得其中任意一组点数为连续数的牌,并将其余的牌按任意顺序置于牌堆顶 <font color=#F0F>已突破</font>';
                });
                lib.arenaReady.push(function () {
                ...
                content() {
                    if (player.name == 'wwyj_niya') {
                        var AnimationClick = function () {
                            if (player.countCards('h') < 3) {
                                ...
                                if (!lib.filter.cardAiIncluded(card)) {
                                    ok = false;
                                } else if (player.isOut() || !lib.filter.cardRespondable(card, player) || card.classList.contains('uncheck') || !(evt && evt.filterCard && evt.filterCard(card, player))) ok = false;
                                ...
                                game.playAudio('../extension/文武英杰/audio/wwyj_dansha.mp3');
                                ui.updatehl();
                                player.update();
                        ...
                        if (event.isMine()) {
                            game.broadcastAll(function (player) {
                                var Animation = ui.create.div();
                                Animation.setBackgroundImage('extension/文武英杰/image/wwyj_niyaicon.png');
                            ...
                            player.node.handcards1.addEventListener(
                                'DOMSubtreeModified',
                                function () {
                                    if (player.countCards('h') < 3)
                                        setTimeout(
            ...
            lib.skill._lc_shanghai = {
                ...
                content() {
                    game.trySkillAudio('wwyj_gainian', this, true); //QQQ
            ...
            lib.skill._lc_juli = {
                ...
                mod: {
                    ...
                    selectTarget(card, player, range) {
                        ...
                        if (type != 'delay') {
                            if (card.name != 'jiedao' && card.name != 'wuzhong' && card.name != 'wuxie' && player.name == 'wwyj_liangchax' && Array.isArray(range) && range[1] != -1) range[1] += Infinity;
                        }
                    },
                },
            };
            ...
            lib.rank.rarity.junk.addArray(['wwyj_maliao', 'wwyj_ziyage', 'wwyj_kanpoyiqie', 'wwyj_danwuyunxi', 'wwyj_xingyunnvshen', 'wwyj_feicheng', 'wwyj_xuebi', 'wwyj_lengyus', 'wwyj_liushas', 'wwyj_wzszhaoyun', 'wwyj_anshas', 'wwyj_ranqis']);
            ...
            lib.rank.rarity.epic.addArray(['wwyj_liangchas', 'wwyj_chengxuyuan', 'wwyj_chenwus', 'wwyj_yangguangweiliang', 'wwyj_Sukincen', 'wwyj_kelejiabing', 'wwyj_remaliao', 'wwyj_zhugejun', 'wwyj_yitiaoxianyu', 'wwyj_shennais', 'wwyj_yiwangs', 'wwyj_tilongjianiao', 'wwyj_huanyuxingcheng', 'wwyj_xuedaoshaozhu', 'wwyj_duanges', 'wwyj_guchengs', 'wwyj_bohetang', 'wwyj_yuhudie', 'wwyj_tianqikui', 'wwyj_zhichitianya', 'wwyj_chansuideshengming', 'wwyj_fanxings']);
                ...
                packSwith1.onclick = function () {
                    ...
                    for (var i = 0; i < div.childNodes.length; i++) {
                        if (packSwith.link_switch == 'all') {
                            ...
                            if (packSwith.link_switch.includes(div.childNodes[i].link)) {
                                div.childNodes[i].style.display = '';
                            }
                        }
                    }
                            ...
                            for (var i = 0; i < div.childNodes.length; i++) {
                                if (packSwith.link_switch == 'all') {
                                    if (packSwith.link_switch1 == 'all') {
                                        ...
                                        if (packSwith.link_switch1.includes(div.childNodes[i].link)) div.childNodes[i].style.display = '';
                                    }
                                } else {
                                    if (packSwith.link_switch.includes(div.childNodes[i].link)) {
                                        if (packSwith.link_switch1 == 'all') {
        ...
        precontent(wwyj) {
            ...
            lib.init.js('extension/文武英杰', 'newtujian', function () { });
            lib.init.js('extension/文武英杰', 'update', function () { });
            lib.extensionMenu.extension_文武英杰.wwyj_最佳拍档 = {
                ...
                onclick() {
                    if (this.wwyj_zuijiapaidang == undefined) {
                        game.playwwyj('wwyj_dansha');
                        var more = ui.create.div('.wwyj_zuijiapaidang', '<li>装备流:极光+烟雨墨染+血刀少主+Niya/造孽/薄荷糖<li>翻面系:苏婆玛丽奥+诸葛均+咸鱼+孤城<li>辅助爆发组:太上大牛+大熊小猫+神奈+Niya');
            ...
            game.import('character', function () {
                var wenwuyingjie = {
                    ...
                    characterSort: {
                        wenwuyingjie: {
                            ...
                            wwyj_zuozhe: ['wwyj_liangchas', 'wwyj_chengxuyuan', 'wwyj_pipi', 'wwyj_Sukincen', 'wwyj_qianshangs', 'wwyj_zhaonies', 'wwyj_lengyus', 'wwyj_shenzuo', 'wwyj_guihua', 'wwyj_yitiaoxianyu', 'wwyj_xuebi', 'wwyj_yanyumoran', 'wwyj_wali', 'wwyj_kelejiabing', 'wwyj_danwuyunxi', 'wwyj_jiguangs', 'wwyj_taishangdaniu', 'wwyj_maliao', 'wwyj_shijian', 'wwyj_huijin', 'wwyj_kanpoyiqie', 'wwyj_yiwangs', 'wwyj_shennais', 'wwyj_huanyuxingcheng', 'wwyj_duanges', 'wwyj_wuqinggezi', 'wwyj_shenwangquanjian', 'wwyj_ziyage', 'wwyj_guchengs', 'wwyj_yuhudie', 'wwyj_hezifengyun', 'wwyj_fux2', 'wwyj_qingzhongs', 'wwyj_remaliao', 'wwyj_bohetang', 'wwyj_niya', 'wwyj_zhongchengpantu', 'wwyj_tianqikui', 'wwyj_zhichitianya', 'wwyj_jianyaleishao', 'wwyj_anshas', 'wwyj_zhuxiaoer', 'wwyj_ranqis', 'wwyj_chansuideshengming', 'wwyj_fanxings', 'wwyj_yangguangweiliang', 'wwyj_rongyaotaoge', 'wwyj_chenwus'],
                            wwyj_fensi: ['wwyj_xuedaoshaozhu', 'wwyj_limuzi', 'wwyj_tilongjianiao', 'wwyj_liushas', 'wwyj_zhugejun', 'wwyj_feicheng', 'wwyj_xingyunnvshen', 'wwyj_lunhuizhong', 'wwyj_daxiongxiaimao', 'wwyj_wzszhaoyun', 'wwyj_zhulinqixian'],
                        },
                    },
                    character: {
                        wwyj_shuihu: ['male', 'shen', 3, ['wwyj_chuangshi', 'wwyj_qianfu', 'wwyj_ancha', 'wwyj_huikeng'], []],
                        wwyj_liangchax: ['female', 'shen', Infinity, [], ['boss']],
                        ...
                        wwyj_yuhudie: ['female', 'wwyjsha', 3, ['wwyj_recaizhi', 'wwyj_redaixue'], []],
                    },
                    characterIntro: {
                        ...
                        wwyj_yitiaoxianyu: '咸鱼,也曾名为<永远的萌新>、<→_→>,一位新生代扩展作者,拥有比较扎实、全面的代码技术.其真实身份比较可疑,应为某位大神的小号,因为其突然空降来到无名杀这个圈子,自称是名<萌新>,但出道即巅峰,写了一堆教程,众所周知,能出教程的都是大佬,尔后其又接写<耀世三国>等扩展,种种事实证明其是一名伪萌新.代表作品还有<西沉的胡思乱想>、<灵枢包>、<特效测试>、<高速决斗>(暂已停更)、<犬夜叉之战>等',
                        wwyj_shennais: '神奈,又名<东平车幻玲>,圈内习惯称呼她为<学妹>,是一位远古代的扩展作者,对扩展有独特的写法,其代表作为<朔包>,以高体力上限与高伤害著称.另外,神奈给人印象较深刻的是其随和、可爱的一面,这也是技能<可爱>的创作思路来源,而技能<神奈>略显得无厘头(本来是想设计一个骚操作类的技能的),实则是在凉茶在创作完<可爱>后灵感枯竭时无意中测试了一局发现,当触发<可爱>时,友方给了几张杀,正好挂连弩,又杀一波,紧接着杀完再触发又来了几张杀……始料未及的契合令凉茶感到非常意外与兴奋,故设计了一个可提升杀的使用次数的技能,这正是技能<神奈>的来由',
                        ...
                        wwyj_liangchax: '这个是boss,可进挑战模式中挑战她!也可在扩展界面开启<天神降临>再重启游戏,就可在非挑战模式中选用或被ai选用(注:本武将及本扩展不含任何赋空等抗性代码)',
                        ...
                        wwyj_zhongchengpantu: '忠诚的叛徒,中生代扩展作者,原叫<最忠诚的叛徒>,因有个群的管理员冒充他胡乱踢人,而改名为<路过的指挥使>.曾在<动漫包>的基础上写了一个名为<伪动漫>的扩展,该扩展以古灵精怪著称,技能大部分花里胡哨不走常规路,而且技能的描述也为一些莫名其妙的口号.其比较得意的为<莫比波斯环>,无穷的无中生有必摸无中生有.后因该扩展的技能、人物不注意写id,积弊已久,导致与同样如此做的<冷雨>包互相冲突、吞并,其将各群的<伪动漫>全删除了并停更了.后来另写扩展<异闻带>',
                        ...
                        wwyj_ranqis: '染柒,原名:染柒行骗,新生代扩展作者,代表作有改编<狼人杀>的<月圆之夜>,曾因学业原因经常断更.后来对代码越来越熟练,接二连三地写了多个扩展,比如:<狼人对决>、<美女如云>、<染柒的世界>、<染柒剧情模式>等',
                        wwyj_chansuideshengming: '残碎的生命,中生代扩展作者,该作者比较低调,很少发言.扩展作品有<次元格斗>、<SH武将>等',
                        wwyj_fanxings: '繁星,新生代扩展作者,代表扩展作品有<花好月圆>',
                        wwyj_yangguangweiliang: '阳光微凉,新生代扩展作者,代表作为<阳光包>,同时是无名杀全教程的编者之一.本设计来自其<阳光包>中个人设计的投稿',
                    ...
                    skill: {
                        wwyj_chenwu: {
                            ...
                            audio: 'ext:文武英杰/audio:1',
                            filter(event, player) {
                                return player != event.player && event.player.countCards('h') > event.player.hp;
                            },
                            content() {
                                'step 0';
                                player.choosePlayerCard(trigger.player, 'h', 1, '选择获得' + get.translation(trigger.player) + '一张手牌').ai = function (card) {
                                ...
                                if (result.cards?.length) {
                                    ...
                                    //if(player.canUse(event.card,player)&&(get.type(event.card)=='basic'||get.type(event.card,'trick')=='trick')){
                                    if (get.type(event.card) == 'basic' || get.type(event.card, 'trick') == 'trick') {
                                        player.chooseUseTarget('选择使用【' + get.translation(event.card) + '】的目标', event.card, false, false);
                        ...
                        wwyj_shengbei_use: {
                            ...
                            content() {
                                ...
                                player.chooseCard('展示一张牌', 'h', function (card) {
                                    return (
                                        (get.type(card) == 'basic' || get.type(card) == 'trick') &&
                                        game.hasPlayer(function (current) {
                                ...
                                if (result.bool) {
                                    ...
                                    player.chooseUseTarget('选择视为使用' + get.translation(event.card) + '的目标', { name: event.card.name }, false, false);
                                    event.finish();
                                } else {
                                    event.num++;
                                    event.goto(2);
                        ...
                        wwyj_rongyao: {
                            ...
                            mod: {
                                targetEnabled(card, player, target, now) {
                                    if (target.storage.wwyj_rongyao && target.storage.wwyj_rongyao.length) {
                            ...
                            ai: {
                                threaten(player, target) {
                                    if (target.storage.wwyj_rongyao && target.storage.wwyj_rongyao.length) return 2;
                                    return 1;
                                },
                            },
                        },
                        wwyj_taoge2: {
                            ...
                            content() {
                                for (var i of game.players) {
                                    //QQ
                                    if (i.hasSkill('wwyj_taoge1')) {
                                        i.storage.wwyj_taoge1 = [];
                                        i.removeSkill('wwyj_taoge1');
                                    }
                                }
                            },
                        },
                        ...
                        wwyj_taoge: {
                            ...
                            group: 'wwyj_taoge2',
                            filter(event, player) {
                                if (player.storage.wwyj_rongyao < 1) return false;
                                return true;
                            },
                            content() {
                                'step 0';
                                ...
                                player
                                    .chooseControl()
                                    .set('choiceList', ['弃置这些<耀>并令' + get.cnNumber(event.cards.length) + '名其他角色各摸一张牌,你回复一点体力', '交给' + get.cnNumber(event.cards.length) + '名其他角色各一张<贤>,其须弃置一张与之不同类别的手牌,否则失去一点体力'])
                                    .set('ai', function () {
                                        var num = game.countPlayer(function (current) {
                                ...
                                ('step 4');
                                player
                                    .chooseTarget(get.prompt('wwyj_taoge'), event.cards.length, true, function (card, player, target) {
                                        return true;
                                    })
                        ...
                        wwyj_zhiguo2: {
                            ...
                            filter(event, player) {
                                return (
                                    ...
                                    player.sex == 'female' &&
                                    game.countPlayer(function (current) {
                                        return current.hasSkill('wwyj_zhiguo');
                                    }) > 0
                                );
                            },
                            content() {
                        ...
                        wwyj_fanxing: {
                            ...
                            audio: ['luanji', 2],
                            filter(event, player) {
                                return player.storage.wwyj_huayue.length;
                            },
                            content() {
                                'step 0';
                            ...
                            ai: {
                                result: {
                                    player(player) {
                                        if (player.storage.wwyj_huayue.length < 3) return 0;
                                        return 1;
                                    },
                                },
                                order: 5,
                        ...
                        wwyj_huayue2: {
                            ...
                            forced: true,
                            filter(event, player) {
                                return event.source && event.source.isAlive() && player.storage.wwyj_huayue.length;
                            },
                            content() {
                                'step 0';
                                trigger.source
                                    .chooseCardButton(player.storage.wwyj_huayue, 1, '选择获得其中的一张<星>牌')
                                    .set('filterButton', function (button) {
                                        return true;
                                    })
                                    .set('ai', function (button) {
                        ...
                        wwyj_chansui: {
                            ...
                            forced: true,
                            filter(event, player) {
                                return player != event.source && player.storage.wwyj_shengming.length;
                            },
                            content() {
                                'step 0';
                                trigger.source
                                    .chooseCardButton(player.storage.wwyj_shengming, 1, '选择获得其中的一张武器牌', true)
                                    .set('filterButton', function (button) {
                                        return true;
                                    })
                                    .set('ai', function (button) {
                                ...
                                if (result.links?.length) {
                                    ...
                                    game.cardsDiscard(result.links[0]);
                                    trigger.source.gain(result.links[0], 'fromStorage');
                                    if (player.storage.wwyj_shengming.length <= 0) {
                        ...
                        wwyj_shengming2: {
                            ...
                            audio: 'oljiangchi',
                            filter(event, player) {
                                return player.storage.wwyj_shengming.length;
                            },
                            content() {
                                'step 0';
                                player.chooseTarget(
                                    get.prompt2('wwyj_shengming2'),
                                    1,
                                    true,
                                    function (card, player, target) {
                                ...
                                if (result.targets?.length) {
                                    ...
                                    player
                                        .chooseCardButton(player.storage.wwyj_shengming, 1, '选择令' + get.translation(event.target) + '装备其中的一张武器牌', true)
                                        .set('filterButton', function (button) {
                                            return true;
                                        })
                                        .set('ai', function (button) {
                        ...
                        wwyj_shengming: {
                            ...
                            mod: {
                                maxHandcard(player, num) {
                                    return num + player.storage.wwyj_shengming.length;
                                },
                            },
                            content() {
                                var list = [];
                            ...
                            content() {
                                ...
                                if (list) {
                                    trigger.source
                                        ...
                                        .set('prompt', get.prompt('wwyj_ranqi'))
                                        .set('prompt2', get.translation('wwyj_ranqi_info'));
                                } else event.finish();
                                ('step 1');
                                if (result.control) {
                        ...
                        wwyj_guozhanrespond: {
                            ...
                            content() {
                                ...
                                player.chooseTarget(get.prompt('wwyj_guozhanrespond'), function (card, player, target) {
                                    ...
                                    // if(!player.storage.wwyj_guozhan.includes(target.group)) return false;
                                    return true;
                                }).ai = function (target) {
                        ...
                        wwyj_fuji: {
                            ...
                            filter(event, player) {
                                return _status.currentPhase && _status.currentPhase != player && _status.currentPhase && _status.currentPhase.isAlive();
                            },
                            check(event, player) {
                                if (player.countCards('e') > _status.currentPhase && _status.currentPhase.countCards('e')) return 0;
                        ...
                        wwyj_chaoyue: {
                            ...
                            audio: ['refenyin', 2],
                            filter(event, player) {
                                return event.card && event.card.name == 'sha' && (event.player.isTurnedOver() || event.player.isLinked() || event.player.isHealthy());
                            },
                            content() {
                                trigger.num++;
                                // game.playwwyj(['wwyj_gainian1','wwyj_gainian2'].randomGet());
                        ...
                        wwyj_jianya: {
                            ...
                            content() {
                                ...
                                player
                                    ...
                                    .set('prompt', get.prompt('wwyj_jianya'))
                                    .set('prompt2', get.translation('wwyj_jianya_info'));
                                ('step 1');
                                if (result.control) {
                                ...
                                ('step 3');
                                player
                                    .chooseCardButton(event.cards, [1, 2], '选择获得任意张黑色牌')
                                    .set('filterButton', function (button) {
                        ...
                        wwyj_leishao: {
                            ...
                            subSkill: {
                                1: {
                                    prompt: '</font><font color=#f00>锁定技</font> 你的♣️️非装备牌均视为雷杀且无距离和次数限制',
                                    mod: {
                                        targetInRange(card) {
                                            if (card.suit == 'club' || _status.event.skill == 'wwyj_leishao_1') return true;
                                            if (card.name == 'sha' && card.nature == 'thunder') return true;
                                        },
                                        cardEnabled(card, player) {
                                            if (_status.event.skill == undefined && get.type(card) != 'equip' && card.suit == 'club') return false;
                                        },
                                    ...
                                    filterCard(card) {
                                        return get.type(card) != 'equip' && card.suit == 'club';
                                    },
                                    filter(event, player) {
                        ...
                        wwyj_zhichi: {
                            ...
                            content() {
                                trigger.num++;
                                //game.playwwyj(['wwyj_gainian1','wwyj_gainian2'].randomGet());
                                game.trySkillAudio('wwyj_gainian', this, true);
                            },
                        },
                        wwyj_tianya: {
                            //audio:"ext:文武英杰/audio:2",
                            ...
                            content() {
                                'step 0';
                                player
                                    .chooseTarget('【天涯】', [1, Infinity], lib.translate.wwyj_tianya_info, function (card, player, target) {
                                        return target != player;
                                    })
                                    .set('ai', function (target) {
                                        return Math.random();
                                ...
                                if (result.bool) {
                                    ...
                                    game.playwwyj(['wwyj_heimao1', 'wwyj_heimao2'].randomGet());
                                    ui.background.setBackgroundImage('extension/文武英杰/image/wwyj_yuhudiebz.jpg');
                                    event.num = 0;
                                    event.list = [];
                                    // event.list1=[]; //另一种写法
                                    event.targets = result.targets;
                        ...
                        wwyj_jitui: {
                            ...
                            content() {
                                ...
                                ('step 1');
                                player
                                    .chooseCardButton(event.cards, 1, '选择其中一张牌')
                                    .set('filterButton', function (button) {
                                        return true;
                                    })
                                    .set('ai', function (button) {
                                ...
                                player.chooseCard('请补回一张与' + get.translation(event.card) + '的花色或类型或点数相同的牌给牌堆顶', 'he', true, function (card) {
                                    return card.suit == event.suit || get.type(card) == event.type || card.number == event.number;
                                }).ai = function (card) {
                        ...
                        wwyj_duiyi: {
                            ...
                            content() {
                                ...
                                for (var i = 0; i < event.cards1.length; i++) {
                                    event.suits.add(event.cards1[i].suit);
                                }
                            ...
                            content() {
                                ...
                                if (result.bool) {
                                    if (
                                        ...
                                        player.chooseUseTarget({ name: 'taoyuan' }, result.cards, true, false).set(
                                            'targets',
                        ...
                        wwyj_liuli: {
                            ...
                            filter(event, player) {
                                ...
                                return evt && player.countCards('h') && evt.player.isAlive() && evt.player != player && evt.hs && evt.hs.length;
                            },
                            content() {
                                'step 0';
                                event.suits = [];
                                ...
                                player.chooseCard('你可交给' + get.translation(trigger.player) + '一张与本次已以此法选择的不同花色的手牌', 'h', 1, function (card) {
                                    var suit = card.suit;
                                    return !event.suits.includes(suit);
                                }).ai = function (card) {
                                    return 8 - get.value(card);
                                };
                                ('step 2');
                        ...
                        wwyj_zhushan: {
                            ...
                            filter(event, player) {
                                return event.card && event.card.name == 'sha' && event.player.countCards('h') <= event.target.countCards('h');
                            },
                            prompt(event, player) {
                        ...
                        wwyj_bohe: {
                            ...
                            content() {
                                ...
                                player
                                    ...
                                    .set('filterButton', function (button) {
                                        if (player.storage.wwyj_bohe && player.storage.wwyj_bohe.includes(button.link[2])) return false;
                                        return true;
                                    })
                                    .set('ai', function (button) {
                                        var rand = _status.event.rand * 2;
                        ...
                        wwyj_zangyue2: {
                            ...
                            filter(event, player) {
                                return player == _status.currentPhase && event.card && event.card.suit == player.storage.wwyj_zangyue2;
                            },
                            content() {
                                'step 0';
                                event.players = game
                        ...
                        wwyj_zangyue: {
                            ...
                            content() {
                                ...
                                for (var i of game.players) {
                                    ...
                                    if (player != i) {
                                        player.line(i, 'green');
                                        i.addTempSkill('wwyj_zangyue2', { player: 'phaseEnd' });
                                        i.storage.wwyj_zangyue2 = [];
                                        i.storage.wwyj_zangyue2.add(event.choice);
                                    }
                                }
                            },
                            ai: {
                        ...
                        wwyj_geziyin: {
                            ...
                            content() {
                                ...
                                ('step 1');
                                target
                                    .chooseTarget('选择发动至少一名目标', [1, Infinity], lib.translate.wwyj_geziyin_info, true, function (card, player, target) {
                                        return true;
                                    })
                                    .set('ai', function (target) {
                                ...
                                player
                                    .chooseControl()
                                    .set('choiceList', ['你横置/重置' + get.translation(target) + '所选择的角色', '你横置/重置' + get.translation(target) + '未选择的角色'])
                                    .set('ai', function () {
                                ...
                                for (var i of game.players) {
                                    //QQ
                                    if (i.hasSkill('wwyj_geziyin1')) {
                                        i.removeSkill('wwyj_geziyin1');
                                    }
                                }
                            },
                            ai: {
                        ...
                        wwyj_geziyang: {
                            ...
                            content() {
                                ...
                                for (var i of game.players) {
                                    //QQ
                                    if (i.hasSkill('wwyj_geziblack')) {
                                        i.removeSkill('wwyj_geziblack');
                                    } else if (i.hasSkill('wwyj_gezired')) {
                                        i.removeSkill('wwyj_gezired');
                                    }
                                }
                            },
                            ai: {
                        ...
                        wwyj_gezi: {
                            ...
                            intro: {
                                content(storage, player, skill) {
                                    if (player.storage.wwyj_gezi == true) return '出牌阶段限一次:你可弃置一张红色手牌并令任意名有手牌的角色各展示一张手牌,你可展示一张手牌横置／重置展示牌与该牌颜色相同的角色,若已横置的角色比未模置的多,你摸一张牌';
                                    return '出牌阶段限一次,你可交给一名其他角色一张黑色手牌,令其选择至少一名角色,你选择横置／重置其所选择的或未选择的角色,若已横置的角色比未模置的多,你摸一张牌';
                                },
                            },
                            audio: 'ext:文武英杰/audio:1',
                        ...
                        wwyj_sepi2: {
                            ...
                            content() {
                                ...
                                if (targets.length == 1) {
                                    ...
                                    player
                                        .chooseTarget(true, '选择一个色批', function (card, player, target) {
                                ...
                                if (event.target) {
                                    ...
                                    player
                                        .discardPlayerCard(event.target, 'h', get.prompt('wwyj_sepi'))
                                        .set('ai', function (button) {
                                            return Math.random();
                                        })
                        ...
                        wwyj_xuedao: {
                            ...
                            content() {
                                ...
                                if (result.targets?.length) {
                                    event.target = result.targets[0];
                                    player
                                        .discardPlayerCard(result.targets[0], 'h', get.prompt('wwyj_xuedao'))
                                        .set('ai', function (button) {
                                            return Math.random();
                                        })
                        ...
                        wwyj_shaozhu: {
                            ...
                            content() {
                                ...
                                ('step 1');
                                if (event.num < event.targets.length) {
                                    event.targets[event.num].chooseToUse({ name: 'sha' }, trigger.player, '对' + get.translation(trigger.player) + '使用一张【杀】(无距离限制),否则' + get.translation(player) + '将获得你的一张牌');
                                } else event.finish();
                                ('step 2');
                                if (result.bool) {
                                    event.num++;
                        ...
                        wwyj_lunpo: {
                            ...
                            content() {
                                ...
                                player
                                    .chooseControl()
                                    .set('choiceList', ['回复一点体力并摸一张牌', '令' + get.translation(trigger.player) + '受到你造成的一点伤害并弃置<丸>标记'])
                                    .set('ai', function () {
                        ...
                        wwyj_qinyan2: {
                            ...
                            mod: {
                                ...
                                targetInRange(card, player, target) {
                                    if (player.storage.wwyj_xiyuan.includes(target)) return true;
                                },
                                playerEnabled(card, player, target) {
                                    var bool = false;
                                    if (player.storage.wwyj_xiyuan && ui.selected.targets.length) {
                                        for (var i = 0; i < player.storage.wwyj_xiyuan.length; i++) {
                                            if (ui.selected.targets.includes(player.storage.wwyj_xiyuan[i])) {
                                                bool = true;
                                                break;
                                            }
                                        }
                                    }
                                    if (!bool && (!player.storage.wwyj_xiyuan || !player.storage.wwyj_xiyuan.includes(target))) {
                        ...
                        wwyj_qinyan: {
                            ...
                            filter(event, player) {
                                ...
                                return _status.currentPhase == player && event.hs && event.hs.length;
                            },
                            //group:"wwyj_qinyan1",
                            forced: true,
                            popup: false,
                        ...
                        wwyj_xiyuan2: {
                            ...
                            content() {
                                ...
                                for (var i of game.players) {
                                    //QQ
                                    if (i.hasSkill('wwyj_xiyuan1')) {
                                        i.removeSkill('wwyj_xiyuan1');
                                    }
                                }
                            },
                        },
                        ...
                        wwyj_xiyuan: {
                            ...
                            content() {
                                ...
                                //});
                                //player.chooseTarget('请选择至多'+get.cnNumber(Math.min(player.countCards('h'),Math.min(num1,num2)))+'名其他角色,各交给一张手牌,这些角色各交回给你一张其他手牌',[1,Math.min(player.countCards('h'),Math.min(num1,num2))],function(card,player,target){
                                player.chooseTarget(
                                    '请选择一至' + get.cnNumber(Math.min(player.countCards('h'), num1)) + '名其他角色,各交给一张手牌,这些角色各交回给你一张其他手牌',
                                    [1, Math.min(player.countCards('h'), num1)],
                                    true,
                                    function (card, player, target) {
                                ...
                                if (event.num < event.targets.length) {
                                    event.targets[event.num].chooseCard('交给' + get.translation(player) + '一张手牌', 'h', true, function (card) {
                                        return !event.targets[event.num].storage.wwyj_xiyuan1.includes(card);
                                    }).ai = function (card) {
                        ...
                        wwyj_jinyan1: {
                            ...
                            _priority: 10,
                            filter(event, player) {
                                return player.hasSkill('wwyj_jinyan2') && event.card && event.card.suit == player.storage.wwyj_jinyan;
                            },
                            content() {
                        ...
                        wwyj_jinyan2: {
                            ...
                            mod: {
                                cardEnabled(card, player, event) {
                                    if (card.suit != player.storage.wwyj_jinyan) return false;
                                },
                                cardUsable(card, player, event) {
                                    //if(!player.storage.wwyj_jinyan.includes(card.name)) return false;
                                    if (card.suit != player.storage.wwyj_jinyan) return false;
                                },
                                cardRespondable(card, player, event) {
                                    if (card.suit != player.storage.wwyj_jinyan) return false;
                                },
                                cardSavable(card, player, event) {
                                    if (card.suit != player.storage.wwyj_jinyan) return false;
                                },
                            },
                            intro: {
                        ...
                        wwyj_jinyan: {
                            ...
                            content() {
                                ...
                                player
                                    .chooseButton(true, [[list, 'vcard']])
                                    .set('filterButton', function (button) {
                                        if (target.storage.wwyj_jinyan && target.storage.wwyj_jinyan.includes(button.link[2])) return false;
                                        return true;
                                    })
                                    .set('ai', function (button) {
                                        var rand = _status.event.rand * 2;
                        ...
                        wwyj_gonggao2: {
                            ...
                            forced: true,
                            filter(event, player) {
                                return event.source && event.source.isAlive() && player != _status.currentPhase;
                            }, //QQQ
                            content() {
                            ...
                            content() {
                                ...
                                if (list.length) {
                                    player
                                        ...
                                        .set('prompt', get.prompt('wwyj_gonggao'))
                                        .set('prompt2', get.translation('wwyj_gonggao_info'));
                                } else event.finish();
                                ('step 1');
                                if (result.control) {
                        ...
                        wwyj_heimao: {
                            ...
                            content() {
                                ...
                                ui.background.setBackgroundImage('extension/文武英杰/image/wenwuyingjie.jpg');
                                ('step 2');
                                if (game.dead.length) {
                                    var list = [];
                        ...
                        wwyj_liusha: {
                            ...
                            content() {
                                'step 0';
                                player
                                    .chooseTarget('流沙', 1, lib.translate.wwyj_liusha_info, function (card, player, target) {
                                ...
                                if (result.bool) {
                                    player
                                        .discardPlayerCard(result.targets[0], 'hej', get.prompt('wwyj_liusha'))
                                        .set('ai', function (button) {
                        ...
                        wwyj_keai: {
                            ...
                            filter(event, player, name) {
                                if (name == 'loseAfter') return !player.countCards('h') && event.hs && event.hs.length;
                                return game.hasPlayer(function (current) {
                        ...
                        wwyj_qianshang: {
                            ...
                            content() {
                                'step 0';
                                player
                                    .chooseCardButton(trigger.cards, 1, '选择使用' + get.translation(trigger.player) + '所弃置的其中一张牌')
                                    .set('filterButton', function (button) {
                                        return game.hasPlayer(function (current) {
                        ...
                        wwyj_mingka: {
                            ...
                            audio: ['xianzhen', 2],
                            filter(event, player) {
                                return event.card && event.card.name == 'sha' && player.countCards('he', { type: 'equip' });
                            },
                            content() {
                                'step 0';
                        ...
                        wwyj_qisi_sha: {
                            ...
                            content() {
                                //player.draw(player.maxHp-player.countCards('h'));
                                //game.playwwyj(['wwyj_qisi1','wwyj_qisi2'].randomGet());
                                game.trySkillAudio('wwyj_qisi', this, true);
                                player.turnOver();
                                trigger.untrigger();
                                trigger.responded = true;
                                trigger.result = { bool: true, card: { name: 'sha' } };
                        ...
                        wwyj_junshen: {
                            ...
                            content() {
                                ...
                                player
                                    .chooseControl()
                                    .set('choiceList', ['使用黑【杀】无距离限制,使用红【杀】没次数限制', '使用的【杀】可指定任意名目标且无视目标的防具'])
                                    .set('ai', function () {
                        ...
                        wwyj_qiaoji: {
                            ...
                            content() {
                                'step 0';
                                player
                                    .chooseCardButton('选择获得其中一张基本牌', trigger.cards, 1)
                                    .set('filterButton', function (button) {
                        ...
                        wwyj_yanyu: {
                                ...
                                if (Array.isArray(event.cards))
                                    for (var i of event.cards) {
                                        ...
                                        for (var j = 0; j < es.length; j++) {
                                            if (get.subtype(i) == get.subtype(es[j])) {
                                                return game.hasPlayer(function (current) {
                            ...
                            content() {
                                'step 0';
                                player
                                    .chooseCardButton('选择其中一张装备牌', trigger.cards, 1)
                                    .set('filterButton', function (button) {
                        ...
                        wwyj_bingmou: {
                            ...
                            mod: {
                                ...
                                selectTarget(card, player, range) {
                                    if (card.name == 'sha' && Array.isArray(range) && range[1] != -1) range[1] += player.getAttackRange() - 1;
                                },
                            },
                        },
                        wwyj_gaochang: {
                        ...
                        wwyj_jiguang_shan2: {
                            ...
                            content() {
                                'step 0';
                                player
                                    .chooseTarget('极光', 1, lib.translate.wwyj_jiguang_shan2_info, true, function (card, player, target) {
                                ...
                                if (result.targets?.length) {
                                    ...
                                    player
                                        .chooseCardButton(event.cards, 1, '弃置' + get.translation(event.target) + '的一张装备区的防具牌或防御马或宝物牌', true)
                                        .set('filterButton', function (button) {
                                            return game.hasPlayer(function (current) {
                        ...
                        wwyj_jiguang_sha: {
                            ...
                            content() {
                                ...
                                ('step 1');
                                player
                                    .chooseCardButton(event.cards, 1, '弃置' + get.translation(target) + '装备区的武器牌或进攻马,视为使用一张【杀】', true)
                                    .set('filterButton', function (button) {
                                        return game.hasPlayer(function (current) {
                                            return player.canUse(button.link, current);
                                        });
                        ...
                        wwyj_jiguang_rshan: {
                            ...
                            content() {
                                'step 0';
                                player
                                    .chooseTarget('极光', 1, lib.translate.wwyj_jiguang_rshan_info, function (card, player, target) {
                                        return target.countCards('e', { subtype: ['equip2', 'equip3', 'equip5'] });
                                    })
                                    .set('ai', function (target) {
                                        var num = game.countPlayer(function (current) {
                        ...
                        wwyj_jiguang_rsha: {
                            ...
                            content() {
                                'step 0';
                                player
                                    .chooseTarget('极光', 1, lib.translate.wwyj_jiguang_rsha_info, function (card, player, target) {
                                        return target.countCards('e', { subtype: ['equip1', 'equip4'] });
                                    })
                                    .set('ai', function (target) {
                                        var num = game.countPlayer(function (current) {
                        ...
                        wwyj_chengpiao: {
                            ...
                            content() {
                                ...
                                ('step 1');
                                player
                                    .chooseCardButton(event.cards, 1, '选择使用' + get.translation(target) + '的一张手牌')
                                    .set('filterButton', function (button) {
                                        return game.hasPlayer(function (current) {
                                            return player.canUse(button.link, current);
                                        });
                        ...
                        wwyj_touliang: {
                            ...
                            content() {
                                ...
                                ('step 1');
                                player
                                    .chooseTarget('选择发动【透凉】的目标', [1, event.num], lib.translate.wwyj_touliang_info, function (card, player, target) {
                        ...
                        wwyj_jinzhu_shan: {
                            ...
                            content() {
                                'step 0';
                                player
                                    .chooseCard(get.prompt2('wwyj_jinzhu'), 'he', function (card) {
                            ...
                            chooseButton: {
                                dialog(event, player) {
                                    ...
                                    for (var i = 0; i < lib.inpile.length; i++) {
                                        ...
                                        if (player.storage.wwyj_jilve.includes(name)) continue;
                                        if (name == 'sha') {
                                            list.push(['基本', '', 'sha']);
                                            list.push(['基本', '', 'sha', 'ice']);
                                            list.push(['基本', '', 'sha', 'fire']);
                        ...
                        wwyj_yanguan: {
                            ...
                            content() {
                                ...
                                if (result.bool) {
                                    ...
                                    trigger.cancel();
                                    //trigger.parent.excluded.add(trigger.targets);
                                } else {
                            ...
                            content() {
                                ...
                                for (var i = 0; i < skills.length; i++) {
                                    ...
                                    if (info != undefined && !info.charlotte && (!info.unique || info.gainable)) {
                                        ...
                                        if (event.skills.includes('wwyj_qianzhui')) {
                        ...
                        wwyj_xiadan: {
                            ...
                            content() {
                                ...
                                if (targets.length == 1) {
                                    ...
                                    player
                                        .chooseTarget(true, '选择【下单】的目标', function (card, player, target) {
                                            return _status.event.list.includes(target);
                                        })
                                        .set('list', targets)
                                        .set('ai', function (target) {
                                ...
                                if (event.target) {
                                    ...
                                    event.target.recover();
                                    event.target.chooseToUse({ name: 'sha' }, '是否使用一张【杀】？');
                                ...
                                player
                                    .chooseButton([get.prompt('wwyj_xiadan'), [list1.concat(list2), 'vcard']])
                                    .set('filterButton', function (button) {
                                        return true;
                                    })
                                    .set('ai', function (button) {
                    ...
                    translate: {
                        wwyj_chenwu: '辰午',
                        wwyj_chenwu_info: '其他角色的弃牌阶段开始时,若其手牌数大于手牌上限,你可以获得其一张手牌并展示之,若此牌为基本牌或普通锦囊牌,你可使用之',
                        ...
                        wwyj_shengbei: '圣杯',
                        wwyj_shengbei_info: '每回合每种情况限一次,当你需要使用或打出一张【杀】/【闪】时,你可以展示你手牌中的一张,若其他角色展示一张同名的手牌,视为你使用或打出之.若为使用【杀】则不计入次数',
                        wwyj_rongyao: '荣耀',
                        wwyj_rongyao_info: '当你受到伤害后,你可将牌堆顶X(你已损失的体力值)张牌置于武将牌上,称为<耀>.若你有<耀>,你不能成为黑色牌的目标',
                        wwyj_taoge: '套鸽',
                        wwyj_taoge_info: '回合结束时,你可选择一项:1、弃置任意张<贤>并令等量的其他角色各摸一张牌,你回复一点体力;2、将任意张<贤>交给等量的其他角色,该角色须弃置一张与之不同类别的手牌,否则其失去一点体力',
                        wwyj_zhiguo: '掷果',
                        wwyj_zhiguo_info: '</font><font color=#f00>锁定技</font> 场上女性角色摸牌阶段多摸一张牌并交给你一张牌,其回复1点体力',
                        wwyj_zhiguo2: '掷果',
                        wwyj_zhiguo2_info: '',
                        wwyj_pingfang: '评芳',
                        wwyj_pingfang_info: '准备阶段开始时,你可观看随机六张未登场的女性武将牌并选择一张,你可用这张牌替换一名其他角色的武将牌',
                        wwyj_qingyan: '倾颜',
                        wwyj_qingyan_info: '出牌阶段每名角色限一次,你可失去1点体力或弃置一张【酒】,令你或一名女性角色摸三张牌',
                        wwyj_fanxing: '繁星',
                        wwyj_fanxing_info: '出牌阶段,若你有<星>,你可以弃置所有的<星>,视为你使用了X张【万箭齐发】(X为你弃置的<星>的数量且至多为7)',
                        wwyj_huayue2: '花月',
                        wwyj_huayue1: '花月',
                        wwyj_huayue: '花月',
                        wwyj_huayue_info: '</font><font color=#f00>锁定技</font> 当你使用一张基本牌后,你将其置于武将牌上,称为<星>,摸一张牌;当你受到伤害后,若你有<星>,伤害来源获得你武将牌上的一张<星>牌,若该牌为红色,你回复1点体力,若为黑色,你对伤害来源造成1点伤害.',
                        wwyj_chansui: '残碎',
                        wwyj_chansui_info: '</font><font color=#f00>锁定技</font> 一名其他角色对你造成伤害后,其获得你武将上的一张<命>牌.若你武将牌上没有<命>牌,你进入濒死状态.',
                        wwyj_shengming2: '生命',
                        wwyj_shengming2_info: '</font><font color=#f00>锁定技</font> 准备阶段,若你的武将牌上有<命>武器牌,你将其中一张置于一名角色的装备区(可替换原装备),并摸等同与这张武器攻击范围数量的牌.当你武将牌上没有<命>牌时,你进入濒死状态.',
                        wwyj_shengming: '生命',
                        wwyj_shengming_info: '</font><font color=#f00>锁定技</font> 游戏开始或你进入游戏时,将所有武器牌置于你的武将牌上,称为<命>,你的手牌上限+X(X为<命>数).准备阶段,若你的武将牌上有<命>武器牌,你须将其中一张置于一名角色的装备区(可替换原装备),你摸等同与这张武器攻击范围数量的牌.',
                        wwyj_ranqi: '染柒',
                        ...
                        wwyj_fuji: '伏击',
                        wwyj_fuji_info: '<font color=#F0F>隐匿技</font> 当你于其他角色的回合登场后,你可与该角色交换装备牌,其翻面',
                        wwyj_guozhandraw: '国战',
                        ...
                        wwyj_leishao_1: '雷少',
                        wwyj_leishao: '雷少',
                        wwyj_leishao_info: '</font><font color=#f00>锁定技</font> 你受到雷属性伤害时,伤害减一;你的♣️️非装备牌均视为雷杀且无距离和次数限制',
                        wwyj_jianya: '剑牙',
                        wwyj_jianya_info: '当你受到伤害或击杀一名角色后,你可以选择一种牌的类型,随机观看牌堆中该类型的两张牌,选择获得其中任意张颜色为黑色的牌',
                        wwyj_zhichi: '咫尺',
                        ...
                        wwyj_jitui: '急退',
                        wwyj_jitui_info: '当你成为杀的目标时,你可观看牌堆顶的5张牌并选择其中一张,你须补回一张花色或类型或点数与此牌相同的牌(置于最后),再将这些牌置回牌堆顶',
                        wwyj_duiyi: '对弈',
                        wwyj_duiyi_info: '出牌阶段限一次,你可以与一名其他角色进行<对弈>:将牌堆顶的七张牌背面朝上展开,你与其轮流翻开展示其中的4张牌,未被翻开的牌置回牌堆顶,若翻开的牌中只有一种花色或花色各不相同,你获得这些牌并回复一点体力,否则其受到一点火／雷属性伤害',
                        wwyj_weiman: '伪漫',
                        ...
                        wwyj_yangshan: '扬善',
                        wwyj_yangshan_info: '当你受到伤害后,若你有红色牌,你可摸两张牌,将一张红色牌当不以你和伤害来源为目标的【桃园结义】使用',
                        wwyj_jieyuan4: '解缘',
                        ...
                        wwyj_1: '薄荷',
                        wwyj_bohe: '薄荷',
                        wwyj_bohe_info: '出牌阶段限一次,你可声明一种类别的牌,直到你的下回合开始,每名角色的回合限一次,每当一名角色使用一张类别与该类别相同的非转化的牌时(不包括延时性锦囊牌),你可令其摸一张牌 <font color=#F0F>可突破</font>',
                        wwyj_jiegeng: '接更',
                        ...
                        wwyj_feixue: '飞雪',
                        wwyj_feixue_info: '当你使用【杀】时,你可令此【杀】额外指定所有武将牌背面朝上的角色,令这些角色翻面',
                        wwyj_zangyue: '葬月',
                        wwyj_zangyue_info: '</font><font color=#f00>锁定技</font> 回合结束阶段,你可选择一种花色,令所有其他角色在其下个结束阶段前,其回合内使用该花色的牌后将武将牌翻面',
                        wwyj_gucheng: '孤城',
                        ...
                        wwyj_duange: '短歌',
                        wwyj_duange_info: '摸牌阶段摸牌时,你可放弃摸牌,改为展示牌堆顶的五张牌,选择获得其中任意张点数同为奇数或同为偶数的牌,再将剩下的牌按先后顺序置于牌堆顶',
                        wwyj_geziyin: '放鸽',
                        wwyj_geziyang: '放鸽',
                        wwyj_gezi: '鸽子',
                        wwyj_gezi_info: '<font color=#F0F>转换技</font> 出牌阶段限一次效果:<li>阳:你可弃置一张红色手牌并令任意名有手牌的角色各展示一张手牌,你可展示一张手牌,横置/重置展示牌与该牌颜色相同的角色,若已横置的角色比未模置的多,你摸一张牌<li>阴:你交给一名其他角色一张黑色手牌,令其选择至少一名角色,你选择横置/重置其所选择的或未选择的角色,若已横置的角色比未模置的多,你摸一张牌',
                        wwyj_wuqing: '无情',
                        ...
                        wwyj_sepi2: '献媚',
                        wwyj_sepi: '色批',
                        wwyj_sepi_info: '每名女性角色的出牌阶段限一次,其可弃置一张手牌,其弃置你的一张手牌,若这两张手牌颜色相同,其与你各选择摸一张牌或回复一点体力(若任一方没受伤则改为摸一张牌),否则各摸一张牌',
                        wwyj_shaozhu: '少主',
                        ...
                        wwyj_lunpo: '论破',
                        wwyj_lunpo_info: '任意有<丸>标记的角色弃牌阶段弃牌时,若其弃置的牌均为不同花色的牌时,你可选择一项:①回复一点体力并摸一张牌;②令该角色受到你造成的一点伤害,其弃置<丸>标记 <font color=#F0F>可突破</font>',
                        wwyj_dansha: '弹杀',
                        wwyj_dansha_info: '当你受到伤害时,你可先选择是否令一名没<丸>标记的其他角色获得<丸>标记,你再对场上随机一名有<丸>标记的角色造成等量点伤害并令其随机弃置一张牌',
                        wwyj_qinyan: '勤言',
                        wwyj_qinyan_info: '</font><font color=#f00>锁定技</font> 回合内,当你失去所有手牌后,你将手牌补至当前体力值且你本回合对本回合发动<释援>的目标使用牌时,无视距离和次数限制',
                        wwyj_xiyuan: '释援',
                        wwyj_xiyuan_info: '出牌阶段限一次,你可以选择交给一至X名有手牌的其他角色各一张手牌,令这些角色分别交给你一张其他的手牌(X为场上手牌数小于其体力上限的角色数)',
                        wwyj_xuanxia: '玄侠',
                        wwyj_xuanxia_info: '<span class=yellowtext>限定技</span> 当你进入濒死状态时,你可回复体力至场上<星>的数量,获得场上所有的<星>,并分别视为对这些角色使用一张【杀】 <font color=#F0F>可突破</font>',
                        wwyj_huanyu: '寰宇',
                        wwyj_huanyu_info: '出牌阶段限一次,你可将场上所有有<星>的角色的<星>收为手牌,再逐一将一张手牌当<星>放置于这些角色的武将牌上',
                        wwyj_xingcheng2: '星城',
                        wwyj_xingcheng1: '星',
                        wwyj_xingcheng: '星城',
                        ...
                        wwyj_gonggao1: '公告',
                        wwyj_gonggao: '公告',
                        wwyj_gonggao_info: '当你受到伤害后,你可声明一种牌的类型,令回合外曾对你造成过伤害的所有其他角色交给你一张手牌,否则你弃置其一张手牌并视为对其使用一张【杀】.若其交给你的牌与你声明的类型相同,其摸一张牌',
                        wwyj_jinyan2: '禁言',
                        wwyj_jinyan1: '禁言',
                        wwyj_jinyan: '禁言',
                        wwyj_jinyan_info: '出牌阶段限一次,若场上没角色被禁言,你可以选择一名其他角色并声明一种花色,其因被禁言只能使用该花色的牌,直到其使用这花色的牌才解除禁言状态',
                        wwyj_gainian: '概念',
                        wwyj_gainian_info: '出牌阶段限一次,你可声明一张基本牌或普通锦囊牌,若如此做,若你未发动技能【黑猫】,你须失去一点体力并翻面,令场上所有其他角色弃置一张与你所声明的牌名字相同的手牌,否则你摸一张牌',
                        wwyj_heimao: '黑猫',
                        wwyj_heimao_info: '<span class=greentext>觉醒技</span> 当你进入濒死状态时,你弃置你区域内的所有牌并重置武将牌,回复体力至体力上限并将手牌补至体力上限,选择一名已阵亡的角色令其复活,体力回复至体力上限并补手牌至体力上限.若为身份局,你与其交换身份牌',
                        wwyj_liusha: '流沙',
                        ...
                        wwyj_gaochang: '高产',
                        wwyj_gaochang_info: '你的摸牌阶段摸牌时,你可令摸牌数+X(X为偷师标记数),偷师标记清零',
                        wwyj_qiuxue: '求学',
                        ...
                        wwyj_shengshen: '圣神',
                        wwyj_shengshen_info: '每轮限一次,当一名角色进入濒死状态时,你可以观看牌堆顶的两张牌,弃置其中一张红色牌视为对其使用一张【桃】.若其中没有红色牌且你有红色的手牌,你可以弃置你的所有红色手牌,视为对其使用一张【桃】',
                        wwyj_kaiche: '开车',
                        ...
                        wwyj_jiguang_sha: '极光',
                        wwyj_jiguang_sha_info: '出牌阶段,若你未使用过【杀】,你可选择一名角色的装备区的武器牌或进攻马并令其弃置之,视为使用一张【杀】,你本回合不能再使用【杀】',
                        wwyj_jiguang: '极光',
                        ...
                        wwyj_jiangsha: '键杀',
                        wwyj_jiangsha_info: '</font><font color=#f00>锁定技</font> 当你成为【杀】的目标时,若来源的武将牌正面朝上,你将手牌补至体力上限.若此【杀】造成伤害,该角色摸一张牌翻面',
                        wwyj_daigeng: '代更',
                        ...
                        wwyj_kangfu: '康复',
                        wwyj_kangfu_info: '</font><font color=#f00>锁定技</font> 你的进攻距离+1;你的装备牌不计入手牌上限;当你脱离濒死状态或你击杀一名角色后,你回复一点体力并选择回复一个装备栏',
                        wwyj_jinzhu_shan: '烬铸',
                        ...
                        wwyj_lilun: '理论',
                        wwyj_lilun_info: '每当你使用一张非延时性锦囊牌时,你可以观看牌堆顶的三张牌,获得其中的一张牌,将其余两张牌先后置于牌堆顶',
                        wwyj_yanguan: '严管',
                        wwyj_yanguan_info: '每名角色的回合限一次,每当一名其他角色使用非延时性锦囊牌时,你可以弃置一张手牌令其失效,你获得此牌',
                        wwyj_jinxiu: '进修',
                        wwyj_jinxiu_info: '</font><font color=#f00>锁定技</font> 结束阶段你摸X张牌(X为你本回合造成的伤害次数)',
                        wwyj_ciya: '呲牙',
                        wwyj_ciya_info: '摸牌阶段开始时,你可少摸一张牌,视为对攻击范围内包含有你的任意名其他角色各使用一张【杀】',
                        wwyj_qianzhui: '潜追',
                        wwyj_qianzhui_info: '<span class=yellowtext>限定技</span> 当一名其他角色阵亡时,你选择失去技能【签到】或【嘤怪】,选择获得该角色的一个的技能',
                        wwyj_yingguai: '嘤怪',
                        ...
                        wwyj_caizhi4: '画',
                        wwyj_caizhi: '才智',
                        wwyj_caizhi_info: '</font><font color=#f00>锁定技</font> 你的回合开始时,你随机从【琴棋书画】中获得一项你未获得的技能.当你受到伤害时,若你已获得的【琴棋书画】中的至少一项,随机移除其中一项,伤害减一<li>注:【琴棋书画】分别对应:卡战、对弈、极略、理论',
                        wwyj_recaizhi: '才智',
                        wwyj_recaizhi_info: '</font><font color=#f00>锁定技</font> 你的回合开始时,你随机从【文武英杰】中获得一项你未获得的技能.当你受到伤害时,若你已获得的【文武英杰】中的至少一项,随机移除其中一项,伤害减一<li>注:【文武英杰】分别对应:概念、咫尺、禁言、少主',
                        wwyj_qunying: '群英',
                        ...
                        wwyj_ancha: '暗察',
                        wwyj_ancha2: '暗察',
                        wwyj_ancha_info: '当一名角色受到来源不为你的伤害后,你可观看伤害来源的手牌,该受到伤害的角色摸一张牌.若为你受到伤害,你将你的武将牌正面朝上,当前回合结束后,你进行一个额外的回合',
                        wwyj_huikeng: '回坑',
                        wwyj_huikeng_info: '出牌阶段限一次,你可随机展示X(其他角色数)张武将牌,逐一选择其中一张,按次序替换其他角色的武将牌(体力上限与体力不变),每替换一名角色你就摸一张牌',
                        wwyj_liangcha: '凉茶',
                        ...
                        wwyj_xiadan: '下单',
                        wwyj_xiadan_info: '出牌阶段限一次,你可<下单>交给<接单者>一张牌,其回复一点体力且其可使用一张【杀】,你选择获得一张基本牌或非延时锦囊牌',
                        wwyj_xiadan1: '单',
                        wwyj_xiadan1_info: '',
                        wwyj_jiedan: '接单',
                        wwyj_jiedan_info: '每名角色的出牌阶段限一次,其可以<下单>交给你一张牌,你回复一点体力且你此时可使用一张【杀】,其选择获得一张基本牌或非延时锦囊牌',
                        wwyj_shuihu: '水乎',
                        wwyj_jiguangs: '极光',
                ...
                for (var i in wenwuyingjie.character) {
                    wenwuyingjie.character[i][4].push('ext:文武英杰/image/' + i + '.jpg');
                }
                lib.config.all.characters.add('wenwuyingjie');
                lib.config.characters.add('wenwuyingjie');
            ...
            game.addMode(
                'wenwuyingjiepicture',
                {
                    game: {
                        syncMenu: true,
                        createview(node, charalist, liblist) {
                            var player = ui.create.player(null, true);
                            player.init(charalist[0]);
                            player.node.avatar.setBackgroundImage('extension/文武英杰/image/' + charalist[0] + '.jpg');
                            ...
                            dialog.addText('<div><div id="Cdetail" style="width:75%;display:block;left:150px;text-align:left;font-size:16px"><span class="bluetext">角色介绍</span>:' + get.characterIntro(charalist[0]) + '<br>' + liblist[0].join('<br>'));
                            ...
                            for (var i = 0; i < dialog1.buttons.length; i++) {
                                ...
                                dialog1.buttons[i].onclick = function () {
                                    ...
                                    player.node.avatar.setBackgroundImage('extension/文武英杰/image/' + charalist[this.value] + '.jpg');
                                };
                            }
                        },
                    },
                    start() {
                        ...
                        ui.background.setBackgroundImage('extension/文武英杰/image/wwyj_picture.jpg');
                        //上一行为背景
                        ...
                        if (lib.config.background_music != 'music_off' && get.config('wwyj_openmusic')) {
                            ui.backgroundMusic.src = 'extension/文武英杰/audio/wwyj_music.mp3';
                        ...
                        wenwuview: {
                            ...
                            showcase(init) {
                                ...
                                if (init) {
                                    var charalist = [];
                                    for (var i in lib.characterPack.wenwuyingjie) {
                                        var wenwu = ['wwyj_shuihu', 'wwyj_remaliao', 'wwyj_liangchax', 'wwyj_shennais', 'wwyj_guihua', 'wwyj_duanges', 'wwyj_guchengs', 'wwyj_hezifengyun', 'wwyj_qingzhongs', 'wwyj_bohetang', 'wwyj_zhulinqixian', 'wwyj_niya', 'wwyj_zhongchengpantu', 'wwyj_huanyuxingcheng', 'wwyj_xuedaoshaozhu', 'wwyj_fux2', 'wwyj_shenwangquanjian', 'wwyj_wuqinggezi', 'wwyj_yiwangs', 'wwyj_liushas', 'wwyj_tilongjianiao', 'wwyj_qianshangs', 'wwyj_limuzi', 'wwyj_zhaonies', 'wwyj_yitiaoxianyu', 'wwyj_lengyus', 'wwyj_yanyumoran', 'wwyj_wali', 'wwyj_danwuyunxi', 'wwyj_jiguangs', 'wwyj_zhugejun', 'wwyj_taishangdaniu', 'wwyj_maliao', 'wwyj_shenzuo', 'wwyj_shijian', 'wwyj_xuebi', 'wwyj_huijin', 'wwyj_chengxuyuan', 'wwyj_pipi', 'wwyj_Sukincen', 'wwyj_liangchas', 'wwyj_ziyage', 'wwyj_kanpoyiqie', 'wwyj_kelejiabing', 'wwyj_feicheng', 'wwyj_tianqikui', 'wwyj_zhichitianya', 'wwyj_jianyaleishao', 'wwyj_anshas', 'wwyj_zhuxiaoer', 'wwyj_ranqis', 'wwyj_chansuideshengming', 'wwyj_fanxings', 'wwyj_xingyunnvshen', 'wwyj_lunhuizhong', 'wwyj_daxiongxiaimao', 'wwyj_wzszhaoyun', 'wwyj_yangguangweiliang', 'wwyj_rongyaotaoge', 'wwyj_chenwus'];
                                        if (wenwu.includes(i)) charalist.push(i);
                                    }
                                    var liblist = [
                                        ['<span class="bluetext">创世</span>:<span class=greentext>觉醒技</span> 游戏开始所有角色摸牌后或你进入游戏时(对决模式),你令其他角色从十名备选角色(关羽、张飞、赵云、马超、马忠、公孙瓒、黄盖、吕蒙、仁王禁、许禇)中挑选一名并变身成为之 <font color=#F0F>可突破</font><br><span class="bluetext">潜伏</span>:</font><font color=#f00>锁定技</font> 回合结束时,若你的武将牌正面朝上,你翻面.当你的武将牌背面朝上,你的防御距离为无限<br><span class="bluetext">暗察</span>:当一名角色受到来源不为你的伤害后,你可观看伤害来源的手牌,该受到伤害的角色摸一张牌.若为你受到伤害,你将你的武将牌正面朝上,当前回合结束后,你进行一个额外的回合<br><span class="bluetext">回坑</span>:出牌阶段限一次,你可随机展示X(其他角色数)张武将牌,逐一选择其中一张,按次序替换其他角色的武将牌(体力上限与体力不变),每替换一名角色你就摸一张牌'],
                                        ...
                                        ['<span class="bluetext">才智</span>:</font><font color=#f00>锁定技</font> 你的回合开始时,你随机从【琴棋书画】中获得一项你未获得的技能.当你受到伤害时,若你已获得的【琴棋书画】中的至少一项,随机移除其中一项,伤害减一<li>注:【琴棋书画】分别对应:卡战、对弈、极略、理论<br><span class="bluetext">代写</span>:出牌阶段限一次,若你已获得的【琴棋书画】中的至少一项技能,你可选择其中一项交给一名没有【琴棋书画】中任意一项与你相同的其他角色'],
                                        ...
                                        ['<span class="bluetext">接单</span>:每名角色的出牌阶段限一次,其可以<下单>交给你一张牌,你回复一点体力且你此时可使用一张【杀】,其选择获得一张基本牌或非延时锦囊牌'],
                                        ...
                                        ['<span class="bluetext">签到</span>:当一名其他角色判定牌生效后,你可获得其一张牌<br><span class="bluetext">嘤怪</span>:当你受到伤害后,你可令一名其他角色随机使用一张延时性锦囊牌(闪电、乐不思蜀、兵粮寸断)<br><span class="bluetext">潜追</span>:<span class=yellowtext>限定技</span> 当一名其他角色阵亡时,你选择失去技能【签到】或【嘤怪】,选择获得该角色的一个的技能'],
                                        ['<span class="bluetext">呲牙</span>:摸牌阶段开始时,你可少摸一张牌,视为对攻击范围内包含有你的任意名其他角色各使用一张【杀】<br><span class="bluetext">进修</span>:</font><font color=#f00>锁定技</font> 结束阶段你摸X张牌(X为你本回合造成的伤害次数)'],
                                        ['<span class="bluetext">理论</span>:每当你使用一张非延时性锦囊牌时,你可以观看牌堆顶的三张牌,获得其中的一张牌,将其余两张牌先后置于牌堆顶<br><span class="bluetext">严管</span>:每名角色的回合限一次,每当一名其他角色使用非延时性锦囊牌时,你可以弃置一张手牌令其失效,你获得此牌'],
                                        ...
                                        ['<span class="bluetext">车祸</span>:</font><font color=#f00>锁定技</font> 游戏开始所有角色摸牌后或你进入游戏时,你废除所有的装备栏<br><span class="bluetext">康复</span>:</font><font color=#f00>锁定技</font> 你的进攻距离+1;你的装备牌不计入手牌上限;当你脱离濒死状态或你击杀一名角色后,你回复一点体力并选择回复一个装备栏<br><span class="bluetext">烬铸</span>:你可以把你的装备牌当做任意基本牌使用或打出'],
                                        ['<span class="bluetext">代更</span>:每轮限一次,当一名角色翻面至武将牌背面朝上时,当前回合结束后,你可以执行一个额外的回合<br><span class="bluetext">键杀</span>:</font><font color=#f00>锁定技</font> 当你成为【杀】的目标时,若来源的武将牌正面朝上,你将手牌补至体力上限.若此【杀】造成伤害,该角色摸一张牌翻面'],
                                        ...
                                        ['<span class="bluetext">开车</span>:</font><font color=#f00>锁定技</font> 摸牌阶段摸牌时,你额外摸X张牌,你的手牌上限加X(X为场上女性角色数且至少为1)<br><span class="bluetext">圣神</span>:每轮限一次,当一名角色进入濒死状态时,你可以观看牌堆顶的两张牌,弃置其中一张红色牌视为对其使用一张【桃】.若其中没有红色牌且你有红色的手牌,你可以弃置你的所有红色手牌,视为对其使用一张【桃】'],
                                        ...
                                        ['<span class="bluetext">偷师</span>:出牌阶段限一次,你可以交给一名其他角色一张牌,若如此做,你获得一枚偷师标记并摸一张牌,且可选择获得该角色的一项技能(主公技、觉醒技、限定技除外)直到下个出牌阶段开始<br><span class="bluetext">求学</span>:<span class=greentext>觉醒技</span> 若你已发动至少3次【偷师】,你失去一点体力上限,回复1点体力并获得技能【高产】<br><span class="bluetext">高产</span>:你的摸牌阶段摸牌时,你可令摸牌数+X(X为偷师标记数),偷师标记清零'],
                                        ...
                                        ['<span class="bluetext">概念</span>:出牌阶段限一次,你可声明一张基本牌或普通锦囊牌,若如此做,若你未发动技能【黑猫】,你须失去一点体力并翻面,令场上所有其他角色弃置一张与你所声明的牌名字相同的手牌,否则你摸一张牌 <font color=#F0F>可突破</font><br><span class="bluetext">黑猫</span>:<span class=greentext>觉醒技</span> 当你进入濒死状态时,你弃置你区域内的所有牌并重置武将牌,回复体力至体力上限并将手牌补至体力上限,选择一名已阵亡的角色令其复活,体力回复至体力上限并补手牌至体力上限.若为身份局,你与其交换身份牌'],
                                        ['<span class="bluetext">公告</span>:当你受到伤害后,你可声明一种牌的类型,令回合外曾对你造成过伤害的所有其他角色交给你一张手牌,否则你弃置其一张手牌并视为对其使用一张【杀】.若其交给你的牌与你声明的类型相同,其摸一张牌<br><span class="bluetext">禁言</span>出牌阶段限一次,若场上没角色被禁言,你可以选择一名其他角色并声明一种花色,其因被禁言只能使用该花色的牌,直到其使用这花色的牌才解除禁言状态'],
                                        ['<span class="bluetext">星城</span>:当你受到伤害后,你可将牌堆顶的一张牌置于一名没有<星>的其他角色的武将牌上,称为<星>;当一名角色阵亡或受到你造成的伤害时,若其有<星>,你可以获得该角色的<星><br><span class="bluetext">寰宇</span>:出牌阶段限一次,你可将场上所有有<星>的角色的<星>收为手牌,再逐一将一张手牌当<星>放置于这些角色的武将牌上<br><span class="bluetext">玄侠</span>:<span class=yellowtext>限定技</span> 当你进入濒死状态时,你可回复体力至场上<星>的数量,获得场上所有的<星>,并分别视为对这些角色使用一张【杀】 <font color=#F0F>可突破</font>'],
                                        ['<span class="bluetext">释援</span>:出牌阶段限一次,你可以选择交给一至X名有手牌的其他角色各一张手牌,令这些角色分别交给你一张其他的手牌(X为场上手牌数小于其体力上限的角色数)<br><span class="bluetext">勤言</span>:</font><font color=#f00>锁定技</font> 回合内,当你失去所有手牌后,你将手牌补至当前体力值且你本回合对本回合发动<释援>的目标使用牌时,无视距离和次数限制'],
                                        ['<span class="bluetext">弹杀</span>:当你受到伤害时,你可先选择是否令一名没<丸>标记的其他角色获得<丸>标记,你再对场上随机一名有<丸>标记的角色造成等量点伤害并令其随机弃置一张牌<br><span class="bluetext">论破</span>:任意有<丸>标记的角色弃牌阶段弃牌时,若其弃置的牌均为不同花色的牌时,你可选择一项:①回复一点体力并摸一张牌;②令该角色受到你造成的一点伤害,其弃置<丸>标记 <font color=#F0F>可突破</font>'],
                                        ...
                                        ['<span class="bluetext">接管</span>:一名其他角色出牌阶段开始时,若其有手牌且手牌数不小于你的,你可以获得其一张手牌.若如此做,此阶段结束时,若其造成过伤害,则视为其对你使用一张【杀】,否则你视为对其使用一张【杀】<br><span class="bluetext">色批</span>:每名女性角色的出牌阶段限一次,其可弃置一张手牌,其弃置你的一张手牌,若这两张手牌颜色相同,其与你各选择摸一张牌或回复一点体力(若任一方没受伤则改为摸一张牌),否则各摸一张牌'],
                                        ['<span class="bluetext">鸽子</span>:转换技,出牌阶段限一次效果:<li>阳:你可弃置一张红色手牌并令任意名有手牌的角色各展示一张手牌,你可展示一张手牌,横置/重置展示牌与该牌颜色相同的角色,若已横置的角色比未模置的多,你摸一张牌<li>阴:你交给一名其他角色一张黑色手牌,令其选择至少一名角色,你选择横置/重置其所选择的或未选择的角色,若已横置的角色比未模置的多,你摸一张牌<br><span class="bluetext">无情</span>:</font><font color=#f00>锁定技</font> 当一名角色受到属性伤害后,你摸一张牌'],
                                        ['<span class="bluetext">短歌</span>:摸牌阶段摸牌时,你可放弃摸牌,改为展示牌堆顶的五张牌,选择获得其中任意张点数同为奇数或同为偶数的牌,再将剩下的牌按先后顺序置于牌堆顶<br><span class="bluetext">美化</span>:每名角色的回合限一次,当一名角色使用一张单一目标的非装备牌、非延时锦囊牌的牌时,你可展示牌堆顶的两张牌,选择改用其中合理的一张牌 <font color=#F0F>可突破</font>'],
                                        ['<span class="bluetext">孤城</span>:</font><font color=#f00>锁定技</font> 游戏轮数为奇数/偶数的回合,你不能成为点数为奇数/偶数的【杀】的目标 <br><span class="bluetext">葬月</span>:</font><font color=#f00>锁定技</font> 回合结束阶段,你可选择一种花色,令所有其他角色在其下个结束阶段前,其回合内使用该花色的牌后将武将牌翻面<br><span class="bluetext">飞雪</span>:当你使用【杀】时,你可令此【杀】额外指定所有武将牌背面朝上的角色,令这些角色翻面'],
                                        ...
                                        ['<span class="bluetext">薄荷</span>:出牌阶段限一次,你可声明一种类别的牌,直到你的下回合开始,每名角色的回合限一次,每当一名角色使用一张类别与该类别相同的非转化的牌时(不包括延时性锦囊牌),你可令其摸一张牌 <font color=#F0F>可突破</font><br><span class="bluetext">助善</span>:当一名角色使用杀时,若其手牌数不大于目标角色的手牌数,你可令此杀不可闪避'],
                                        ...
                                        ['<span class="bluetext">结缘</span>:出牌阶段限一次,你可以将任意张黑色牌交给没有『结缘』状态的角色,令其处于『结缘』状态.你防止受到『结缘』状态的角色造成的伤害,其受到伤害后,你摸一张牌.其可在其出牌阶段主动交给你一张红色牌解除『结缘』状态 <font color=#F0F>可突破</font> <br><span class="bluetext">扬善</span>:当你受到伤害后,若你有红色牌,你可摸两张牌,将一张红色牌当不以你和伤害来源为目标的【桃园结义】使用'],
                                        ...
                                        ['<span class="bluetext">对弈</span>:出牌阶段限一次,你可以与一名其他角色进行<对弈>:将牌堆顶的七张牌背面朝上展开,你与其轮流翻开展示其中的4张牌,未被翻开的牌置回牌堆顶,若翻开的牌中只有一种花色或花色各不相同,你获得这些牌并回复一点体力,否则其受到一点火／雷属性伤害 <br><span class="bluetext">急退</span>:当你成为杀的目标时,你可观看牌堆顶的5张牌并选择其中一张,你须补回一张花色或类型或点数与此牌相同的牌(置于最后),再将这些牌置回牌堆顶'],
                                        ['<span class="bluetext">剑牙</span>:当你受到伤害或击杀一名角色后,你可以选择一种牌的类型,随机观看牌堆中该类型的两张牌,选择获得其中任意张颜色为黑色的牌 <br><span class="bluetext">雷少</span>:</font><font color=#f00>锁定技</font> 你受到雷属性伤害时,伤害减一;你的黑色♣️️非装备牌均视为雷杀且无距离和次数限制'],
                                        ...
                                        ['<span class="bluetext">伏击</span>:<font color=#F0F>隐匿技</font> 当你于其他角色的回合登场后,你可与该角色交换装备牌,其翻面 <br><span class="bluetext">国战</span>:回合结束时或一名角色阵亡后,你可以从场上除你之外的势力中选择其中一个,直到下次发动【国战】前,该势力的角色受到伤害或回复体力时你摸一张牌,且当你需要打出杀或闪时,你可观看此势力的一名其他角色的手牌,选择打出一张符合情况的手牌'],
                                        ...
                                        ['<span class="bluetext">生命</span>:</font><font color=#f00>锁定技</font> 游戏开始或你进入游戏时,将所有武器牌置于你的武将牌上,称为<命>,你的手牌上限+X(<命>数).准备阶段,若你的武将牌上有<命>武器牌,你须将其中一张置于一名角色的装备区(可替换原装备),你摸等同与这张武器攻击范围数量的牌 <br><span class="bluetext">残碎</span>:</font><font color=#f00>锁定技</font> 一名其他角色对你造成伤害后,其获得你武将牌上的一张<命>牌.若你武将牌上没有<命>牌,你进入濒死状态'],
                                        ['<span class="bluetext">花月</span>:</font><font color=#f00>锁定技</font> 当你使用一张基本牌后,你将其置于武将牌上,称为<星>,摸一张牌;当你受到伤害后,若你有<星>,伤害来源获得你武将牌上的一张<星>牌,若该牌为红色,你回复1点体力,若为黑色,你对伤害来源造成1点伤害<br><span class="bluetext">繁星</span>:出牌阶段,若你有<星>,你可以弃置所有的<星>,视为你使用了X张【万箭齐发】(X为你弃置的<星>的数量且至多为7)'],
                                        ['<span class="bluetext">掷果</span>:</font><font color=#f00>锁定技</font> 场上女性角色摸牌阶段多摸一张牌并交给你一张牌,其回复1点体力 <br><span class="bluetext">评芳</span>:准备阶段开始时,你可观看随机六张未登场的女性武将牌并选择一张,你可用这张牌替换一名其他角色的武将牌'],
                                        ['<span class="bluetext">荣耀</span>:当你受到伤害后,你可将牌堆顶X(你已损失的体力值)张牌置于武将牌上,称为<耀>.若你有<耀>,你不能成为黑色牌的目标 <br><span class="bluetext">套鸽</span>:回合结束时,你可选择一项:1、弃置任意张<贤>并令等量的其他角色各摸一张牌,你回复一点体力;2、将任意张<贤>交给等量的其他角色,该角色须弃置一张与之不同类别的手牌,否则其失去一点体力'],
                                        ['<span class="bluetext">圣杯</span>:每回合每种情况限一次,当你需要使用或打出一张【杀】/【闪】时,你可以展示你手牌中的一张,若其他角色展示一张同名的手牌,视为你使用或打出之.若为使用【杀】则不计入次数 <br><span class="bluetext">辰午</span>:其他角色的弃牌阶段开始时,若其手牌数大于手牌上限,你可以获得其一张手牌并展示之,若此牌为基本牌或普通锦囊牌,你可使用之'],
                                        //  ['<span class="bluetext">模板</span>:</font><font color=#f00>锁定技</font> 模板 <br><span class="bluetext">狼杀</span>:</font><font color=#f00>锁定技</font> 模板'],
                                    ];
        ...
        help: {
            文武英杰: '<li>特别鸣谢:极光、瓦力、短歌、诗笺、一条咸鱼、寰宇星城、无情鸽子<li>界限突破:<br>小苏的【群英】去掉体力差与手牌差的条件限制<br>寰宇星城的【玄侠】改为每两轮限一次<br>短歌的【短歌】改为展示牌堆顶九张牌并选择获得点数连续的牌、美化改为展示牌堆顶四张牌,但开局或进场时体力上限减一<br>可乐加冰、浅觞的【退坑】在体力值变化时摸X张牌(X为你已损失的体力值)<br>极光的【卡战】由随机使用装备改为选择使用牌堆或弃牌堆中的一个装备<br>fux2的【论破】改为锁定技且合并选项效果<br>薄荷糖的【薄荷】由<你令其摸一张牌>改为<其令你摸一张牌><br>竹林七贤的【结缘】由交给对方黑色牌改为弃置黑色牌来发动<br>俺杀的【超越】有大改<br>水乎的【创世】由从十个标包武将中选改为从标准包所有的武将里选<br>松岛枫桂花的【概念】改为回合结束阶段发动',
        },
        config: {
            wwyj_help: {
                nopointer: true,
                ...
                item: {
                    ...
                    4: '<li>若武将界面没显示图片或点将找不到本扩展的角色,请先开启武将菜单界面的右上角的总开关,重启游戏,即可显示武将插画.关闭本扩展再重启就能删除本扩展',
            ...
            wwyj_hezizhashi: {
                name: '何子诈尸',
                intro: '稍改作者包的经典模式,开启后重启游戏生效.<li>效果:</font><font color=#f00>锁定技</font> 当一名角色阵亡后,若场上没有<何子风云>,<何子风云>在该阵亡角色身上复活,并令所有其他角色受到一点伤害,当前回合结束后,<何子风云>执行一个额外的回合',
                init: false,
            },
            wwyj_sjwjp: {
                name: '随机武将',
            ...
            wwyj_renormalize: {
                name: '诛天灭地',
                intro: '开启后重启游戏生效.所有武将的技能会被全部清空(慎用!此功能可克制99%的变态角色,比如弹丸杀的神座出流),关闭此开关再重启游戏后会回复原样',
                init: false,
            },
            wwyj_newtujianicon: {
                name: '图鉴按钮',
                        ...
                        case '2':
                            ...
                            ui.backgroundMusic.addEventListener('ended', function () {
                                if (lib.config.background_music == 'music_off') {
                                    ...
                                    ui.backgroundMusic.src = 'extension/文武英杰/audio/' + lib.config.wwyj_music + '.mp3';
                                }
                            });
                            break;
                    }
