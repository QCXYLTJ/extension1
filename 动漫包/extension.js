                    ...
                    skill: {
                        ...
                        须弥: {
                            ...
                            filter(event, player) {
                                ...
                                return event.player != player && event.player.countCards('h') > _status.event.player.hp;
                            },
                            content() {
                                'step 0';
                                var num = trigger.player.countCards('h') - _status.event.player.hp;
                        ...
                        摸鱼: {
                            ...
                            forced: true,
                            filter(event, player) {
                                return player.countCards('h') < Math.min(3);
                            },
                            content() {
                                player.draw(Math.min(3) - player.countCards('h'));
                            },
                        },
                        网瘾少年: {
                            nobracket: true,
                        ...
                        境界: {
                            ...
                            subSkill: {
                                ...
                                隙间偷窥: {
                                    ...
                                    filter(event, player) {
                                        if (event.player == player) return false;
                                        return event.player.countCards('h') && player.storage.境界 && player.storage.境界 >= 2;
                                    },
                                    content() {
                                        'step 0';
                            ...
                            content() {
                                ...
                                next.ai = function (card) {
                                    if (ai.get.effect(player, trigger.card, trigger.player, player) < 0) {
                                        if (get.tag(trigger.card, 'respondSha') && player.countCards('h', 'sha')) return 0;
                                        if (get.tag(trigger.card, 'respondShan') && player.countCards('h', 'shan')) return 0;
