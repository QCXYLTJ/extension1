        ...
        arenaReady() {
            ...
            lib.card.gwmaoxian_falanxisika = {
                ...
                async content(event, trigger, player) {
                    ...
                    if (list.length) {
                        const { links } = await player
                            .chooseVCardButton('使用一张金卡法术', list.randomGets(3), true)
                            .set('ai', (button) => {
                    ...
                    skill: {
                            ...
                            async content(event, trigger, player) {
                                ...
                                while (count-- > 0) {
                                    ...
                                    if (result.control == '获得两张牌') {
                                        const result1 = await player
                                            .chooseButton(['获得两张牌', cards], 2, true)
                                            .set('ai', function (button) {
                                        ...
                                        const result1 = await player
                                            .chooseButton(['使用一张牌', cards], 1, true)
                                            .set('ai', function (button) {
                        ...
                        QD_luanwu: {
                            ...
                            async content(event, trigger, player) {
                                ...
                                while (num-- > 0) {
                                    ...
                                    for (const i of game.players) {
                                        const result = await i
                                            .chooseButton(['视为使用无距离限制的杀或者伤害类锦囊', [list, 'vcard']])
                                            .set('ai', (button) => {
                                ...
                                for (const i of trigger.cards) {
                                    if (player.getCards('he').includes(i)) {
                                        if (get.color(i) == 'red') {
                                            player.draw();
                                            const result = await player
                                                .chooseBool(`令${get.translation(trigger.player)}回复1点体力`)
                                                .set('ai', () => get.recoverEffect(trigger.player, player, player))
                                                .forResult();
                                            if (result.bool) {
                        ...
                        QD_leiji: {
                            ...
                            async content(event, trigger, player) {
                                ...
                                const { targets } = await player
                                    .chooseTarget(`对一名角色造成${num}点雷电伤害`, lib.filter.notMe)
                        ...
                        鬼道: {
                            ...
                            async content(event, trigger, player) {
                                player.draw('nodelay');
                                const result = await player
                                    .chooseCard(get.translation(trigger.player) + '的' + (trigger.judgestr || '') + `判定为${get.translation(trigger.player.judging[0])},` + get.prompt('xinguidao'), 'hes')
                                    .set('ai', function (card) {
                        ...
                        慷忾: {
                            ...
                            async content(event, trigger, player) {
                                ...
                                if (trigger.target != player) {
                                    const { cards } = await player
                                        .chooseCard(true, 'h', `交给${get.translation(trigger.target)}一张牌`)
                                        .set('ai', function (card) {
                                            if (get.type(card) == 'equip') {
                                                return 2;
                                            }
                        ...
                        制衡: {
                            ...
                            async content(event, trigger, player) {
                                ...
                                const result = await player
                                    .chooseToDiscard('hes', [1, Infinity], true)
                                    .set('ai', function (card) {
                        ...
                        QD_wanyi: {
                            ...
                            forced: true,
                            async content(event, trigger, player) {
                                const result = await player.choosePlayerCard(trigger.target, true, 'he').forResult();
                        ...
                        比翼: {
                            ...
                            subSkill: {
                                ...
                                2: {
                                    ...
                                    async content(event, trigger, player) {
                                        const { cards } = await player
                                            .chooseToDiscard('he', `弃置一张牌,令${get.translation(trigger.card)}结算两次`)
                                            .set('ai', function (card) {
                            ...
                            subSkill: {
                                1: {
                                    ...
                                    async content(event, trigger, player) {
                                        ...
                                        const result1 = await player
                                            .chooseTarget('狂风', (c, p, t) => !t.hasSkill('QD_kuangfeng'), [1, game.players.length])
                                            .set('ai', (t) => t.isEnemiesOf(player))
                                            .forResult();
                        ...
                        QD_dinghuo: {
                            ...
                            async content(event, trigger, player) {
                                ...
                                const result = await player
                                    .chooseTarget(true, `对一名目标角色造成${num}点火焰伤害`, function (card, player, target) {
                        ...
                        QD_jueqing: {
                            ...
                            async content(event, trigger, player) {
                                const { cards } = await player
                                    .chooseToDiscard('弃置任意张牌,此伤害改为体力流失', 'he', [1, player.countCards('he')])
                                    .set('ai', (card) => {
                                        ...
                                        if (targets && targets[0]) {
                                            if (targets[0].hasJudge('lebu')) {
                                                ...
                                                const { targets: targets1 } = await player
                                                    .chooseTarget('选择移动乐不思蜀的目标', (c, p, t) => targets[0] != t)
                                                    .set('ai', (t) => -get.attitude(player, t))
                                                    .forResult();
                        ...
                        QD_luoshen: {
                            ...
                            async content(event, trigger, player) {
                                while (true) {
                                    const result = await player.judge('洛神', (card) => (get.color(card) == 'black' ? 2 : -1)).forResult();
                                    ...
                                    async content(event, trigger, player) {
                                        for (const npc of game.players) {
                                            ...
                                            if (cards && cards[0]) {
                                                ...
                                                const { links } = await player
                                                    .chooseButton([`令${get.translation(npc)}执行一项`, [['受到一点无来源火焰伤害', '翻面'], 'tdnodes']])
                                                    .set('ai', (button) => {
                        ...
                        QD_fanjian: {
                            ...
                            async content(event, trigger, player) {
                                ...
                                const result = await player.gainPlayerCard(event.target, 'he', true).forResult();
                                if (result?.links?.length) {
                        ...
                        QD_zhiheng: {
                            ...
                            async content(event, trigger, player) {
                                ...
                                const result = await player
                                    .discardPlayerCard(event.target, 'he', [1, hs.concat(es).length])
                                    .set('ai', (button) => 1)
                                    .forResult();
                            ...
                            async content(event, trigger, player) {
                                if (trigger.target != player) {
                                    const { bool } = await player
                                        .chooseBool('令此牌目标改为你')
                                        .set('ai', () => trigger.player.isEnemiesOf(player) || player.hp < player.maxHp)
                                        .forResult();
                                    if (bool) {
                        ...
                        QD_fenli: {
                            ...
                            async content(event, trigger, player) {
                                ...
                                const { links } = await player
                                    .chooseButton(['请选择令其跳过的阶段', [list, 'tdnodes']], [1, list.length])
                                    .set('ai', (button) => {
                                        if (trigger.player.isFriendsOf(player)) {
                                            if (button.link == '弃牌阶段') {
                                                return 5;
                                ...
                                backup(links, player) {
                                    return {
                                        ...
                                        async precontent(event, trigger, player) {
                                            ...
                                            const { links } = await player
                                                .choosePlayerCard(_status.currentPhase, true, 'he', 'visible')
                        ...
                        QD_sidi: {
                            ...
                            async content(event, trigger, player) {
                                const { links } = await player
                                    .choosePlayerCard(trigger.player, 'he', 'visible')
                        ...
                        QD_bixin: {
                            ...
                            async content(event, trigger, player) {
                                ...
                                const { links } = await player
                                    .chooseButton(['请选择类型', [lib.type.map((i) => [i, get.translation(i)]), 'tdnodes']])
                                    .set('ai', (b) => {
                        ...
                        QD_duishi: {
                            ...
                            async content(event, trigger, player) {
                                ...
                                const { targets } = await player
                                    .chooseTarget(`弃置一名角色前${type.length}个区域中的所有牌`)
                                    .set('ai', (t) => {
                                        let value = 0;
                        ...
                        QD_wengua: {
                            ...
                            async content(event, trigger, player) {
                                const { links } = await player.gainPlayerCard('he', trigger.player, true).set('gaintag', ['QD_wengua']).forResult();
                        ...
                        QD_rende: {
                            ...
                            async content(event, trigger, player) {
                                const { links } = await player
                                    .choosePlayerCard(event.target, 'he', [1, event.target.countCards('he')], 'visible')
                                    .set('ai', (b) => get.value(b.link))
                                    .forResult();
                                if (links?.length) {
                                    ...
                                    while (player.storage.QD_rende > 1) {
                                        ...
                                        if (list.length) {
                                            const result = await player
                                                .chooseButton(['视为使用一张基本牌', [list, 'vcard']])
                                                .set('ai', function (button) {
                                                    const player = _status.event.player;
                                                    const num = player.getUseValue(
                                                        {
