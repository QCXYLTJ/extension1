	...
	game.xjzhAchi = {
		...
		openAchievementEquipPage() {
			...
			var state = {
				...
				refreshPage() {
					//刷新书签
					if (state.zhuanshu_on) zhuanshu.style.backgroundImage = 'url(extension/仙家之魂/css/images/qishuyaojian/zhuanshu_on.png)';
					else zhuanshu.style.backgroundImage = 'url(extension/仙家之魂/css/images/qishuyaojian/zhuanshu.png)';
					if (state.tongyong_on) tongyong.style.backgroundImage = 'url(extension/仙家之魂/css/images/qishuyaojian/tongyong_on.png)';
					else tongyong.style.backgroundImage = 'url(extension/仙家之魂/css/images/qishuyaojian/tongyong.png)';
					//刷新奇术要件
