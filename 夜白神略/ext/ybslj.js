...
game.import('character', function (lib, game, ui, get, ai, _status) {
	var ybslj = {
		...
		characterSort: {
			ybdd: {
				order_xzhq: ['North_yanghuiyu', 'North_duyu', 'North_sunshangxiang', 'Northxx_sunshangxiang', 'North_zhugeliang', 'Northxx_zhugeliang', 'North_lidian', 'North_diaochan', 'North_beimihu', 'North_bulianshi', 'North_caojinyu', 'North_huangyueying', 'North_caoxiancaohua', 'North_sunhanhua'],
			...
			ybxh: {
				ybxh_ssj: ['ybxh_linyi', 'ybxh_zhanglongliyao'],
			},
			ybslj: {
				ybsl_ssln: ['ybsl_001sunlisong', 'ybsl_002chenailin', 'ybsl_003yanshuang', 'ybsl_004zhangyujie', 'ybsl_005wangruobing', 'ybsl_006wanghanzhen', 'ybsl_007wugege', 'ybsl_008wuyuxin', 'ybsl_009liyushan', 'ybsl_010zhouyue', 'ybsl_011gaoyuhang', 'ybsl_012zhengjiayi', 'ybsl_014liutianyu', 'ybsl_015wanghairu', 'ybsl_016manchengqi', 'ybsl_017xiaohong', 'ybsl_018zhangqing', 'ybsl_019shengyan', 'ybsl_020jiayutong', 'ybsl_021liuyufeng', 'ybsl_022salt', 'ybsl_023shiqingyu', 'ybsl_024yuetong', 'ybsl_025shiwang', 'ybsl_032baiyichen', 'ybsl_033xiaohui', 'ybsl_042pingzi', 'ybsl_043fangjiayu', 'ybsl_044huruihang', 'ybsl_045gaocong', 'ybsl_046jiangxuewu', 'ybsl_047shan', 'ybsl_048wushuang', 'ybsl_049waner', 'ybsl_050zunjian', 'ybsl_051fomalhaut', 'ybsl_052trees', 'ybsl_053qiuer', 'ybsl_054yueer', 'ybsl_055zhengyan', 'ybsl_056dongjianchao', 'ybsl_057sunmeiqi', 'ybsl_058sunshibo', 'ybsl_059starsFall', 'ybsl_060liutianhang', 'ybsl_061zheyu', 'ybsl_062yuhongyan', 'ybsl_063weimingli', 'ybsl_064lvmingyan', 'ybsl_065yanxiwen', 'ybsl_066wujun', 'ybsl_068qingyue', 'ybsl_070lvyanqiu', 'ybsl_079xiaoxin', 'ybsl_082bianqiuwen', 'ybsl_085DGY', 'ybsl_086GJ', 'ybsl_087tianlu', 'ybsl_088lijiaxin', 'ybsl_089lvjinling', 'ybsl_090dengtingyue', 'ybsl_091wangcaiyu', 'ybsl_092handan'],
				ybsl_mztz: ['ybsl_026can', 'ybsl_027rain', 'ybsl_028crystal', 'ybsl_029dawn', 'ybsl_030book', 'ybsl_031huanqing', 'ybsl_034zhoulianyuan', 'ybsl_035stamp', 'ybsl_036bright', 'ybsl_037diamondqueen', 'db_ybsl_038tengwu', 'ybsl_039zhafu', 'ybsl_040ether', 'db_ybsl_067snake', 'ybsl_069xiangzi', 'ybsl_076zhujun', 'ybsl_077yangqixu', 'ybsl_078zhuyahai', 'ybsl_081chenli', 'ybsl_081chensi', 'ybsl_083xiaozhu', 'ybsl_084zhangmi'],
				//'ybsl_sixp':[],
				ybsl_dzsl: ['dzsl_013yinji', 'dzsl_014liutianyu' /*,'dzsl_014xinzhikui'*/, 'dzsl_015wanghairu', 'dzsl_016manchengqi', 'dzsl_017xiaohong'],
				ybsl_spsp: ['db_ybsp_014liutianyu', 'ybsp_016manchengqi', 'ybsp_072sulingyi', 'db_ybsp_038tengwu', 'ybsp_001sunlisong', 'ybsp_002chenailin', 'ybsp_027rain'],
				ybsl_sjfk: ['ybslshen_014liutianyu', 'ybslshen_018zhangqing', 'ybslshen_017xiaohong', 'ybslshen_002chenailin', 'ybslshen_071faraway', 'ybslshen_073Al', 'ybslshen_074piao', 'ybsl_075dogcard', 'ybsl_080phoenix', 'ybslshen_001sunlisong', 'ybsl_hairi', 'ybslshen_100Cosette', 'sp_key_umi'],
				ybsl_jxtp: ['ybnb_034zhoulianyuan'],
				ybsl_sgsh: ['sgsh_huaxu', 'sgsh_taizichangqin', 'sgsh_nvba', 'sgsh_luohou', 'sgsh_dongwanggong', 'sgsh_yinglong', 'sgsh_xingtian', 'sgsh_xiwangmu', 'sgsh_yuqiang', 'sgsh_dayu'],
				ybsl_mjgx: ['dzsl_luxun', 'ybsl_machao', 'ybsl_zhouyuxiaoqiao', 'ybsl_zhanghe', 'ybslshen_zhenji', 'ybnb_guanyinping'],
				ybsl_laji: ['ybsl_018zhangqing_feian', 'ybslshen_002chenailin_feian', 'ybsb_084zhangmi', 'ybsb_077yangqixu', 'ybsb_068qingyue', 'ybsb_048wushuang', 'ybold_019shengyan'],
			},
		},
		character: {
			//武将格式 :
			...
			ten_caoyi: ['female', 'wei', 4, ['caoyi_miyi', 'caoyi_yinjun'], []], //-------掐指一算,本体曹轶应该快上来了,我这个就收起来了
			ybsl_windmoon: ['female', 'wei', 4, ['kagari_ybzongsi', 'xinfu_ybfalu', 'xinfu_ybzhenyi', 'xinfu_ybdianhua', /*'ybsl_kuwang','ybsl_guqu',*/ 'ybsl_aocai'], []],
			ybsl_mystery1: ['female', 'wei', 4, ['North_haoling', 'North_zhenglue'], []],
			North_pc: ['male', 'qun', 4, ['North_PC_zigong', 'North_PC_qianshui'], []],
			...
			//---------------------名将改写
			// 'dzsl_luxun':['male','wu',3,['dzsl_shenhuo','dzsl_buxi','dzsl_shennu'],['junk']],//陆逊
			...
			dzsl_014xinzhikui: ['female', 'YB_memory', 1, ['dz017_shanwu', 'dz014_qingling', 'dz014_yangkui', 'dz014_xianji'], ['legend']], //心之傀
			...
			ybsl_037diamondqueen: ['female', 'YB_dream', 6, ['yb037_yizhong', 'yb037_kexie', 'yb037_guiling', 'ybsl_sanmeng'], ['rare']], //梦——♦️️Q
			...
			ybsl_059starsFall1: ['female', 'YB_memory', 4, ['yb059_guanhong'], ['legend']], //鞠熒
			ybsl_059starsFall2: ['female', 'YB_memory', 4, ['yb059_zhuotan'], ['legend']], //宋橤
			ybsl_059starsFall3: ['female', 'YB_memory', 4, ['yb059_qingliu'], ['legend']], //周靈
			ybsl_059starsFall4: ['female', 'YB_memory', 4, ['yb059_pingyu'], ['legend']], //李曉
			...
			ybsl_083xiaozhu: ['female', 'YB_dream', 3, ['yb083_shenshou', 'ybsl_sanmeng'], ['epic']], //小筑
			ybsl_084zhangmi: ['female', 'YB_dream', 3, ['yb084_xundu', 'yb084_efei', 'yb084_pomeng'], ['legend']], //张汨
			// 'ybsl_085DGY':['female','YB_memory',3,['yb085_muyuan','yb085_cibie'],['epic']],//独孤雨
			...
			ybslshen_018zhangqing: ['female', 'shen', 3, ['yb018_isi', 'yb018_chongmeng', 'yb018_yisi', 'ybsl_xuxian'], ['YB_memory', 'legend']], //神张晴
			...
			//----------------------忆包废案
			ybslshen_002chenailin_feian: ['female', 'shen', '3/4', ['yb002_yiqu', 'ybold_shangyuan', 'ybsl_xuxian'], ['YB_memory', 'legend']], //废稿神陈爱琳
			ybsl_018zhangqing_feian: ['female', 'YB_memory', 3, ['yb018_huaimeng', 'yb018_yinsi'], ['epic']], //废稿张晴
			ybsb_084zhangmi: ['female', 'YB_dream', 3, ['yb084_efei', 'yb084_pomen'], ['epic']], //通渠张汨
			ybsb_077yangqixu: ['male', 'YB_dream', 3, ['yb077_shensu', 'yb077_yingmu', 'ybsl_sanmeng'], ['rare']], //羊祈絮
			ybsb_068qingyue: ['female', 'YB_memory', 3, ['yb010_mingzhu', 'yb068_chenyu', 'yb068_jingyue'], ['rare']], //清月姑娘
		...
		characterIntro: {
			...
			//---------------------------------//上古神话
			sgsh_huaxu: '<font color=cyan>上古神话-001</font><br>♦️️︎技能设计:夜白<br>♦️️︎代码撰写者:夜白<br>♦️️︎插图:网图<br>♦️️︎配音:暂无<br>&nbsp;&nbsp;华胥氏,简称华胥,最早见于<列子·黄帝>.相传是中国上古时期母系氏族部落的一位杰出女首领.是伏羲与女娲之母.她生在一个叫华阳的地方,有了华胥后改名(华胥国),古往今来,上百种中华典籍中均记载着一个叫华胥氏的氏族女首领及其儿女伏羲、女娲的故事.中国建国初期的多位朴素主义学者相信,华胥氏的历史比黄帝还要长得多.华胥国的传统服饰为长袍,即国服、华服,后来发展成为具有长袍特点的汉服,也与华胥国有关.<br><br>&nbsp;&nbsp;神话所记录的是一个民族早期的唯心世界观,以纪念族群中做过特别重大贡献的部落群体和首领.越朴实的神话,还原的早期先民生活和思想就越可信.<br><br>&nbsp;&nbsp;--来自搜狗百科', //华胥
			sgsh_taizichangqin: '<font color=cyan>上古神话-002</font><br>♦️️︎技能设计:夜白<br>♦️️︎代码撰写者:夜白<br>♦️️︎插图:网图<br>♦️️︎配音:暂无<br>&nbsp;&nbsp;太子长琴,<山海经>记载之神话人物.火神祝融的儿子,传说他出生的时候怀中抱着一把小琴,天地都因为他的出生而欢唱.<br><br>&nbsp;&nbsp;颛顼生老童,老童生祝融,祝融生太子长琴,传说太子长琴精于乐道,能使五色鸟舞于庭中.<左传>记载:<有五只彩鸟:一只叫皇鸟,一只叫鸾鸟,一只叫凤鸟,听见琴音就会翩翩起舞.<br><br>&nbsp;&nbsp;--来自搜狗百科>', //太子长琴
			sgsh_nvba: '<font color=cyan>上古神话-003</font><br>♦️️︎技能设计:夜白<br>♦️️︎代码撰写者:夜白<br>♦️️︎插图:网图<br>♦️️︎配音:暂无<br>&nbsp;&nbsp;女魃是神话中的旱神,亦作<女妭>,她穿青衣,居住在赤水之北.<br><br>&nbsp;&nbsp;女魃在黄帝攻打蚩尤时有着巨大作用,蚩尤起兵攻打黄帝,黄帝令应龙进攻冀州,蚩尤请来风伯雨师,以狂风骤雨对付应龙部队,于是,黄帝令女魃助战,她阻止了大雨,最终助黄帝赢得战争.<br><br>&nbsp;&nbsp;--来自搜狗百科', //女魃
			sgsh_luohou: '<font color=cyan>上古神话-004</font><br>♦️️︎技能设计:夜白<br>♦️️︎代码撰写者:夜白<br>♦️️︎插图:网图<br>♦️️︎配音:暂无<br>&nbsp;&nbsp;罗睺是印度神话中的阿修罗之一,是达耶提耶王毗婆罗吉提(Vipracitti)与辛悉迦(Simhika,达刹之女)的儿子.罗睺经常吞食日月,造成日蚀和月蚀,当日月在他敞开的喉头走出,蚀便完结.罗睺又被称为<行星、流星之王>,西南方的守护神;他长有四只手,下半身为蛇尾,好为非作歹.<br><br>&nbsp;&nbsp;--来自搜狗百科', //罗睺
			sgsh_dongwanggong: '<font color=cyan>上古神话-005</font><br>♦️️︎技能设计:夜白<br>♦️️︎代码撰写者:夜白<br>♦️️︎插图:网图<br>♦️️︎配音:暂无<br>&nbsp;&nbsp;东王公(别称扶桑大帝、青童君等),中国神话中的仙人,与西王母相对应,统率所有男仙.东王公为道教尊神,战国时期,楚地信仰的<东皇太一>神,为东王公之前身;<真灵位业图>将其排在上清左位,号曰<太微东霞扶桑丹林大帝上道君>.<br><br>&nbsp;&nbsp;郭沫若在<卜辞中的古代社会>一文中就说:<神话传说中人物,一人化为二人以上,一事化为二事以上,乃古今中外常有之事.><br><br>&nbsp;&nbsp;--来自搜狗百科', //东王公
			sgsh_yinglong: '<font color=cyan>上古神话-006</font><br>♦️️︎技能设计:夜白<br>♦️️︎代码撰写者:夜白<br>♦️️︎插图:网图<br>♦️️︎配音:暂无<br>&nbsp;&nbsp;应龙,名叫庚辰,是古代中国神话传说中的创世神、造物神,作为一种有翼的龙出现于神话,同时也是真龙与龙族始祖,亦作黄龙、飞龙.传说鱼虾喝一口应龙的尿就能成为真龙.<br><br>&nbsp;&nbsp;先秦记载中,只存在一条应龙,名为庚辰,本居于天上世界,开辟了大地,生下了凤凰、麒麟.是助黄帝争帝而捕猎夔牛,独战虎、豹、熊、罴四兽,于南极杀蚩尤、斩夸父,最后与黄帝飞升;助大禹治水而再度下凡,以龙尾画地成江,开龙门、擒无支祁、捉拿相柳的无双战神,训练了中国第一支骑兵,撰写了十二生肖名表.直到商代都仍有帝王祭祀应龙.<br><br>&nbsp;&nbsp;传说应龙不死,是一尊曾于混沌划分阴阳、孵化创世神盘古的巨神,她的泪水形成了阴间黄泉,还有传说她化身成了天上的星座.<br><br>&nbsp;&nbsp;同时,应龙庚辰也是于五方主中央、五行司土的,云雨雷霆之神、沟渎河川之神、天龙之神,号曰顺天佑畿辅时应龙神的太一之妃,是活跃在先秦神话中的神明.<br><br>&nbsp;&nbsp;后世星经中,应龙更成为了司四季、司中岳、司中土、司黄河、长江、汉水、淮河、济水、司黄帝之子孙、司倮虫三百六十的天神.<br><br>&nbsp;&nbsp;--来自搜狗百科', //应龙
			sgsh_xingtian: '<font color=cyan>上古神话-007</font><br>♦️️︎技能设计:夜白<br>♦️️︎代码撰写者:夜白<br>♦️️︎插图:网图<br>♦️️︎配音:暂无<br>&nbsp;&nbsp;刑天是中国古代神话传说人物之一,是炎帝手下一员大将,与黄帝大战时,被砍掉脑袋,因此称为<刑天>,意为<形体夭残>.其记载于<山海经·海外西经>中,真实性学界一直有所争议,原本可能是华夏族无名神祇.<br><br>&nbsp;&nbsp;据甲骨文和金文记载,刑天为一人形符号,为氏族部落的象征图腾.在<山海经>的原本记载,称作<形天>,而<刑天>之得名,为陶渊明所改,其诗中<刑天舞干戚>一词,可能因传抄错误而有<刑天舞干戚>与<形夭无千岁>二说.<br><br>&nbsp;&nbsp;--来自搜狗百科', //刑天
			sgsh_xiwangmu: '<font color=cyan>上古神话-008</font><br>♦️️︎技能设计:夜白<br>♦️️︎代码撰写者:夜白<br>♦️️︎插图:网图<br>♦️️︎配音:暂无<br>&nbsp;&nbsp;道教创立以后,西王母被纳入神系,成为道教至高无上的女神.民间俗称<王母娘娘>.<西王母>的称谓,始见于<山海经>,因所居昆仑丘于汉中原为西,故称西王母.<br><br>&nbsp;&nbsp;--来自搜狗百科', //西王母
			sgsh_yuqiang: '<font color=cyan>上古神话-009</font><br>♦️️︎技能设计:夜白<br>♦️️︎代码撰写者:夜白<br>♦️️︎插图:网图<br>♦️️︎配音:暂无<br>&nbsp;&nbsp;禺强(yú qiáng)是传说中的风神、冬神,字玄冥.可以传播瘟疫,人面鸟身,用两条青蛇穿在耳朵上做装饰,踩着两条红色的蛇.<br><br>&nbsp;&nbsp;冬至之时,<史记>上记载,汉朝时要有七十个童男童女一起唱<玄冥>之歌,以此来祭祀冬神禺强.<br><br>&nbsp;&nbsp;--来自搜狗百科', //禺强
			sgsh_dayu: '<font color=cyan>上古神话-010</font><br>♦️️︎技能设计:夜白<br>♦️️︎代码撰写者:夜白<br>♦️️︎插图:网图<br>♦️️︎配音:暂无<br>&nbsp;&nbsp;大禹,姓姒,名文命,字(高)密,是黄帝的玄孙、颛顼的孙子(另一说为颛顼六世孙),其父名鲧,其母为有莘氏之女脩己,为夏后氏首领、夏朝开国君王,因治理滔天洪水而广受世人传颂.<br><br>&nbsp;&nbsp;相传,禹治理黄河有功[1],受舜禅让而继承帝位,以阳城为都城(另有说都城是平阳或安邑或晋阳),国号夏,并分封丹朱于唐,分封商均于虞,又划定中国版图为九州.禹死后安葬于会稽山上(今浙江绍兴),现仍存禹庙、禹陵、禹祠.<br><br>&nbsp;&nbsp;--来自搜狗百科', //大禹
			//---------------------------------//名将改写
			...
			♠️️♠️️︎️ ♥️️♥️️︎️ ♣️️♣️️︎️ ♦️️♦️️︎ 虚无🃏 日○ 月☽ 星☆ 山△ 禁※
			空桃♤ 空心♡ 空梅♧ 空钻♢ 空无◎
			...
			//♠️️  <br>♠️️︎️技能设计:夜白<br>♠️️︎️代码撰写者:夜白<br>♠️️︎️插图:暂无<br>♠️️︎️配音:暂无
			//♥️️  <br>♥️️︎️技能设计:夜白<br>♥️️︎️代码撰写者:夜白<br>♥️️︎️插图:暂无<br>♥️️︎️配音:暂无
			//♣️️  <br>♣️️︎️技能设计:夜白<br>♣️️︎️代码撰写者:夜白<br>♣️️︎️插图:暂无<br>♣️️︎️配音:暂无
			//♦️️  <br>♦️️︎技能设计:夜白<br>♦️️︎代码撰写者:夜白<br>♦️️︎插图:暂无<br>♦️️︎配音:暂无
			...
			*/
			...
			ybsl_083xiaozhu: '<font color=cyan>忆-083·巡梦天合</font><br>⊙技能设计:夜白<br>⊙代码撰写者:夜白<br>⊙插图:灵境AI绘图<br>⊙配音:暂无<br/>待填写.<br/><span class=thundertext>小筑,记2023年5月30日之31日梦.由于未能及时记录导致梦境遗忘较多,只记得这个姑娘擅长搭建建筑,但被风一吹就散架回复原样.</span>',
			ybsl_084zhangmi: '<font color=cyan>忆-084·痴惘之妒魂</font><br>⊙技能设计:夜白<br>⊙代码撰写者:夜白<br>⊙插图:灵境AI绘图<br>⊙配音:暂无<br/>凭什么你可以,我就不行？<br/><span class=thundertext>张汨,记2023年6月7日之8日梦.梦见彡,还有另一个丫头<span style="text-decoration: line-through;">&#20993&#22919</span>,我为其命名为张汨.我们一同进入陌生的大学.我和彡一直在腻歪,张汨就一直辱骂彡,我就一直抱着彡安抚她.我气不过,准备回骂,但由于情绪过于激动,导致梦醒.</span>',
			ybsl_085DGY: '<font color=cyan>忆-085·雨漫孤城</font><br>❀技能设计:夜白<br>❀代码撰写者:夜白<br>❀插图:<style type="text/css">#shiroha_bilibili:link, #shiroha_bilibili:visited {color:white;}</style><a id="shiroha_bilibili" href="https://space.bilibili.com/2170177" target="_blank"><span class="YB_http">哔哩哔哩up主鸣濑白羽酱</span></a>群内半成品图片<br>❀配音:暂无<br/>你在我的心里,立了一块碑.我的心,从此荒芜.<br/><span class=thundertext>独孤雨,原名保密,某天打王者认识的,后来逐渐熟络,也交换了姓名.性格跳脱.我半年没玩,跟她打了会匹配,她借口我辅助不跟她,给我删了.后来加了回来,说来姨妈了,心情不好.我:……注意身体.</span>',
		...
		*/
		...
		perfectPair: {
			//珠联璧合
			db_ybsp_014liutianyu: ['ybsl_002chenailin', 'ybsl_009liyushan', 'ybsl_010zhouyue', 'dzsl_015wanghairu', 'ybsl_008wuyuxin', 'ybart_016manchengqi', 'dzsl_016manchengqi', 'ybsp_016manchengqi', 'ybsl_016manchengqi', 'ybart_017xiaohong', 'dzsl_017xiaohong', 'ybslshen_017xiaohong', 'ybsl_017xiaohong', 'ybsl_018zhangqing', 'ybslshen_018zhangqing', 'ybsl_018zhangqing_feian', 'ybsl_023shiqingyu', 'db_ybsl_038tengwu', 'db_ybsp_038tengwu', 'db_ybsl_067snake', 'ybsp_002chenailin', 'ybsl_027rain', 'ybsp_027rain', 'ybsl_047shan'],
			ybslshen_014liutianyu: ['ybsl_002chenailin', 'ybsl_009liyushan', 'ybsl_010zhouyue', 'dzsl_015wanghairu', 'ybsl_008wuyuxin', 'ybart_016manchengqi', 'dzsl_016manchengqi', 'ybsp_016manchengqi', 'ybsl_016manchengqi', 'ybart_017xiaohong', 'dzsl_017xiaohong', 'ybslshen_017xiaohong', 'ybsl_017xiaohong', 'ybsl_018zhangqing', 'ybslshen_018zhangqing', 'ybsl_018zhangqing_feian', 'ybsl_023shiqingyu', 'db_ybsl_038tengwu', 'db_ybsp_038tengwu', 'db_ybsl_067snake', 'ybsp_002chenailin', 'ybsl_027rain', 'ybsp_027rain', 'ybsl_047shan'],
			dzsl_017xiaohong: ['dzsl_016manchengqi', 'ybart_016manchengqi', 'ybsp_016manchengqi', 'ybsl_016manchengqi', 'ybsl_019shengyan', 'dzsl_015wanghairu', 'ybsl_015wanghairu', 'ybsl_018zhangqing', 'ybsl_018zhangqing_feian', 'ybslshen_018zhangqing'],
			ybart_017xiaohong: ['dzsl_016manchengqi', 'ybart_016manchengqi', 'ybsp_016manchengqi', 'ybsl_016manchengqi', 'ybsl_019shengyan', 'dzsl_015wanghairu', 'ybsl_015wanghairu', 'ybsl_018zhangqing', 'ybsl_018zhangqing_feian', 'ybslshen_018zhangqing'],
			ybslshen_017xiaohong: ['dzsl_016manchengqi', 'ybart_016manchengqi', 'ybsp_016manchengqi', 'ybsl_016manchengqi', 'ybsl_019shengyan', 'dzsl_015wanghairu', 'ybsl_015wanghairu', 'ybsl_018zhangqing', 'ybsl_018zhangqing_feian', 'ybslshen_018zhangqing'],
			ybsl_017xiaohong: ['dzsl_016manchengqi', 'ybart_016manchengqi', 'ybsp_016manchengqi', 'ybsl_016manchengqi', 'ybsl_019shengyan', 'dzsl_015wanghairu', 'ybsl_015wanghairu', 'ybsl_018zhangqing', 'ybsl_018zhangqing_feian', 'ybslshen_018zhangqing'],
			dzsl_015wanghairu: ['ybart_016manchengqi', 'dzsl_016manchengqi', 'ybsp_016manchengqi', 'ybsl_016manchengqi', 'ybsl_018zhangqing', 'ybsl_018zhangqing_feian', 'ybslshen_018zhangqing'],
			ybsl_015wanghairu: ['ybart_016manchengqi', 'dzsl_016manchengqi', 'ybsp_016manchengqi', 'ybsl_016manchengqi', 'ybsl_018zhangqing', 'ybsl_018zhangqing_feian', 'ybslshen_018zhangqing'],
			ybsl_001sunlisong: ['ybsl_002chenailin', 'ybslshen_002chenailin', 'ybslshen_002chenailin_feian', 'ybsp_002chenailin'],
			ybsp_001sunlisong: ['ybsl_002chenailin', 'ybslshen_002chenailin', 'ybslshen_002chenailin_feian', 'ybsp_002chenailin'],
			ybslshen_001sunlisong: ['ybsl_002chenailin', 'ybslshen_002chenailin', 'ybslshen_002chenailin_feian', 'ybsp_002chenailin'],
			ybsl_018zhangqing: ['ybsl_031huanqing'],
			ybslshen_018zhangqing: ['ybsl_031huanqing'],
			ybsl_018zhangqing_feian: ['ybsl_031huanqing'],
			ybsl_056dongjianchao: ['ybsl_057sunmeiqi'],
			ybslshen_018zhangqing: ['ybsl_031huanqing'],
			ybsl_010zhouyue: ['ybsl_009liyushan', 'ybsl_008wuyuxin', 'ybsl_011gaoyuhang'],
			ybsl_008wuyuxin: ['ybsl_009liyushan', 'ybsl_011gaoyuhang'],
			ybsl_009liyushan: ['ybsl_011gaoyuhang'],
			ybsl_004zhangyujie: ['ybsl_048wushuang'],
			ybsl_084zhangmi: ['ybsl_047shan'],
			ybsb_084zhangmi: ['ybsl_047shan'],
			ybsl_047shan: ['db_ybsl_038tengwu', 'db_ybsp_038tengwu', 'ybsl_082bianqiuwen', 'ybsl_025shiwang', 'ybsl_023shiqingyu'],
		...
		skill: {
			...
			xhly_wuji: {
				...
				filter(e, p, c) {
					...
					if (e.cards[0].suit == null) return false;
				...
				subSkill: {
					...
					shan: {
						...
						audioname2: {
							...
							ybart_016manchengqi: 'yb016_shanwu',
							dzsl_016manchengqi: 'dz016_shanwu',
							ybsl_018zhangqing_feian: 'yb017_shanwu', //QQQ
						},
			...
			yb017_luming: {
				...
				prompt(player) {
					...
					if (player.storage.yb017_luming_block.length) {
						str += '<br>不能使用以下花色:';
			...
			yb014_shifu2: {
				...
				content() {
					...
					if (event.triggername == 'useCardAfter') {
						...
						if (trigger.trigger.cards.length == 1) {
							event.num = 13;
						} else {
							event.num = 7;
						}
			...
			North_huimiex: {
				...
				subSkill: {
					kill: {
						...
						forced: true,
						content() {
							if (!player.getStat('triggerSkill').North_huimiex) player.getStat('triggerSkill').North_huimiex = 0;
							player.getStat('triggerSkill').North_huimiex--;
						},
					},
				},
			},
				...
				subSkill: {
					light: {
						...
						content() {
							...
							if (list2.length) lib.skill.North_dy_qingyu.up(player);
						},
						ai: {
							basic: {
								order: 1,
			...
			North_dy_zhengwu: {
				...
				subSkill: {
					use1: {
						...
						enable: 'chooseToUse',
						filter(event, player) {
							if (!player.storage.North_dy_qingyu_light) player.storage.North_dy_qingyu_light = []; //QQQ
			...
			North_ld_chenxun: {
				...
				subSkill: {
					after: {
						...
						forced: true,
						filter(event, player) {
							if (player.getExpansions('North_ld_chenxun').length) return true;
							return false;
						},
						content() {
							'step 0';
			...
			North_bmh_huanchao: {
				...
				group: 'North_bmh_huanchao_ben', //QQQ
				subSkill: {
					ben: {
						zhuanhuanji: true,
						mark: true,
				...
				filter(event, player) {
					if (
						game.countPlayer(function (target) {
							if (get.North_bmh_chizhang(target).length) return true;
						}) < 1
					)
						return false;
					var damage = player.getHistory('sourceDamage').length;
			...
			North_bmh_lushou: {
				...
				mod: {
					maxHandcard(player, num) {
						if (get.North_bmh_chizhang(player).length) return num + 3;
						return num;
					},
				},
			},
			...
			North_cjy_bashu: {
				...
				content() {
					...
					if (event.num > 0) {
						...
						player.addTempSkill('North_cjy_bashu_1');
					}
				},
				mark: true,
				intro: {
			...
			North_cjy_duijing: {
				audio: 'xianjing',
				init(player) {
					player.markSkill('YB_phaseNumber');
				},
				trigger: { player: 'phaseUseBegin' },
				content() {
					if (player.storage.YB_phaseNumber % 4 == 0) {
						var num = 5;
					}
					player.draw(num || 1);
				},
				prompt2(event, player) {
					var str = '你可以摸';
					var num = player.storage.YB_phaseNumber % 4 == 0 ? 5 : 1;
					str += num;
					str += '张牌';
					return str;
				},
				...
				intro: {
					name: '出牌阶段计数',
					content(storage, player) {
						var num = player.storage.YB_phaseNumber || 0;
						return '你经历了' + num + '个出牌阶段';
					},
				},
				group: ['North_cjy_duijing_diancai', 'YB_phaseNumber'],
				subSkill: {
					diancai: {
						audio: 'xianjing',
			...
			North_shh_yuniao: {
				...
				intro: {
					content(storage, player, skill) {
						var str = '';
						if (player.storage.North_shh_yuniao == true) str += '转换技.回合结束时,<span class=thundertext>阳:你可获得1名角色1张牌,对该角色造成1点火属性伤害</span>;阴:你可交给1名角色1张牌,对该角色造成1点伤害.';
			...
			North_shh_qingsi: {
				...
				content() {
					...
					if (result.bool) {
						...
						player.useCard({ name: 'sha', nature: 'thunder' }, result.targets[0], 'North_shh_qingsi', false);
					}
				},
			},
			North_shh_xianyin: {
			...
			// caoyi_miyi:'蜜饴',
			// caoyi_miyi_info:'准备阶段,你可以选择一项:<br>1.回复一点体力 <br>2.受到一点你造成的伤害<br>令任意名角色依次执行该项.<br>若如此做,结束阶段这些角色执行另一项.',
			// caoyi_yinjun:'寅君',
			...
			caoyi_yinjun: {
				...
				content() {
					...
					player.useCard({ name: 'sha', caoyi_yinjun: true }, trigger.targets[0]).set('addCount', false);
				},
				init(player) {
			...
			North_zhenglue: {
				enable: 'phaseUse',
				prompt: '出牌阶段,你可以流失一点体力并获得一点护甲,令一名角色摸一张牌',
				content() {
					'step 0';
					player.loseHp(1);
			...
			YB_nobody_longying: {
				...
				content() {
					...
					player.chooseCard(num, 'he', '是否弃置' + num + '张牌,弃置' + get.translation(target) + '等量的牌？<br>若因此弃置了不少于两张牌,你对' + get.translation(target) + '造成一点伤害').set('ai', function (card) {
						var att = get.attitude(_status.event.player, target);
						if (att < 0) {
			...
			sgsh_cangling: {
				...
				content() {
					'step 0';
					player.chooseTarget('请选择一名角色令其增加一点体力上限,你回复一点体力', true);
					('step 1');
					var target = result.targets[0];
					target.gainMaxHp();
					player.recover();
			...
			sgsh_fuchou: {
				...
				content() {
					'step 0';
					player.draw();
					player.useCard({ name: 'sha' }, trigger.player, 'sgsh_fuchou');
				},
			},
			//--------------西王母
			sgsh_kunlun: {
			...
			sgsh_huasheng: {
				...
				content() {
					'step 0';
					player
						.chooseCard('h', get.prompt('sgsh_huasheng'), '展示并视为使用一张基本牌或普通锦囊牌', function (card, player) {
			...
			/*
			sgsh_kunlun:'昆仑',
	sgsh_kunlun_info:'锁定技,当你成为♠️️牌的目标时,若你已受伤,你摸两张牌.',
			sgsh_huasheng:'化生',
	...
	sgsh_zhishui_info:'出牌阶段限一次,你可以令至多X名角色弃置所有牌并摸等量的牌,X为你当前体力值.',
			*/
			...
			kagari_ybzongsi: {
				...
				content() {
						...
						if (lib.card[yb].type != 'equip') {
							if (yb == 'sha') {
								for (var kkk of lib.inpile_nature) {
									switch (kkk) {
										case 'fire':
											list55.add([get.type2(yb), '', 'sha', 'fire']);
											break;
										case 'thunder':
											list55.add([get.type2(yb), '', 'sha', 'thunder']);
											break;
										case 'kami':
											list55.add([get.type2(yb), '', 'sha', 'kami']);
											break;
										case 'ice':
											list55.add([get.type2(yb), '', 'sha', 'ice']);
											break;
										case 'stab':
											list55.add([get.type2(yb), '', 'sha', 'stab']);
											break;
										default:
											list55.add([get.type2(yb), '', 'sha', kkk]);
											break;
									}
								}
							} else {
					...
					player
						...
						.set('ai', (button) => player.getUseValue({ name: button.link[2] })); //QQQ
					event.goto(9);
					('step 9');
					if (result.links) {
						var name = result.links[0][2];
						...
						if (!_status.kagari_ybzongsi) _status.kagari_ybzongsi = {};
						if (!_status.kagari_ybzongsi_nature) _status.kagari_ybzongsi_nature = {};
					...
					player.chooseButton(['纵丝', '令' + ('<span class=yellowtext>' + get.translation(card) + '</span>') + '视为什(shén)么？选择原牌名则不会转化<br>(知道有多音字,所以特意标上了读音[机智])', [list66, 'vcard']], true).set('prompt2', '将此牌转化为什(shén)么？选择原牌名则不会转化<br>(知道有多音字,所以特意标上了读音[机智])');
					('step 11');
					if (event.target1) event.target1.line(event.target2, 'water');
					if (result.links[0][2] == card.name) event.target2.addJudge(card);
			...
			xinfu_ybfalu: {
				...
				filter(event, player) {
					...
					for (var i = 0; i < event.cards2.length; i++) {
						if (!player.hasMark('xinfu_falu_' + event.cards2[i].suit) || player.countMark('xinfu_falu_' + event.cards2[i].suit) < 3) return true;
			...
			kotori_yumo_YB_memory: {
				...
				intro: {
					name: "<span style='color: #28e3ce'>魔物</span>",
					content: 'mark',
				},
			},
			kotori_yumo_YB_dream: {
				...
				intro: {
					name: "<span style='color: #e328b7'>魔物</span>",
					content: 'mark',
				},
			},
			...
			xinfu_ybjingxie: {
				getJingxie() {
					return ['bagua', 'baiyin', 'lanyinjia', 'renwang', 'tengjia', 'zhuge', 'ybsl_wangzhui', 'chitu', 'zhuque', 'wuxinghelingshan', 'yitianjian', 'shandian', 'fulei', 'taigongyinfu', 'ybsl_tianleiyubi', 'hongshui', 'huoshan', 'du', 'chiyanzhenhunqin', 'tongque', 'qinglong', 'fangtian', 'wutiesuolian', 'huxinjing'];
				},
				firstDo: true,
			...
			dz017_shanwu: {
				...
				check(card) {
					var player = _status.event.player;
					if (ui.selected.cards && ui.selected.cards.length) return 6 - get.value(card) && get.type2(card) == get.type2(ui.selected.cards[0]);
			...
			ybsl_xianyin: {
				...
				intro: {
					content(storage, player) {
						...
						var str2 = '阴(阳):当你因弃置而失去一张♣️️牌时,你可令一名角色回复一点体力;';
						var str3 = '阳(阴):当你因弃置而失去一张♥️️牌时,你可令一名角色失去一点体力;';
			...
			ybsl_luanming: {
				viewAs(cards, player) {
					...
					if (name) return { name: name, nature: nature, card: card };
					return null;
				},
				lose: true,
				audio: 'ext:夜白神略/audio/character:2',
				...
				intro: {
					content(storage, player) {
						//<br><span class="yellowtext">注意:此技能不能用于响应其他牌,更不能在别人濒死时用桃选择其为目标!</span>
						if (player.storage.ybsl_luanming == true) return '转换技,每回合限一次,当你可以使用牌时,你可以弃置一黑一红共两张牌,:阴:视为使用其中的黑色牌并额外执行一次;<span class="bluetext">阳:视为使用其中的红色牌并额外执行一次.</span>';
						return '转换技,每回合限一次,当你可以使用牌时,你可以弃置一黑一红共两张牌,:<span class="bluetext">阴:视为使用其中的黑色牌并额外执行一次;</span>阳:视为使用其中的红色牌并额外执行一次.';
					},
				},
				init(player) {
				...
				subSkill: {
					...
					buff:{
						...
						// 	delete player.getStat('triggerSkill').ybsl_luanming_buff;
						// },
					},
					*/
				},
			...
			/*
			yb001_yongyue:'咏月',
			yb001_yongyue_info:'锁定技,判定阶段开始时/当你受到伤害时,若你存在已损体力值,你跳过之,改为失去空血条,摸等量牌;当你失去牌后,若你的已损体力值不大于3,你增加一点体力上限.',
			...
			*/
			yb001_haowan: {
				...
				filter(event, player) {
					...
					for (var i of es) suits.add(i.suit);
			...
			yb001_minglun: {
				...
				content() {
					...
					if (event.triggername == 'phaseAfter') {
						player
							.chooseControl(['掉血', '弃掉'])
							.set('prompt', '请选择一项:弃掉所有<命轮>牌,或失去一点体力')
							.set('ai', function (control) {
								var cards = player.getExpansions('yb001_minglun');
								var list = [];
								for (var i of cards) {
			...
			yb002_ziren: {
				...
				content() {
					...
					('step 1');
					if (result.control == 'cancel2') {
						player.getStat('triggerSkill').yb002_ziren--;
						event.finish;
					} else {
						if (result.control == '无') {
			...
			*/
			...
			yb002_shangyuan: {
				...
				content() {
					'step 0';
					player.chooseTarget('请选择一个目标').set('ai', function (target) {
						//ai选目标的限制条件
					...
					if (result.bool) {
						player
							.chooseControl('摸牌', '弃牌')
							.set('prompt', '令' + get.translation(result.targets[0]) + '摸或弃' + event.num + '张牌?')
							.set('ai', function (target) {
			...
			*/
			...
			yb007_chenwang: {
				...
				filter(event, player) {
					...
					if (event.filterCard && event.filterCard({ name: evt.card.name }, player, event)) return true;
				},
				filterCard(card) {
					return true;
				},
				...
				prompt(event, player) {
					return '是否将一张牌当做' + get.translation(lib.skill.yb007_chenwang.getLastUse(_status.event.player)) + '使用,摸一张牌';
				},
				selectCard: 1,
			...
			// 你可以在合适的时机选择一张<小抄>,①使用此<小抄>,并弃置其余小抄②弃置此<小抄>,并将一张手牌当此>小抄>使用.',
			// 'yb012_xibei':'习备',
			// 'yb012_xibei_info':'场上其他角色使用非转化即时牌后,你可以将之充入<小抄>.',
			// 'yb012_suotu':'索图',
			...
			yb014_yingbian: {
				...
				filter(event, player) {
					if (!game.players.some((Q) => Q.countCards('h', { name: 'suijiyingbian' }))) return false;
					return event.card && event.skill != 'yb014_yingbian_1' && (player.group == 'YB_memory' || player.group == 'ye');
				}, //QQQ
				content() {
			...
			yb014_shizhui: {
				...
				content() {
					...
					player
						...
						.set('prompt', '<span class=yellowtext>游戏开始时或一轮游戏开始时,你可以减1点体力上限,将一名其他角色武将牌上的技能加入到你的武将牌上.</span>')
						.set('ai', function (target) {
							var player = _status.event.player;
				...
				subSkill: {
					delete: {
						...
						content() {
							...
							var num = 8;
							var str = '<span class=yellowtext>出牌阶段,你可以删除一个以此法获得的技能,摸三张牌,并</span>';
							if (player.storage.yb014_shizhui_delete == true) {
								str += '<span class=yellowtext>回复一点体力.</span>';
							} else {
								str += '<span class=yellowtext>增加一点体力上限.</span>';
							}
			...
			yb016_juli: {
				...
				content() {
					...
					if (trigger.target == player) {
						...
						player
							.chooseBool('是否令' + get.translation(trigger.target) + '选择是否重铸牌,以此令' + get.translation(trigger.card) + '有几率对其无效？')
							.set('ai', function () {
					...
					trigger.player
						.chooseToDiscard(1, 'he', function (card) {
							return event.list2.includes(get.type2(card));
						})
						.set('prompt', '请弃置一张牌,且牌的类型必须在【' + list3 + '】之中.')
						.set('ai', function (card) {
			...
			yb017_chuanxin: {
				...
				content() {
					...
					player.chooseButton(
						['传信:选择要使用的牌,或点取消摸一张牌', [list, 'vcard']],
						function (button) {
					...
					else player.chooseUseTarget({ name: result.links[0][2], nature: result.links[0][3] }, false);
				},
			},
			yb017_zuigui: {
				audio: 'ext:夜白神略/audio/character:2',
			...
			yb017_guangzhu: {
				...
				forced: true,
				filter(event, player) {
					return (event.card.name == 'ybsl_lumingqianzhuan' || get.zhinangs().includes(event.card.name) || player.getStorage('yb017_zhenshi').includes(event.card.name)) && event.cards.length == 1;
				},
				content() {
					player.draw();
				},
				...
				subSkill: {
					add: {
						...
						content() {
							...
							var list1 = player.getStorage('yb017_zhenshi');
			...
			yb018_minxing: {
				...
				content() {
					...
					list.push('不移除');
					player.chooseControl(list).set('choiceList', ['移除两枚梦,摸五放五', '移除一枚梦,摸四放四', '不移除梦,摸三放三']).set('prompt', '请选择');
					('step 2');
					...
					player
						...
						.set('ai', function (card) {
							if (ui.selected.cards.length) {
								if (ui.selected.cards[ui.selected.cards.length - 1].suit == card.suit) return 10;
							} else {
								return 6 - get.value(card);
							}
						});
					...
					if (result.control == '是') {
						...
						if (cards[0].suit == cards[1].suit) event.y = cards[2];
						if (cards[0].suit == cards[2].suit) event.y = cards[1];
						if (cards[2].suit == cards[1].suit) event.y = cards[0];
						// event.y=y;//独苗卡牌对象
					...
					player
						.chooseControl(listb)
						.set('choiceList', ['<span class=yellowtext>摸两张牌</span>', '<span class=yellowtext>回复一点体力</span>', '背水!消耗<span class=yellowtext>两</span>枚梦', '<span class=yellowtext>摸一张牌</span>', '<span class=yellowtext>获得仅有一张的花色的牌</span>', '背水:消耗<span class=yellowtext>一</span>枚梦'])
					...
					if (result.control == '打牌') {
						if (player.countCards('he') > 0) {
							player.chooseToRespond('he', true).set('ai', function (card) {
								if (player.storage.YB_memorysuit && card.suit == player.storage.YB_memorysuit) return 3;
								return 1;
							});
						}
					}
			...
			yb018_yinsia: {
				...
				content() {
					'step 0';
					player.chooseControl('是', '否').set('prompt', '是否移除两枚>梦<,卜算3？');
					('step 1');
			...
			yb018_yinsib: {
				...
				content() {
					'step 0';
					player.chooseControl('是', '否').set('prompt', '是否移除一枚>梦<,多摸一张牌？');
					('step 1');
					var jg = result.control;
					if (jg == '是') {
						player.removeMark('yb018_huaimeng', 1);
			...
			yb018_yinsic: {
				...
				content() {
					'step 0';
					player.chooseControl('是', '否').set('prompt', '是否移除两枚>梦<,本回合获得【善舞】？');
					('step 1');
					var jg = result.control;
					if (jg == '是') {
						player.removeMark('yb018_huaimeng', 2);
			...
			yb018_yinsid: {
				...
				content() {
					'step 0';
					player.chooseControl('是', '否').set('prompt', '是否移除两枚>梦<,获得【注视】和【轻灵】直到下回合开始？');
					('step 1');
					var jg = result.control;
					if (jg == '是') {
						player.removeMark('yb018_huaimeng', 2);
			...
			// 'yb019_zhiyu':'掷郁',
			// 'yb019_zhiyu_info':'每回合每种牌名(限实体牌名)限一次.出牌阶段,你可以展示一张手牌并交给一名其他角色,视为你对其使用此牌(不计入次数,不受距离限制).',还没开写呢,懒
			// yb019_zhiyu:{
			// },
			//--------------贾雨桐
			yb020_shange: {
			...
			yb021_qiujiao: {
				...
				num() {
					...
					if (
						...
						player
							.chooseTarget(get.prompt2('yb021_qiujiao'), function (card, player, target) {
								return target != player && target.countCards('he') > 0;
							})
							.set('ai', function (target) {
								var att = get.attitude(_status.event.player, target);
				...
				content() {
					...
					if (trigger.player.countCards('he') >= num * 2) {
						trigger.player
							...
							.set('prompt', '断想')
							.set('prompt2', '请选择' + get.cnNumber(num * 2) + '张牌弃置,回复' + get.cnNumber(num) + '点体力,<br>否则失去' + get.cnNumber(num) + '点体力上限并摸等量牌.')
							.set('ai', function (button) {
				...
				content() {
					...
					chooseButton
						.set('ai', function (button) {
							...
							var att1 = get.attitude(player, event.source),
								att2 = get.attitude(player, event.target);
							if (att1 > 0 && num1 < 0) {
					...
					if (result.links) {
						...
						switch (result.links[0]) {
							case 1:
								event.source.draw(event.numo);
								break;
							case 2:
								event.source.discardPlayerCard('h', event.source, event.numo, true);
								break;
							case 3:
								event.target.draw(event.nump);
								break;
							case 4:
								event.target.discardPlayerCard('h', event.target, event.nump, true);
								break;
						}
					}
				},
			...
			*/
			...
			yb_jianyuan_mu_info:'当你失去最后的手牌时,你可以摸一张牌,你可以移除木剑元并摸等同体力上限的牌数.',
			yb_jianyuan_shui_info:'当你成为其他角色使用【杀】的目标时,你可以依次选择是否①弃置一张牌,将此杀【流离】出去;②移除水剑元,与一名可成为【流离】目标的其它角色互换座位.',
			...
			*/
				...
				intro: {
					...
					mark(dialog, storage, player) {
						if (player.getExpansions('yb_jianyuan_jin')) {
							...
							dialog.addAuto(content);
							dialog.addText('当你失去最后的手牌时,你可以摸一张牌,<span class=yellowtext>你可以移除木剑元并摸等同体力上限的牌数.</span>');
						} else {
				...
				intro: {
					...
					mark(dialog, storage, player) {
						if (player.getExpansions('yb_jianyuan_jin')) {
							...
							dialog.addAuto(content);
							dialog.addText('当你成为其他角色使用【杀】的目标时,你可以依次选择是否①弃置一张牌,将此杀【流离】出去;<span class=yellowtext>②移除水剑元,与一名可成为【流离】目标的其它角色互换座位.</span>');
						} else {
			...
			'(初稿待定)苏婆夏洛特,出牌阶段限一次或当你受到伤害(伤害至少为一)后,你可以摸一张牌,
					将一张手牌置于武将牌上称为<剑元>,同时为此<剑元>绑定一个装备栏
			...
			<br>防御马:水剑元,当你成为其他角色使用【杀】的目标时,你可以选择至多两项①弃置一张牌,将此杀【流离】出去;
									②移除水剑元,与一名可成为【流离】目标的其它角色互换座位.
			<br>宝物栏:木剑元,当你失去最后的手牌时,你可以摸一张牌,你可以移除木剑元并摸等同体力上限的牌数.',
			*/
			yb028_sheshen: {
				audio: 'ext:夜白神略/audio/character:2',
				...
				content() {
					...
					player
						.chooseTarget(true)
						.set('prompt', '请选择一名角色,令其摸两张牌并回复一点体力')
						.set('ai', function (target) {
							var player = _status.event.player;
							var att = get.attitude(player, target) / Math.sqrt(1 + target.countCards('h'));
							return att;
			...
			/*
			'yb028_sheshen_info':
			'(初稿待定)锁定技,当你装备栏被废除时,你令一名角色摸两张牌并回复一点体力,你减一点体力上限;
			你的手牌上限额外增加被废除装备栏的数量;
			...
			*/
			...
			yb029_chonghui: {
				...
				filter(event, player) {
					return !player.getStorage('yb029_chonghui2').includes(event.card.name);
				},
				forced: true,
				content() {
					'step 0';
			...
			*/
			...
			yb031_lihun2: {
				...
				mod: {
					globalFrom(from, to) {
						if (from.storage.yb031_lihun && from.storage.yb031_lihun.includes(to)) return -Infinity;
					},
				},
				intro: {
					content(content, player) {
			...
			yb033_yuqi: {
				...
				content() {
					...
					// 	player.chooseControl(['ok2','cancel2']).set('prompt','是否移除其<诉>标记？').set('prompt2','其回复一点体力.').set('ai',function(control){
					// 		var att=get.attitude(_status.event.player,trigger.player);
					// 		if(att>0)return 'ok2';
					// 		return 'cancel2';
					// 	})
			...
			yb034_bifa: {
				...
				content() {
					...
					target.addTempSkill('yb034_bifa_card', 'phaseUseAfter');
				},
				check(card) {
					return 8 - get.value(card);
				},
			...
			/*
			'yb034_rebifa':'笔伐',
			'yb034_rebifa_info':'出牌阶段,若场上没有被此技能选择的角色,你可以展示一张手牌并交给一名其他角色,该角色不能使用或打出手牌直到此阶段结束.若被此技能选择的目标于此阶段阵亡,你摸一张牌.',
			'yb034_bifa':'笔伐',
			'yb034_bifa_info':'出牌阶段,若场上没有被此技能选择的角色,你可以展示一张手牌并交给一名其他角色,该角色不能使用或打出与此牌同颜色的手牌直到此阶段结束.若被此技能选择的目标于此阶段阵亡,你摸一张牌.',
			'yb034_rejiandao':'剑道',
			...
			*/
			...
			yb037_kexie: {
				...
				content() {
					...
					if (player.countMark('yb037_kexie') >= 2) {
						for (var i = 0; i < evt.cards2.length; i++) {
							if (evt.cards2[i].suit == 'heart') event.count++;
						}
						event.goto(1);
					}
					('step 1');
			...
			yb038_quanlu: {
				...
				content() {
					...
					if (player.countCards('h') == 0) {
						...
						player
							.chooseControl(list)
							.set('prompt2', '请选择失去一点体力<span class=yellowtext>或</span>体力上限')
			...
			yb038_shenglu: {
				...
				content() {
					...
					if (player.countCards('h') == 0) {
						...
						player
							.chooseControl(list)
							.set('prompt2', '请选择失去一点体力并增加一点体力上限<span class=yellowtext>或</span>失去一点体力上限并回复一点体力')
							.set('ai', function (player) {
			...
			yb039_zhifu: {
				...
				selectCard: 1,
				check(card) {
					if (card.suit == 'heart') return 8 - get.value(card);
					if (card.suit == 'diamond') return 8 - get.value(card);
					return 6 - get.value(card);
				},
				content() {
					'step 0';
					...
					if (!lib.card[cardx]) {
						lib.card[cardx] = {
							...
							damagenature: nature,
							async content(event, trigger, player) {
								const num = lib.card[event.card.name].damagenum || 1;
								const nature = lib.card[event.card.name].damagenature || 'recover';
								if (nature == 'recover') {
									event.target.recover(num);
								} else {
									event.target.damage(num, nature);
								}
							},
							ai: {
								basic: {
			...
			yb040_xuyuan: {
				...
				intro: {
					...
					content(storage, player) {
						...
						if (!storage) return '无';
						var list1 = player.storage['yb040_xuyuan_chongzhijiList']; //刷新列表
			...
			*/
			...
			yb042_mingtui: {
				...
				check(event, player) {
					var num = 4;
					if (event.parent.excluded.includes(player)) num /= 2;
			...
			yb048_wuling: {
				...
				content() {
					...
					var prompt = '弃置' + num + '张牌,' + trans + '摸一张牌';
					if (cards.length > 1) prompt += ';或弃置一张牌,' + trans + '摸' + num + '张牌';
			...
			yb053_lvxin: {
				...
				content() {
					...
					list.push('加上限');
					list.push('cancel2');
					player.chooseControl(list).set('prompt', '是否弃置本次旅心摸的牌,回复一点体力或本回合手牌上限+1？');
					('step 1');
			...
			//其他角色使用点数大于1的装备牌时,你可以令此牌点数-1,你获得一张点数为1的同名牌并可立即使用.当复制牌进入弃牌堆时,自动销毁,并令此牌的原型点数+1,若此牌的原型仍在场上,则区域内有该牌的角色回复一点体力.
			yb054_xiezhi: {
				audio: 'ext:夜白神略/audio/character:2',
			},
			yb054_chouqi: {
			...
			yb054_tongxin: {
				...
				content() {
					...
					player
						.chooseControl(list)
						.set('prompt', get.translation(trigger.player) + '即将受到' + get.cnNumber(trigger.num) + '点' + get.translation(trigger.nature) + '伤害,是否令此伤害-1,自己受到一点无来源伤害？')
						.set('ai', function () {
							var attitude = get.attitude(player, trigger.player);
							if (attitude >= 0) return 0;
							if (attitude < 0) {
			...
			创建两张与此牌同牌名的牌,且两张牌的点数之和等于原来的那张牌,花色与原来的牌相同.
			你选择一名其他角色,你与其各获得一张,且可立即使用之.标记该角色为<裁巾>.',
			'yb054_xiezhi':'血指',
			'yb054_xiezhi_info':'①锁定技,当你受到伤害后,你展示手牌,若其中红色手牌数不大于你体力值,你摸三张牌;
			<br>②当你进入濒死状态时,你可以展示手牌并弃置所有红色手牌,回复体力至所弃红色牌的数量.
			...
			*/
			...
			//--------------------星落四公主059
			// yb059_huiguang:'晖光',
			// yb059_huiguang_info:'锁定技,游戏开始时,你选择一名星落四公主之一,将武将牌替换为其.当你即将阵亡时,若你仍有存活公主,则取消之,改为减少一点体力上限(至多减至1)并将武将牌替换为一名未阵亡的公主,并将你武将牌上的技能添加至新公主武将牌上,回复体力至上限.',
			// yb059_xingshi:'星逝',
			...
			// yb059_pingyu:'评雨',
			// yb059_pingyu_info:'场上角色的判定阶段开始时,若其判定区没有牌,你可令其进行一次【灵雨】判定.每当场上有判定牌即将生效时,你可以打出一张牌替换之,若此牌与原判定牌的花色相同,你摸一张牌.',
			yb059_huiguang: {
				audio: 'ext:夜白神略/audio/character:2',
				forced: true,
				mark: true,
			...
			yb059_xingshi: {
				...
				ai: {
					effect: {
						player(card, player, target) {
							if (!player.getStat('triggerSkill').yb059_xingshi || player.getStat('triggerSkill').yb059_xingshi <= 0) {
				...
				subSkill: {
					...
					sha: {
						...
						filter(event, player) {
							...
							if (player.storage.yb059_guanhong_judge != event.card.suit) return false;
			...
			yb067_kuiyi: {
				...
				content() {
					...
					if (event.suits >= 1)
						player
							...
							.set('ai', function (target) {
								...
								if (att < 0) return -event.numb;
								if (att >= 0 && player.storage.yb067_chanqing == target) return event.numb * 2;
					...
					('step 6');
					if (player.storage.yb067_chanqing == event.targets[0]) {
						//二维数组方案
				...
				subSkill: {
					use: {
						...
						filter(event, player) {
							...
							return event.card && get.position(event.card, true) == 'o'; //QQQ
						},
						forced: true,
						popup: true,
						content() {
			...
			yb069_wenhuan: {
				...
				intro: {
					content(storage, player, skill) {
						...
						return '当场上角色受到伤害后,你可令其武将牌复位,摸一张牌.';
					},
				},
				...
				subSkill: {
					1: {
						...
						prompt2(event, player) {
							var str = '';
							str += player.storage.yb069_wenhuan == true ? '是否令其翻面,并令此次回复效果+1' : '是否令其武将牌复位,其摸一张牌';
							return str;
						},
						check(event, player) {
							var tar = event.player;
			...
			_ybsl_zhezhiqiang_lose: {
				...
				filter(event, player) {
					...
					for (var i = 0; i < cs.length; i++) {
						if (cs[i].name == 'ybsl_zhezhiqiang' && get.position(cs[i], true) == 'd') return true;
					}
					return false;
				},
				forceDie: true,
			...
			ybsl_cuixing_diamond:'<span style=\'color: #ff0000\'>淬星</span>',
					*/
					...
					next.set('list', [
						...
						["操作方法:从下方选择你想要的目标牌,替换你要赋予的花色.操作结算时,会根据你选择的牌名对该花色进行添加.<br>此操作本质上是读取此格内牌名的序列,按照♠️️,♥️️,♣️️,♦️️的顺序依次读取,故而想要不为这个花色赋予时,可以把自带的花色图案放在那里卡位,那玩意不会被读取.<br><span style='color: #fff600'>请勿在此界面托管,否则ai不会进行任何操作,并直接确认</span><br>——感谢Angel大佬撰写的ai框架,并顺手让这个框只能替换而不能移动", [list66, 'vcard']],
					]);
					next.set('filterMove', function (from, to) {
						return typeof to != 'number';
					});
			...
			ybsl_kunyu: {
				...
				content() {
					...
					player.chooseCardTarget({
						prompt: '请选择【困圄】的牌和目标',
						prompt2: '将一张手牌交给一名其他角色并防止伤害' + (player.hasSkill('ybsl_duanzui') ? ',将伤害来源的一张牌置于其武将牌上称为<§>(若其无牌则改为牌堆顶一张牌)' : ''),
						filterCard: true,
						forced: true,
			...
			//-----------小新
			// yb079_qingnian:'情念',
			// yb079_qingnian_info:'锁定技,每轮开始时,若场上没有你指定的<情念>角色,你需指定一名其他的未折棒的男性角色,标记为<情念>.当<情念>角色于摸牌时,若你有手牌,则你{可以}弃置一张手牌,令其本次摸牌数+2.当你于一回合内第二次询问此技能时,你将前文中的{可以}删掉,失去【浸染】,获得【吟咏】.',//当你不因此技能而获得牌时,若其有手牌,其需交给你一张手牌.
			// yb079_jinran:'浸染',
			// yb079_jinran_info:'其他角色弃牌阶段结束时,你可以获得一张本阶段其弃置的牌,若你手牌数不大于体力上限,你可再执行一次.当你再一次执行时,若场上有你指定的<情念>角色,且当前弃牌的角色{不为<情念>角色,不为折棒角色,不为女性角色},则视为当前弃牌的角色对<情念>角色使用一张决斗,因此决斗受伤的角色可以选择折棒,防止此伤害.当<情念>角色折棒时,你取消对其的<情念>.',
			// yb079_yinyong:'吟咏',
			...
			yb080_fengming: {
				...
				content() {
					...
					if (result.control == '选项一') {
						...
						player.chooseUseTarget({ name: 'ybsl_fengmingjiuxiao' }, true, false);
					}
				},
			...
			yb080_niepan:'涅槃',
			yb080_niepanv_info:'限定技,当你进入濒死状态时,你可以回复体力至3,摸三张牌,获得技能【凤鸣】.',
			yb080_fengming:'凤鸣',
			...
			*/
			...
			yb082_chameng: {
				...
				filter(event, player, name) {
					...
					if (name == 'loseAfter') {
						...
						if (event.parent.name == 'draw') return true;
						return false;
					}
					return false;
				},
			...
			yb084_efei: {
				...
				content() {
					...
					if (result.bool) {
						...
						player.getStat('triggerSkill').yb084_efei--;
						event.finish();
					}
					('step 2');
					if (event.triggername == 'useCard') {
						...
						trigger.player.damage(1, trigger.card, trigger.source);
					}
				},
				ai: {
					threaten: 3, //嘲讽值
			...
			yb084_pomen: {
				...
				content() {
					'step 0';
					player.chooseCardButton('选择一张令其收回,视为其对自己造成一点由此牌造成的伤害', trigger.cards).set('ai', function (card) {
						if (get.attitude(_status.event.player, trigger.player) > 0) return false;
						return 6 - get.value(card);
					});
					('step 1');
					if (result.bool && result.links && result.links.length) {
						...
						player.getStat('triggerSkill').yb084_pomen--;
					}
				},
				init(player) {
				...
				subSkill: {
					die: {
						...
						filter(event, player) {
							...
							if (player.storage.yb084_pomen_card.includes(event.getParent(2).card)) return true;
							return false;
						},
						forced: true,
						content() {
			...
			yb100_lieshi: {
				...
				prompt2: '出牌阶段限一次,你可以选择一名其他角色,你令你们之一先选择列表其中一项执行,另一方执行列表中其未选择的一项.',
				content() {
					'step 0';
			...
			// yb100_lieshi:'烈誓',
			// yb100_lieshi_info:'重置技,刷新列表为:["受到你造成的一点火焰伤害,废除一个随机装备栏","受到你造成的两点火焰伤害","受到你造成的三点火焰伤害,摸三张牌"].
			// 出牌阶段限一次,你可以选择一名其他角色,你令你们之一先选择列表其中一项执行,另一方执行列表中仍存的一项.',
			/*快捷复制:
			<span class=yellowtext>文字</span>暗亮双色
			<span class=thundertext>文字</span>
			<span class=thundertext></span>
			...
			*/
			yb100_dianzhan: {
				...
				prompt2: '当你使用牌指定目标时,若此是你本回合首次指定其为目标,你横置自身并执行列表中的一项,令目标也执行此项.',
				subSkill: {
					mark: {
						onremove(player, skill) {
			...
			// yb100_dianzhan:'点盏',
			// yb100_dianzhan_info:'重置技,锁定技,刷新列表为:["横置自身展示手牌并重铸一种花色所有手牌","调整手牌至4张","展示手牌并弃置每种类型手牌各一张"].
			// 当你使用有目标的牌时,若此是你本回合首次指定其为目标,你横置自身并执行列表中的一项,若你不为目标,则令目标也执行此项.',
			yb100_huanyin: {
				audio: 'ext:夜白神略/audio/character:2',
				trigger: { player: 'dying' },
				forced: true,
			...
			// 将手牌调整至与已发动选项数相同,你展示手牌,若花色各不相同,你回复体力至1.(已发动选项数,即刷新列表存在,但现存列表没有的选项)',
			//-------夜白示范的傲才
			ybsl_aocai: {
				audio: 2,
				enable: ['chooseToUse', 'chooseToRespond'],
		...
		card: {
			...
			ybsl_lumingqianzhuan: {
				...
				content() {
					...
					if (event.directHit) event._result = { bool: false };
						...
						target
							.chooseToRespond('请打出一张杀或闪响应鹿鸣千转', function (card, player) {
								var name = card.name;
			...
			ybsl_nohua: {
				...
				content() {
					...
					switch (Math.floor(Math.random() * 4 * i)) {
						case 0:
							return target.draw(event.baseDamage || 1);
							break;
						case 1:
							return target.gainMaxHp(event.baseDamage || 1);
							break;
						case 2:
							return target.changeHujia(event.baseDamage || 1);
							break;
						case 3:
							return target.recover(event.baseDamage || 1);
							break;
					}
				},
				ai: {
			...
			ybsl_lingyu: {
				...
				ai: {
					...
					result: {
						target: (player, target) => target.countCards('h') - 3, //QQQ
					},
					tag: {
						skip: 'phaseDraw',
					},
					...
					if (result.bool == false) {
						if (player.countDiscardableCards(player, 'h'))
							player
								...
								.set('prompt', '请弃置一张手牌,若此牌花色为' + get.translation(result.suit) + '你回复一点体力,否则失去一点体力.')
								.set('ai', function (card) {
									if (card.suit == result.suit) return 16 - get.value(card);
									return 6 - get.value(card);
								});
					} else event.finish();
					('step 1');
		...
		translate: {
			...
			ybsl_zuogeceshi: '测试',
			ybsl_zuogeceshi_info: '结束阶段,你可以展示牌堆顶的三张牌,根据X值(X为这三张牌中红色牌的数量),令一名其他角色获得对应的效果直到其下回合结束:①三张:其摸牌阶段多摸两张牌,使用【杀】的次数上限+1.②两张:其使用【杀】的次数上限-1,跳过弃牌阶段.③小于两张:其于准备阶段开始时弃置一张手牌',
			ybsl_fenshe: '奋射',
			ybsl_fenshe_info: '出牌阶段,你可以弃置X张牌对你攻击范围内的一名其他角色造成1点伤害(X为该角色的体力值),后的一枚<伏>标记.若该角色因此法进入濒死状态且存活,则你于濒死状态结算后失去1点体力,且本回合不能再发动此技能',
			ybsl_fenshe2: 'ybsl_fenshe2',
			ybsl_fenshe2_info: '',
			ybsl_fenshe3: 'ybsl_fenshe3',
			ybsl_fenshe3_info: '',
			ybsl_chengyu: '乘舆',
			ybsl_chengyu_info: '当你失去装备区内的牌后,你可以摸二倍的牌张牌或回复等量体力,获得两枚伏',
			ybsl_fuhu: '伏虎',
			ybsl_fuhu_info: '转换技,略',
			ybsl_fuhu2: 'ybsl_fuhu2',
			ybsl_fuhu2_info: '',
			ybsl_shoujian: '受谏',
			ybsl_shoujian_info: '当你的判定牌生效后,你可以获得之,获得一枚伏虎',
			ybsl_quanchi: '拳斥',
			ybsl_quanchi_info: '当你即将受到伤害时,你可以弃置一张牌,获得伤害来源的一张牌并展示,若两张牌花色相同,则防止此伤害.你获得两枚伏虎',
			ybsl_scsaodang: '扫荡',
			ybsl_scsaodang_info: '锁定技,你使用杀指定手牌数大于你的角色无距离限制;你使用杀指定手牌数小于你的角色时,你本回合使用杀的次数-1',
			ybsl_scpingjun: '平郡',
			ybsl_scpingjun_info: '每当你使用杀指定目标后,你可令目标获得此杀,若如此做,此杀不可被闪避,你与其各摸一张牌',
			...
			ybsl_zhaosanmusi_info: '出牌阶段,对自己使用.目标角色选择:摸三张牌,弃置四张手牌,或弃置三张手牌,摸四张牌.',
			//技能翻译
			ybsl_zigong: '自功',
			ybsl_zigong_info: '当你不因此技能获得牌后,你可以弃置这些牌,摸等量牌(至多摸5张)',
			ybsl_zicai: '自才',
			...
			xhly_baihe: '白鹤',
			xhly_baihe_info: '锁定技,当你获得此技能时,创建集合A{杀,闪,桃,酒};当你使用或成为牌的目标时,若你有对应记录,你移除之,若你记录均已移除,你重置集合A、加一点体力上限并回复一点体力.',
			xhly_wuji: '武技',
			...
			xhzlly_guihuo: '诡祸',
			xhzlly_guihuo_info: '锁定技,当你对其他角色造成伤害时或受到其他角色造成的伤害时,此伤害+1,若双方均存活,你获得对方的一张牌;锁定技,击杀你的角色获得【诡祸】.',
			...
			ybsl_sixp_info: '六艺:出牌阶段限一次,你可以将一张手牌置入你的六艺区(若你拥有其它六艺技,则改为至多三张)若六艺数大于二,则获得〖精艺〗直到下回合开始.你可以将你六艺区的牌如手牌般使用或打出.六艺区的牌数至多为六,无法溢出.<br>精艺:锁定技,当你六艺区失去一张牌时,你摸一张牌.<br>六艺包,连作者都懒得维护了……作者最大烂活',
			...
			//---------------------六艺篇
			_ybsl_sixart: '六艺',
			_ybsl_sixart_info: '出牌阶段限一次,你可以将一张手牌置入你的六艺区(若你拥有其它六艺技,则改为至多三张)若六艺数大于二,则获得〖精艺〗直到下回合开始.你可以将你六艺区的牌如手牌般使用或打出.六艺区的牌数至多为六,无法溢出.',
			_ybsl_sixart2: '六艺',
			ybsl_master: '精艺',
			...
			yb041_juxin: '聚心',
			yb041_juxin_info: '出牌阶段限一次,你可以弃置任意张手牌并选择等量其他角色,你将这些角色各一张牌充入六艺区,若六艺数大于二,则获得〖精艺〗直到下回合开始..',
			yb017_luming: '鹿鸣',
			...
			yb014_huanlei: '还酹',
			yb014_huanlei_info: '限定技,出牌阶段,当你诗赋使用过的牌名大于3时可用,你可以令系统在[月之盈亏,蜃之万相,雷之灾覆,风之自在,火之无措]中进行次数为X的随机抽取,X为你诗赋用过的牌名数.你从抽取的列表中选择一个作为主流派,你可以再选择一个作为副流派(与主流派相同则加快主流派的升级速度).<br>月之盈亏(抽取权重1)<br>①决堰(陆抗)<br>②伪伤(key宫泽谦吾)<br>③游凤(key凤千早)<br>④止啼(手杀神张辽)<br>⑤浮萍(夏侯令女)<br>⑥均步(key凤咲夜)/烈武(key凤千早)<br>⑦弥笃(胡昭)<br>⑧贤望(胡昭)/奋锐(霍峻)<br>蜃之万相(抽取权重2)<br>①武圣(界关羽)+倾国(界甄姬)<br>②龙胆(界赵云)<br>③善断+义烈(ol周处)<br>④急救(华佗)+连环(界庞统)<br>⑤火计+看破(手杀卧龙)<br>⑥矫诏+殚心(界郭皇后)<br>⑦龙魂(神赵云)<br>⑧双掣(key三枝二木)<br>雷之灾覆(抽取权重2)<br>①符咒(DIY张宁)<br>②鬼道(DIY张宁)<br>③太平(DIY张宁)<br>④筹策(戏志才)<br>⑤屯田(ol界邓艾)<br>⑥暴球(key枣铃)<br>⑦八阵(卧龙)<br>⑧吉境(王荣)<br>风之自在(抽取权重1)<br>①制衡(界孙权)<br>②法箓+真仪(张琪瑛)<br>③会输(全不会解)<br>④易输(全不会解)<br>⑤点化(张琪瑛)<br>⑥淑武(key七濑留美)<br>⑦苦肉(黄盖)/募兵(SP张辽已觉醒)<br>⑧敏思(王荣)/巧思(马均)<br>火之无措(抽取权重4)<br>①锋略(荀谌)<br>②天义(太史慈)+探虎(星SP吕蒙)<br>③烈刃(手杀祝融)<br>④专对(秦宓)<br>⑤明伐(手杀羊祜)+大喝(星SP张飞)<br>⑥酣战(界太史慈)/天辩(秦宓)<br>⑦咆哮(界张飞)/陷阵(界高顺)<br>⑧除害(周处)',
			ybmyx_moon: '月之盈亏',
			...
			order_JJ: '金主四号',
			North_zhangwenwen: '张雯雯', //疑似被人抢单.技能描述我也没备注.毁灭吧
			...
			North_yhy_cihua: '慈化',
			North_yhy_cihua_info: '1.当你受到伤害或回复体力后,你可以先弃置三张手牌,选择弃置场上一张「惠」标记或一张「狭」标记,令一名角色翻面,可以选择与另一角色各弃置任意张牌,再摸等量的牌. 2.其他角色于其回合内使用第z张牌时,若此牌为基本牌或普通锦囊牌,你可将此牌收入手牌,并令此牌无效.(z为你当前体力).',
			...
			North_dy_qingyu: '请谕',
			North_dy_qingyu_info: '1.游戏开始前,你将所有的基本牌、锦囊牌牌名记录在<武库>当中.2.出牌阶段,你可重铸一张基本牌,若此时<武库>中有未点亮的牌名,则你可点亮<武库>中的一种牌名,每回合至多重铸x次(x为你的体力值).若你点亮的牌名不小于6种,则你立即获得技能［破势］.3.当你回合内使用一张非转化的锦囊牌或回合外使用、打出的一张非转化的基本牌时,若此牌名在<武库>中已被点亮,你可以摸一张牌.',
			...
			North_dy_poshi: '破势',
			North_dy_poshi_info: '锁定技.1.每回合结束后,你随机从牌堆中使用两张装备牌,随机对一名横置状态的角色造成一点火焰伤害(若没有横置角色则不触发伤害).2.当你成为杀的目标时,你摸两张牌.当你对其他角色使用杀时,该角色须弃置两张牌(若牌不足则全弃).',
			North_ssx_jibing: '戎装',
			North_ssx_jibing_info: '锁定技,当你失去装备区里的一张牌后,你展示牌堆顶3张牌,并加入队列,依次使用队列中所有装备牌,最后获得其余牌;你的回合开始前/结束后,你随机从牌堆里使用1张装备牌;游戏开始时,随机装备两件装备.',
			...
			North_zgl_dongxu: '洞虚',
			North_zgl_dongxu_info: '1.回合外,你可以将一张黑色牌当【无懈可击】使用,若如此,你可再选择令1名角色摸1张牌.2.其他角色回合结束后,你可选择x名角色.或令其依次回复1点体力并回复武将牌,或令其进入横置状态(x为本回合你失去的黑色牌数).',
			North_zgl_qizhu: '祈祝',
			North_zgl_qizhu_info: '锁定技.1.准备阶段和结束阶段,你观看牌堆顶的7张牌,你可以将其中任意数量的牌置于牌堆顶,将其余的牌置于牌堆底.2.出牌阶段开始时,你摸1张牌,再选择将1张手牌置于武将牌上称为<风>.',
			North_zgl_shiyan: '势焰',
			...
			North_bmh_chizhang_info: '回合结束时,若你本回合造成的伤害不低于你的体力值上限,则你可回复1名角色一个已发动过的限定技.',
			North_bmh_chizhangd: '持杖', //第二版//台词:骨疽
			North_bmh_chizhangd_info: '回合结束时,若你本回合造成的伤害不低于你的体力值上限和手牌上限之和,则你可回复1名角色一个已发动过的限定技.',
			North_bmh_chizhangt: '持杖', //第三版//台词:骨疽
			North_bmh_chizhangt_info: '回合结束时,若你本回合使用的牌不低于你的体力值上限和手牌上限之和,则你可回复1名角色一个已发动过的限定技.',
			North_bmh_chizhangq: '持杖', //第四版//台词:骨疽
			North_bmh_chizhangq_info: '回合结束时,若你本回合使用的牌或弃牌阶段弃置的牌不低于你的体力值上限和手牌上限之和,则你可回复1名角色一个已发动过的限定技.',
			...
			North_dc_ziman_info: '锁定技.1.回合开始时,若场上有<若芙>标记的角色,你分别将<若芙>标记收入手牌.当你收入第1/2/3张<若芙>标记时,你回复1点体力/令本次选择的角色流失1点体力/你与本次选择的角色互换位置.2.若你以此法获得了3张<若芙>标记,则你可令之前拥有标记的3名角色按照座位轮次依次对后面一位<若芙>角色视为使用1张〖决斗〗.',
			...
			North_hyy_lancai_info: ' 1.回合开始前,你可观看牌堆顶X张牌,将其中任意数量的牌置于牌堆顶,将其余的牌置于牌堆底(X为<闺识>牌数量).2.出牌阶段限一次,你观看一名其他角色的手牌,可将其中1张手牌与<闺识>牌中的1张交换,你可弃置其手牌中3张花色相同的牌.',
			...
			North_cxch_lingxi_info: '当你使用牌后,若本回合你没有使用过与此牌花色相同的牌,你可摸1张牌,将牌堆底的1张牌明置于武将牌上,称为<玉娉>.若<玉娉>与使用的牌颜色相同,你可将牌堆顶1张牌明置于武将牌上,称为<婷袅>.',
			...
			North_shh_yuniao_info: '回合结束时,阳:你可获得1名角色1张牌,对该角色造成1点火属性伤害;阴:你可交给1名角色1张牌,对该角色造成1点伤害.',
			...
			caoyi_yinjun_info: '当你对其他角色使用手牌中唯一目标的【杀】或锦囊牌结算后,可以视为对其使用一张【杀】(此杀造成的伤害无来源).若你此技能本回合发动次数大于你当前体力值,此技能本回合失效.',
			North_haoling: '号令',
			North_haoling_info: '限定技,出牌阶段,你可以移动场上的两张牌,你令场上其他角色依次选择:交给你一张牌或者受到一点伤害',
			North_zhenglue: '政略',
			North_zhenglue_info: '出牌阶段,你可以流失一点体力并获得一点护甲,令一名角色摸一张牌.每局游戏限一次,结束阶段,若你发动【政略】累计达到三次,增加一点体力上限,回复一点体力获得技能【谋划】',
			North_mouhua: '谋划',
			North_mouhua_info: '每轮限三次,每回合限一次,你选择将一张牌当做任意基本牌或任意锦囊牌使用或打出(选择范围包括标准,军争,应变,用间),你摸一张牌',
			YB_nobody_guiyin: '癸隐',
			...
			//----------------------装备及其他
			ybsl_cu: '醋', //达成
			ybsl_cu_info: '出牌阶段,对一名其他角色使用,或当你进入濒死状态时,你可以对自己使用,令目标回复一点体力,弃置其一张牌.',
			ybsl_lumingqianzhuan: '鹿鸣千转', //达成
			ybsl_lumingqianzhuan_bg: '鸣',
			ybsl_lumingqianzhuan_info: '出牌阶段,对一名其他角色使用.你将目标角色标记为<喜啼>或<悲鸣>(对其他角色不可见).目标角色可以打出一张【杀】或【闪】.若其是<喜啼>且未打出【杀】,则你对其造成1点伤害;若其是<悲鸣>且未打出【闪】,则你获得其一张牌.',
			faraway_spade: '♠️️',
			...
			ybsl_zhezhiqiang_info: '每回合限一次,你可以根据此牌花色在适当的时机使用此牌对应的花朵;当此牌进入弃牌堆时,根据此牌花色和点数将此牌改为对应的花朵.<br>♣️️:♣️️;♦️️:兰花;<br>♠️️:竹子;♥️️:菊花.<br><span style="opacity:0.05;">无花:无花</span>',
			...
			// ybsl_lingyu_info:'出牌阶段,对一名场上角色使用.若判定结果为黑色,其将手牌调整至体力值,回复一点体力;否则其将体力值调整至手牌数,摸两张牌.',
			//---------------------技能(鬼神易)
			dzsl_shennu: '神弩',
			...
			dz017_zhushi: '注视',
			dz017_zhushi_info: '回合结束时,你可以记录一名其他角色(效果触发前不可见),该角色于其出牌阶段内使用牌指定你为目标后你摸X张牌(X为其本阶段使用的牌数且至多为5);该角色的结束阶段开始时,若其本回合没有使用牌指定你为目标,则你获得其一张牌,你失去一点体力.',
			dz017_shanwu: '善舞',
			dz017_shanwu_info: '出牌阶段限一次,你可以弃置任意张牌,摸等量的牌.若你本次弃置的牌均为:基本牌,你回复一点体力;锦囊牌,你摸两张牌;装备牌,本回合接下来造成的伤害+1.',
			dz016_zanxu: '赞许',
			dz016_zanxu_info: '出牌阶段限一次,你可以将一张♥️️牌正面朝上交给一名其他角色.若如此做,则该角色于其下一个回合内第一次回复体力时,你摸两张牌.',
			dz016_shanwu: '善舞',
			dz016_shanwu_info: '出牌阶段限一次,你可以弃置任意张牌,摸等量的牌.若你本次弃置的牌均为:基本牌,你回复一点体力;锦囊牌,你摸两张牌;装备牌,本回合接下来造成的伤害+1.',
			dz015_xianzhe: '贤者',
			...
			dz015_enguang: '恩广',
			dz015_enguang_info: '主公技,每名其他忆势力角色限一次,当你受到伤害时,其可以防止此伤害,其受到等量的无来源伤害.',
			dz014_shanwu: '善舞',
			dz014_shanwu_info: '出牌阶段限一次,你可以弃置任意张牌,摸等量的牌.若你本次弃置的牌均为:基本牌,你回复一点体力;锦囊牌,你摸两张牌;装备牌,本回合接下来造成的伤害+1.',
			dz014_fuhua: '腐化',
			dz014_fuhua_info: '锁定技,你的回合开始时或你使用黑色牌时,你获得一枚<腐>;你使用红色牌时移去一枚<腐>;你的手牌上限+X(X为你的<腐>标记数).',
			dz014_xinsheng: '新生',
			dz014_xinsheng_info: '锁定技,结束阶段开始时或你进入濒死状态时,若你拥有至少三个<腐>标记且标记数大于你的体力上限,则你移去所有<腐>,摸等量的牌,并扣减一点体力上限,你将体力回复至体力上限.',
			dz014_xinkui: '心傀',
			...
			dz014_qingling: '轻灵',
			dz014_qingling_info: '锁定技,你的手牌上限+1;当你受到大于一点的伤害时防止之,流失一点体力.',
			dz014_yangkui: '养傀',
			...
			dz013_qingling: '轻灵',
			dz013_qingling_info: '锁定技,你的手牌上限+1;当你受到大于一点的伤害时防止之,流失一点体力.',
			dz013_shanwu: '善舞',
			dz013_shanwu_info: '出牌阶段限一次,你可以弃置任意张牌,摸等量的牌.若你本次弃置的牌均为:基本牌,你回复一点体力;锦囊牌,你摸两张牌;装备牌,本回合接下来造成的伤害+1.',
			//-------------------------------周瑜小乔
			ybsl_xianyin: '弦音',
			ybsl_xianyin_info: '转换技,(括号内的阴阳为鸾鸣的形态)<br/>阴(阴):当你因弃置而失去一张♠️️牌时,你可令一名角色下个摸牌阶段额外摸一张牌;(若你没有鸾鸣或鸾鸣已使用则改为黑色牌)<br/>阴(阳):当你因弃置而失去一张♣️️牌时,你可令一名角色回复一点体力;(若你没有鸾鸣或鸾鸣已使用则改为黑色牌)<br/>阳(阴):当你因弃置而失去一张♥️️牌时,你可令一名角色失去一点体力;(若你没有鸾鸣或鸾鸣已使用则改为红色牌)<br/>阳(阳):当你因弃置而失去一张♦️️牌时,你可令一名角色下个摸牌阶段少摸一张牌.(若你没有鸾鸣或鸾鸣已使用则改为红色牌)',
			ybsl_luanming: '鸾鸣',
			ybsl_luanming_info: '转换技,每回合限一次,当你可以使用牌时,你可以弃置一黑一红共两张牌,:阴:视为使用其中的黑色牌并额外执行一次;阳:视为使用其中的红色牌并额外执行一次.<br><span class=yellowtext>注意:此技能不能用于响应其他牌,更不能在别人濒死时用桃选择其为目标!</span>',
			...
			ybsl_zjsshixiang: '诗想',
			ybsl_zjsshixiang_info: '限定技,回合开始时,你可以弃置所有手牌,摸三倍数量的牌(至多9张),并且跳过本回合弃牌阶段.',
			ybsl_hejie: '和解',
			...
			//------------界篝
			kagari_ybzongsi: '纵丝',
			kagari_ybzongsi_info: '出牌阶段限一次,你可以选择一张不在游戏外的牌,将其置于牌堆/弃牌堆的顶部/底部或一名角色的对应区域内,<span class=yellowtext>并赋予该牌合理的视为牌名直到此牌离开该区域.</span>',
			//------------界张琪瑛
			xinfu_ybfalu: '法箓',
			...
			xinfu_ybzhenyi: '真仪',
			xinfu_ybzhenyi_info: '你可以在以下时机弃置相应的标记来发动以下效果:一名角色的判定牌生效前,你可以弃置一枚「紫薇」,将判定结果改为任意花色且点数为5;你的回合外,你可以弃置一枚「后土」,将你的一张手牌当【桃】使用;当你造成伤害时,你可以弃置一枚「玉清」,令此伤害+1;当你受到伤害后,你可以弃置一张「勾陈」,你从牌堆中随机获得三种类型的牌各一张.<span class=yellowtext>当你没有对应标记时,若你有「虚无」,你可改为弃置一张「虚无」</span>',
			xinfu_ybdianhua: '点化',
			...
			//------------界神诸葛亮
			ybsl_qixing: '七星',
			ybsl_qixing_info: '游戏开始时,你将牌堆顶的七张牌置于你的武将牌上,称之为<星>.你可用任意数量的手牌等量交换这些<星>;<span class=yellowtext>摸牌阶段结束后,你可以获得武将牌上所有星,选择至多七张手牌置于武将牌上称为星.</span>',
			ybsl_kuangfeng: '狂风',
			ybsl_kuangfeng_info: '<span class=yellowtext>出牌阶段限一次</span>/结束阶段,你可以弃置1张<星>并指定一名角色:直到你的下回合开始,该角色受到火焰伤害时,此伤害+1.',
			//------------界佐藤雏
			hina_ybshenshi: '神视',
			hina_ybshenshi_info: '神势力技.出牌阶段开始时/结束时,你可摸两张牌,<span class=yellowtext>将一张手牌置于牌堆顶</span>.你以此法获得的牌视为拥有全部应变效果,<span class=yellowtext>且可以无条件发动,且不计入手牌上限</span>.',
			//------------界神户小鸟
			kotori_ybyumo: '驭魔',
			...
			//------------界马钧
			xinfu_ybjingxie: '精械',
			xinfu_ybjingxie_info: '出牌阶段,你可以展示一张未强化过的【诸葛连弩】或标准包/军争包/SP包中的防具牌,<span class=yellowtext>赤兔,王追,闪电及其变种牌,洪水,火山,朱雀扇及其变种牌,倚天剑,毒,青龙刀,铜雀,护心镜</span>,对其进行强化.当你处于濒死状态时,你可以重铸一张防具牌,将体力回复至1点.',
			//----------------------孙丽松
			yb001_fufeng: '扶风',
			...
			//---------------以下均为废案孙丽松(主要是不好写)
			ybold_shenian: '设念',
			ybold_shenian_info: '限定技,非主公技,出牌阶段,你可以指定一名其他角色获得标记<念>.当你死亡后,你可令该角色回复一点体力并将你因死亡而置入弃牌堆的牌都交给该角色,该角色获得〖挽月〗.当对方死亡后,你可以与其互换座位,并舍弃你原本身份,视为你继承该角色身份继续游戏(你胜利即为该角色胜利),若场上没有与你身份相同的角色,你摸三张牌.',
			// 'yb001_yishui_ab':'挽月',
			yb001_yishui: '忆水',
			yb001_yishui_info: '回合结束时,你可以获得一张本回合进入弃牌堆的牌.',
			yb001_shenian: '新设念',
			yb001_shenian_ab: '设念',
			yb001_shenian_info: '游戏开始时或准备阶段,若场上没有被你标记为<念>的角色,你可以标记一名角色为<念>(此过程不记录且触发效果前其他人不可见).每回合限一次,当你或其回复体力/受到伤害后,若其体力值不等于你,你可以交换双方体力上限,令其失去或回复体力至Y,并令你回复或失去体力至X(X为触发技能时其的体力值,Y为触发技能时你的体力值.).',
			yb001_chuilian: '垂怜',
			...
			yb001_minglun: '命轮',
			// 'yb001_minglun_info':'锁定技,回合开始时,根据你已损体力值:<br/>不小于1:你可选择一个牌的类型,本回合使用此类型的牌时,摸一张牌;<br/>不小于2:你可获得一张随机装备;<br/>不小于3:你可摸3张牌.<br/>结束阶段,你回复X点体力或摸2X张牌(记X为回合开始时你可选的选项,但你没选,且当前阶段不满足的选项数)',
			yb001_minglun_info: '锁定技,回合开始时,你展示牌堆顶一张牌并放在武将牌上,至多放四张.根据<命轮>的花色,你视为拥有技能:<br>♠️️:栖月;♥️️:旅心;<br>♣️️:折叶;♦️️:忆水.<br>结束阶段,若<命轮>包含相同花色或四种花色,则你需弃置所有<命轮>或失去一点体力.',
			...
			yb001_yongyue: '咏月',
			yb001_yongyue_info: '锁定技,判定阶段开始时/当你受到伤害时,若你存在已损体力值,你跳过之,改为失去空血条,摸等量牌;当你失去牌后,若你的已损体力值小于1,你增加一点体力上限.',
			//--------------------------陈爱琳
			yb002_ziren: '自刃',
			yb002_ziren_info: '出牌阶段限一次,你可以对自己造成一点伤害,属性从(无,火,雷)中自选',
			yb002_shangyuan_ab: '殇怨',
			yb002_shangyuan: '新殇怨',
			yb002_shangyuan_info: '当你受到伤害后,你可以令一名角色摸X张牌或弃X张牌(X为目标角色的已损体力值,且X取值于[1,5],计数+X.你回合结束时,重置计数.',
			//-----------------------神陈爱琳
			yb002_yiqu: '易取',
			yb002_yiqu_info: '出牌阶段限一次,你可以选择一张不在游戏外的牌,将其置于牌堆/弃牌堆的顶部/底部或一名角色的对应区域内.若你拥有〖新殇怨〗,则当殇怨计数大于Y时,此技能不能发动.(Y为存活角色数*2-1)',
			ybold_shangyuan: '殇怨',
			ybold_shangyuan_info: '出牌阶段限X次,若你〖易取〗已发动,你可以重置〖易取〗.(X为你已损体力值)',
			//-----------------------旧版陈爱琳(主要是不好写)(改版并用于SP)
			yb002_touxin: '偷心',
			// 'yb002_touxin_info':'每回合对每名角色限一次.出牌阶段,你可以选择一名其他角色,声明一个花色,获得其一张手牌并展示,若花色与你声明的相同,你可回复一点体力并摸一(若你有‘香’,则此处数值改为‘香’的数量)张牌,你可以将一张牌交给该角色;若花色与你声明的不同,你失去一点体力.',
			yb002_touxin_info: '出牌阶段,你可以失去一点体力,获得一名其他角色hej区域的一张牌.',
			yb002_zheye: '折叶',
			yb002_zheye_info: '锁定技,每当你的体力值变动一点时,你摸一张牌.',
			yb002_xiangyun: '香陨',
			// 'yb002_xiangyun_info':'(若你体力值不大于2,则此处增加<场上角色的>)准备阶段(若你未受伤,则此处增加<或结束阶段>),你可以展示牌堆顶一张牌,并将之放在你的武将牌上称为<香>,若有<香>中有其它与本次展示的牌同花色的牌,你需弃置一张与本次展示牌同花色手牌,否则失去一点体力.<br>场上角色出牌阶段开始时,其可以弃置一张手牌,获得你的一张同花色的<香>.<br>当你进入濒死状态时,你可以获得所有<香>并回复一点体力,定格〖偷心〗并失去〖香陨〗',
			// 'yb002_xiangyun_info':'锁定技,你的手牌、装备区的牌、判定区的牌进入弃牌堆时,你将之放在武将牌上称为<香>.当你进入濒死状态时,你可以移除4张花色各不相同的<香>,回复体力至1.',
			yb002_xiangyun_info: '使命技,游戏开始时,你将牌堆顶X张牌置于武将牌上称为<香>,X为场上角色数一半向下取整.<br>①每轮开始时,你需将至少一张花色各不相同的牌(二或更多周目则没有花色限制)置入<香>,摸 等量(二或更多周目则改为双倍)的牌.<br>②场上角色的出牌阶段开始时,若其为你或手牌数小于体力值,其可以获得你的一张<香>,<br>③成功:准备阶段,若你的<香>包含三种花色(二或更多周目则改为四种),则你获得所有<香>,并回复一点体力,在本轮结束时重新激活并令周目数+1.<br>④失败:准备阶段,若你没有<香>,你失去一点体力并重铸所有手牌,在本轮结束时重新激活(不过不增加周目数).',
			yb002_yishui: '忆水',
			...
			yb003_toushi: '偷食',
			// 'yb003_toushi_info':'出牌阶段限一次,你可以观看一名其他角色的手牌并获得其中一张【桃】或【酒】(没有【桃】或【酒】则改为任意一张),其可以对你使用一张【杀】.',
			yb003_toushi_info: '出牌阶段,你可以观看一名其他角色的手牌并获得其中一张带有回复属性的牌,其可以对你使用一张【杀】.(若你空手而归或被对方成功抓包,则此技能本阶段失效)',
			yb003_fenxaing: '分享',
			...
			yb004_tianqi: '天祈',
			yb004_tianqi_info: '锁定技,当你对其他角色造成伤害后,你进行判定:若伤害不大于1,且结果为红色,你回复一点体力或摸一张牌;若伤害大于1,且结果为黑色,你失去一点体力并摸一张牌.当你受到伤害后,你进行判定,若结果为黑色,你摸x+1张牌,否则你回复x-1点体力(x为此次伤害值)(此技能不可触发界雷击)',
			yb004_shangyuan: '殇怨',
			yb004_shangyuan_info: '觉醒技,当你造成伤害致人死亡后,若伤害大于1,则你失去〖巫女〗,修改〖天祈〗(修改后的技能可以触发界雷击),选择回复一点体力或摸两张牌,最后获得〖玉洁〗.',
			...
			yb005_ruyu: '如玉',
			// 'yb005_ruyu_info':'当你即将造成冰属性伤害时,你可以弃置任意张牌,令等量其他角色进入横置状态,你摸X张牌,X为当前场上处于横置状态的角色.',//即将造成冰属性伤害这个概念太抽象了……
			yb005_ruyu_info: '锁定技,当你受到伤害时,你摸xʸ张牌,x为本次伤害值,y为你体力值,最终摸牌数不大于10.',
			yb005_qianxun: '谦逊',
			yb005_qianxun_info: '锁定技,你不能成为【顺手牵羊】和【乐不思蜀】的目标.',
			yb005_jieshen: '洁身',
			yb005_jieshen_info: '准备阶段,你可以失去一点体力上限,获得以下技能之一:〖无猜〗,〖折叶〗,〖玉洁〗.你摸三张牌.',
			yb005_wucai: '无猜',
			...
			yb006_boxue_rewrite_info: '锁定技,当你使用非装备牌或成为非装备牌的目标时,若你:<br>①没有对应的记录,则你记录该牌名,此技能结束.<br>②有对应的记录,则你移除对应的记录,摸一张牌(若此牌的使用者不为目标,则改为摸二),此技能结束.',
			yb006_jufan: '举反',
			yb006_jufan_info: '觉醒技,准备阶段或结束阶段开始时,若你博学已记录的牌名不小于3,则你修改〖博学〗和〖表率〗.',
			yb006_biaoshuai: '表率',
			yb006_biaoshuai_info: '主公技,每名其他忆势力角色每轮次各限一次.记录你回合内使用的第一张牌(覆盖上次记录).其他忆势力角色使用或打出与之同名的牌时,其可以令你摸一张牌,自己摸一张牌.',
			yb006_biaoshuai_rewrite: '表率·改',
			yb006_biaoshuai_rewrite_info: '主公技,每名其他忆势力角色每轮次各限一次.记录你回合内使用的第一张牌(覆盖上次记录).其他忆势力角色使用或打出与之同名的牌时,<span class=yellowtext>你可以摸一张牌,你可以令其摸一张牌.</span>',
			//---------------------作↓废--------------------//
			/*
	ybold_boxue:'旧博学',
	ybold_boxue_ab:'博学',
	...
	ybold_tonglian:'通练',
	ybold_tonglian_info:'(已被新版完全覆盖,故此作废.)觉醒技,任意角色的准备阶段,若你的<练>不小于3,则你减少一点体力上限,修改〖博学〗.(本来是②效果被指定目标也可触发)',
	ybold_kulian:'苦练',
	ybold_kulian_info:'(已被新版完全覆盖,故此作废.)觉醒技,任意角色的准备阶段,若你累积移除的<练>不小于3,则你减少一点体力上限,修改〖博学〗.(手牌上限+2)',
			*/
			//---------------------作↑废-----------------------//
			//-----------------------吴格格
			// 'yb007_renqing':'人情',
			...
			// 'yb007_shigu':'世故',
			// 'yb007_shigu_info':'对每名其他角色限一次,当你对其造成伤害时,你可以防止之,令其摸等同伤害值数的牌.',
			// 'yb007_zhengling':'征令',
			// 'yb007_zhengling_info':'主公技,其他忆势力角色出牌阶段开始时,你可令其交给你一张牌,若如此做,其摸一张牌.',
			yb007_chenwang: '陈往',
			yb007_chenwang_info: '每回合限一次,你可以将一张牌当做你使用的上一张牌使用,摸一张牌.',
			//-----------------------吴雨欣
			yb008_wucai: '无猜',
			...
			yb009_tulinghuaqi_info: '你的判定阶段、摸牌阶段、出牌阶段、弃牌阶段开始时,你可以失去一点体力,摸两张牌;当你即将造成伤害时,若你有护盾,你可以移去一枚护盾,令伤害加一.',
			//-----------------------周玥
			yb010_wucai: '无猜',
			yb010_wucai_info: '锁定技,摸牌阶段摸牌时,你额外摸一张牌;当你受到伤害时,若你体力值不小于一,则视为体力流失.',
			yb010_juxing: '聚星',
			yb010_juxing_info: '(此技能已作废,有机会再改)出牌阶段限一次,你可以指定一名其他角色A,弃置一张牌,号召其他非A角色依次选择是否弃置一张牌,你可以弃置其等同你们弃置牌数的牌.若A因此失去所有手牌时,A可以获得你们弃置的牌,否则包括A在内的所有其他角色均摸一张牌.',
			yb010_zhusui: '珠碎',
			...
			//-----------------------高宇航(此版本难写,欲要作废)
			yb011_kongbai: '空白',
			yb011_kongbai_info: '锁定技,当你使用装备牌时,你将该装备牌移出游戏,获得该装备的技能,最后废除该装备栏;当你受到卡牌造成的伤害时,若你未拥有对应的<痕>,你记录该牌名为<痕>.',
			yb011_chenxing: '尘醒',
			yb011_chenxing_info: '使命技,准备阶段①成功:若你已废除装备栏不小于三个(原文是全部,此处降低难度),你增加一点体力上限,回复一点体力,获得技能〖姻梦〗;②失败:若你已废除装备栏小于三个,且你的<痕>不小于3,则你失去一点体力上限,失去〖空白〗,获得〖恨〗.',
			yb011_yinmeng: '姻梦',
			yb011_yinmeng_info: '当你即将造成卡牌伤害时,若你有此牌对应的<痕>,你可以防止此伤害并移除对应的<痕>,你与当前回合角色各摸一张牌,否则你可以记录对应的<痕>.',
			yb011_hen: '恨',
			yb011_hen_info: '锁定技,当你获得此技能时,将你的胜利条件修改为<击杀除你以外所有角色>;所有被<痕>记录的牌名无法对你造成伤害;你摸牌阶段额外摸<痕>的数量;你手牌上限增加<痕>的数量;你使用<痕>记录的牌名造成伤害时,此伤害+1;回合结束时,若你本回合未击杀其他角色,你失去一点体力.',
			//----------------------新版高宇航(主要是好写)
			yb011_lijian: '离间',
			...
			// 'yb012_buxing':'不行',
			// 'yb012_buxing_info':'当你发动〖作弊〗时,若你的上家或下家为男性,则其可以交给你一张牌,你选择:①视为其对你造成一点伤害,②此次〖作弊〗使用的牌无效.',
			//------------上为废稿
			yb012_bianqian: '便签',
			yb012_bianqian_info: '出牌阶段限一次,你可以将一张手牌盖在武将牌上称为<小抄>;你可以在合适的时机选择一张<小抄>,①使用此<小抄>,并弃置其余小抄②弃置此<小抄>,并将一张手牌当此>小抄>使用.',
			yb012_xibei: '习备',
			...
			yb014_shihua: '诗华',
			yb014_shihua_info: '觉醒技,准备阶段或结束阶段,若你手牌数小于体力值,则你摸等同体力上限的牌数,失去一点体力上限,获得〖窥梦〗',
			yb014_kuimeng: '窥梦',
			...
			//-----------------------神夜白
			yb014_shizhui: '诗追',
			yb014_shizhui_info: '<span class=yellowtext>游戏开局时或一轮游戏开始时,你可以减1点体力上限,将一名其他角色武将牌上的技能加入到你的武将牌上.出牌阶段,你可以删除一个以此法获得的技能,摸三张牌,并回复一点体力/增加一点体力上限.</span>',
			//------此处应为王海茹,满城柒,小红,前者并无异构,后两者在六艺篇
			//-----------------六艺篇已被独立
			//---------------------新满城柒
			yb016_juli: '拒礼',
			yb016_juli_info: '当一名角色成为除其外的角色使用【杀】的目标时,若你至该角色的距离不大于1,你可以重铸至多1张牌,令此牌的使用者弃置一张牌,(该牌的类型须为你重铸的牌中包含的类型)否则此牌对你无效.',
			yb016_shenzou: '神奏',
			yb016_shenzou_info: '出牌阶段限一次,你可以随机演奏一首音乐,并根据完成度来获得相应的分数(至多五分).你可令【拒礼】中的一个阿拉伯数字+1(消耗分数为该选项当前数字)或将【杀】改为伤害性牌(消耗5分),并使用剩余的分数进行摸牌(每张2分).',
			// 'yb016_shenzou_append':'目前的削弱手段为,禁止其加点第二个数字,后续调整有待斟酌',
			//-----------------------SP满城柒
			yb016_xianyue: '仙乐',
			yb016_xianyue_info: '当你回复体力后,你可以弃置一张牌并进行一次判定,若结果为:♥️️,你回复一点体力;♦️️,你摸两张牌;♣️️,你弃置一名角色的两张牌;♠️️,你令一名角色流失一点体力.',
			yb016_tianliao: '天疗',
			yb016_tianliao_info: '当你回复体力时,你可以弃置一张牌,令此回复值加一.',
			yb016_qingjie: '清节',
			yb016_qingjie_info: '锁定技,当你受到伤害后,你 回复X点体力,流失X点体力.(X为本次伤害值)',
			yb016_pojie: '破界',
			yb016_pojie_info: '锁定技,当你回复体力时,若回复值溢出,则取消溢出的回复值,改为增加等量体力上限,并摸等量牌.',
			//-----------------------满城柒重制版废稿
			yb016_melody: '歌律',
			yb016_melody_info: '锁定技,当你使用牌指定其他角色为目标后或成为其他角色使用牌的目标后,若没有角色处于濒死状态,记录此牌花色.当记录花色数达到5时,立即终止当前所有结算,根据记录情况,执行效果:<br/> <i>第一位决定句式<br/>♠️️:令B执行D,或令C执行E;<br/>♥️️:令B依次执行DE,否则C执行DE;<br/>♣️️:令B执行D,令C执行E;<br/>♦️️:令B执行D或E中你选择的一项,C执行相同的一项;<br/>🃏:令B执行DE中0之2项,令C执行DE中0之2项;<br/>第二/三位决定B/C:<br/>♠️️:任意一名角色;<br/>♥️️:指定一名角色,与指定角色性别不同的<b>角色</b>;<br/>♣️️:所有角色;<br/>♦️️:所有其他角色;<br/>🃏:至少一名任意角色;<br/>第四/五位决定效果:<br/>♠️️:失去一点体力或翻面;<br/>♥️️:回复一点体力或摸一张牌;<br/>♣️️:受到一点无属性伤害或弃两张牌;<br/>♦️️:摸一张牌或摸一张牌或摸一张牌;<br/>🃏:任选一个花色执行,并将或改为并</i>',
			//---------------新小红
			yb017_chuanxin: '传信',
			yb017_chuanxin_info: '锁定技,一名角色的结束阶段开始时,若当前角色本回合内使用过牌,你选择一项:①摸一张牌,②视为使用一张其本回合使用过的一张非【装备及延时】牌.',
			yb017_zuigui: '醉归',
			yb017_zuigui_info: '锁定技,弃牌阶段开始时,你视为使用一张酒;你的酒buff会赋给任何伤害牌;你使用的酒不计入次数,且效果改为:回复一点体力,令目标本回合下一张杀伤害+1.',
			//-----------------------神小红
			yb017_mizhu: '秘助',
			yb017_mizhu_info: '锁定技,游戏开始的时候,把八张【鹿鸣千转】加入牌堆.【鹿鸣千转】对你无效.当有一名角色成为【鹿鸣千转】的目标时,你可以查看其手牌,为其重新指定<喜啼>或<悲鸣>.',
			yb017_guangzhu: '广智',
			yb017_guangzhu_info: '锁定技,当一名角色使用非虚拟且非转化的锦囊牌时,若此牌的牌名属于智囊牌名、<贞侍>已记录的牌名或【鹿鸣千转】,你摸一张牌.',
			yb017_zhenshi: '贞侍',
			yb017_zhenshi_info: '锁定技,当你成为锦囊牌的目标时,若此牌名未被记录,则记录此牌名,取消之.回合开始时,你可以在<贞侍>记录中增加或移除一种锦囊牌牌名.',
			//-----------------------张晴
			yb018_huaimeng: '怀梦',
			yb018_huaimeng_info: '锁定技,游戏开始时,你获得五枚<梦>;当你于每个回合首次使用或打出一种花色的牌时,你获得一枚<梦>标记;每轮开始时,你需指定一个花色,本轮你因该花色获得的<梦>改为三枚.',
			yb018_minxing: '悯星',
			yb018_minxing_info: '回合开始或结束阶段,你可以移除两枚<梦>标记,并摸<span class=thundertext>3</span>张牌,将<span class=thundertext>3</span>张手牌以任意顺序盖在牌堆顶(你可以移除至多两枚<梦>,令蓝色字体增加等量值)你可以展示牌堆顶三张牌并置入弃牌堆,:①若出现两张同花色的牌,你摸一张牌或获得花色与其他不同的牌(背水:移除一枚>梦>标记);②若出现三张同花色的牌,你摸两张牌或回复一点体力(背水:移除两枚<梦>标记).',
			yb018_fanling: '凡灵',
			yb018_fanling_info: '伪转换技,锁定技,游戏首轮开始时,你需指定一个状态作为起始状态.从第二轮开始时,你每轮需移除一枚<梦>标记,转换一次形态.(没有梦标记则无法发动.)①你视为拥有技能〖栖月〗直至本轮结束;②你视为拥有技能〖折叶〗直至本轮结束.',
			yb018_fanling1: '凡灵',
			yb018_fanling1_info: '',
			yb018_zheye: '折叶',
			...
			//-----------------------废案张晴
			yb018_yinsi: '吟思',
			yb018_yinsi_info: '回合开始时,你可以移去两枚<梦>,卜算3;摸牌阶段开始时,你可以移去一枚<梦>,多摸一张牌;出牌阶段开始时,你可以移去两枚<梦>,获得【善舞】直到回合结束;回合结束时,你可以移去两枚<梦>,获得技能【注视】、【轻灵】直到下回合开始.',
			yb018_yinsia: '吟思',
			yb018_yinsia_info: '',
			yb018_yinsib: '吟思',
			yb018_yinsib_info: '',
			...
			yb018_yinsid_info: '',
			dz018_shanwu: '善舞',
			dz018_shanwu_info: '出牌阶段限一次,你可以弃置任意张牌,摸等量的牌.若你本次弃置的牌均为:基本牌,你回复一点体力;锦囊牌,你摸两张牌;装备牌,本回合接下来造成的伤害+1.',
			dz018_zhushi: '注视',
			dz018_zhushi_info: '回合结束时,你可以记录一名其他角色(效果触发前不可见),该角色于其出牌阶段内使用牌指定你为目标后你摸X张牌(X为其本阶段使用的牌数且至多为5);该角色的结束阶段开始时,若其本回合没有使用牌指定你为目标,则你获得其一张牌,你失去一点体力.',
			dz018_qingling: '轻灵',
			dz018_qingling_info: '锁定技,你的手牌上限+1;当你受到大于一点的伤害时防止之,流失一点体力.',
			//-----------------------神张晴
			yb018_isi: '懿思',
			yb018_isi_info: '出牌阶段限一次,若你的体力上限小于10,你可进行判定牌不置入弃牌堆的判定.若判定结果与本次发动技能时的其他判定结果的花色均不相同且你的体力上限小于10,则你加1点体力上限并重复此流程.你将所有位于处理区的判定牌交给一名角色.若其手牌数为全场最多,则你减1点体力上限.',
			yb018_chongmeng: '宠梦',
			yb018_chongmeng_info: '觉醒技,准备阶段,若场上的所有存活角色均于本局游戏内受到过伤害,则你加2点体力上限并回复1点体力,令一名角色获得技能〖释罔〗.',
			yb018_yisi: '仪祀',
			yb018_yisi_info: '限定技,出牌阶段,你可选择一名角色.若你的体力上限不小于存活人数且其有未发动的觉醒技,则你令其中一个技能无视发动条件;否则其摸四张牌.你减2点体力上限.',
			yb018_guajian: '挂件',
			yb018_guajian_info: '因为怕出bug,故而添加此挂件...',
			yb018_shiwang: '释罔',
			yb018_shiwang_info: '准备阶段,若令你获得〖释罔〗的角色存活且体力上限大于1,则你可以令其减1点体力上限,你获得如下效果:出牌阶段限一次,你可以视为使用一张普通锦囊牌.',
			yb018_shiwang2: '释罔',
			...
			yb019_zhiyu: '掷郁',
			yb019_zhiyu_info: '每回合每种牌名(限实体牌名)限一次.出牌阶段,你可以展示一张手牌并交给一名其他角色,视为你对其使用此牌(不计入次数,不受距离限制).',
			yb019_misan: '弥散',
			yb019_misan_info: '当你使用基本牌时,你可以将其交给一名其他角色.每回合每种牌名限一次.',
			yb019_renxing: '任性',
			yb019_renxing_info: '每回合对每名角色限一次,当你使用【杀】或伤害类锦囊指定目标后,你可以观看其手牌,弃置其一张基本牌.',
			...
			//-----------------------贾雨桐(待写)
			yb020_shange: '善歌',
			yb020_shange_info: '出牌阶段,你可以弃置至多五张同颜色的牌,翻开牌堆顶双倍的牌,获得其中与你弃置的牌颜色不同的牌,若你获得的牌数小于你弃置的牌数,你可以回复一点体力或令一名其他角色失去一点体力.每个出牌阶段对每个颜色限一次.',
			yb020_wanyue: '挽月',
			yb020_wanyue_info: '结束阶段,你可以摸4-Y张牌 (至少为1),Y为你当前手牌中的花色数.',
			yb020_yuyun: '余韵',
			yb020_yuyun_info: '锁定技,你每使用一张黑色牌,获得一枚<仄>标记;你每使用一张红色牌,获得一枚<平>标记;你每使用一张🃏牌时,你获得一对<平仄>标记;当你获得一枚<仄/平>时,若你已拥有<平/仄>,你移去一对<平仄>,回复一点体力或摸一张牌.',
			//-----------------------刘域楓(待写)
			yb021_shusuan: '数算',
			yb021_shusuan_info: '出牌阶段限一次,你可以观看牌堆顶4+X张牌,选择自己的手牌与牌堆顶的牌共计四张展示,用这四张牌的点数计算24点,若成功,则你摸4+X张牌.计算结束后,你需将用于计算的牌交给一名其他角色或弃置.',
			yb021_qiujiao: '求教',
			yb021_qiujiao_info: '出牌阶段限一次或当你受到一次伤害后,你可以令一名其他角色交给你一张牌,并令你下一次〖数算〗的X值加一.',
			//-----------------------盐(待写)
			yb022_yiduan: '臆断',
			// 'yb022_yiduan_info':'当你需要使用一张不是<装备牌或延时性锦囊>的牌时,若此牌未被〖臆断〗记录,你可以声明该牌名,将牌堆顶第一张牌视为这张牌使用之.若该牌本体与你声明的牌名不一致,则你记录该牌名,令〖臆断〗本回合无法使用.',
			...
			yb022_duanxiang: '断想',
			yb022_duanxiang_info: '每回合限一次,当有角色受到伤害后,你可以令受伤角色选择一项:①,弃置2X张牌(牌数不够则不能选),回复X点体力;②,失去X点体力上限,摸X张牌.(X为其已损体力值.)',
			yb022_duanxiangxin: '断想',
			yb022_duanxiangxin_info: '每回合限一次,当有角色受到伤害后,<br>①若伤害来源的手牌数不等于受伤角色的体力值,你可令伤害来源将手牌调整至受伤角色的体力值;<br>②若受伤角色的手牌数不等于伤害来源的体力值,你可令受伤角色将手牌调整至伤害来源的体力值.',
			//下面是废弃的描述
			...
			yb022_duanxiangxx_info: '觉醒技,当你进入濒死状态时,若你〖臆断〗记录的牌名大于X(X为场上玩家数且最小为4),你失去〖臆断〗,增加一点体力上限,回复一点体力.',
			//-----------------------史庆宇(待写)
			//-----------------------岳瞳(待写)
			//-----------------------史庆宇王贺(待写)
			yb025_mojiang: '摸奖',
			yb025_mojiang_info: '(机制不成熟,先用水转百戏图将就一下)出牌阶段限一次,你可以表演一次抓娃娃,判定娃娃的品质并摸等量张牌,将等量张牌交给一名其他角色或弃置.｛娃娃机初始刷新一个4品质娃娃,两个3品质娃娃,五个2品质娃娃,八个1品质娃娃,娃娃机每轮开始时(不包括第一轮),自然刷新一个4品质,两个3品质,三个2品质,四个1品质娃娃;娃娃总数不得超过20只;娃娃机每次限时30秒｝',
			yb025_zanzhu: '赞助',
			...
			yb026_xiaoye: '笑靥',
			yb026_xiaoye_info: '当你成为其他角色使用杀的目标时,你可以摸一张牌或弃一张牌,若你的手牌数小于杀的使用者,则此杀对你无效.每回合每个选项触发的令杀无效各限一次.',
			//-------------------梦雨--------------//
			yb027_sanmeng: '散梦',
			...
			// 'yb027_milixx_info':'锁定技,当你使用基本或普通锦囊牌时,或当你被其他角色使用基本或普通锦囊指定为目标时,若此牌未被记录,你记录之.每回合限一次,当你使用基本或普通锦囊时,或成为其他角色使用基本或普通锦囊的目标时,若已有记录,你可以令此牌的效果改为你记录的另一张牌的效果(同时移除此记录),本次使用牌不会被主技能记录.',
			yb027_mili: '迷离',
			yb027_mili_info: '锁定技,当一名其他角色对你使用牌时,其获得一枚<迷>;其他角色回合结束后,若其有<迷>,则你令其移除所有<迷>,你摸等量牌.',
			//-------------------梦晶--------------//
			yb028_sanmeng: '散梦',
			yb028_sanmeng_info: '梦势力技,回合开始时,你可以摸两张牌,若如此做,本回合手牌上限-1.弃牌阶段开始时,你可以弃置两张牌,令手牌上限+1.',
			yb028_jianzhen: '剑阵',
			yb028_jianzhen_info: '苏婆夏洛特,出牌阶段限一次或当你受到伤害(伤害至少为一)后,你可以摸一张牌,选择一张手牌置于武将牌上称为剑元<br>根据剑元废除对应的装备栏并获得如下技能.<br>武器栏:金剑元,锁定技,你的攻击范围加2;当你使用杀时,你无视对方防具.当你造成伤害时,你可以移除金剑元,令伤害+1.<br>防具栏:土剑元,你可以将一张装备牌当【无中生有】使用.当你受到伤害时,你可以移除土剑元,令伤害-1.<br>进攻马:火剑元,出牌阶段限一次,你可以将所有手牌当任意锦囊使用.当你使用牌指定目标后,你可以移除火剑元,弃置此牌目标各一张牌.<br>防御马:水剑元,当你成为其他角色使用【杀】的目标时,你可以依次选择是否①弃置一张牌,将此杀【流离】出去;②移除水剑元,与一名可成为【流离】目标的其它角色互换座位.<br>宝物栏:木剑元,当你失去最后的手牌时,你可以摸一张牌,你可以移除木剑元并摸等同体力上限的牌数.',
			yb_jianyuan_jin: '金剑元',
			yb_jianyuan_mu: '木剑元',
			...
			// yb_jianyuan_tu_info:'你可以将一张装备牌当【无中生有】使用.当你受到伤害时,你可以移除土剑元,令伤害-1.',
			yb028_sheshen: '舍身',
			yb028_sheshen_info: '锁定技,当你装备栏被废除时,你令一名角色摸两张牌并回复一点体力,你减一点体力上限;你的手牌上限额外增加被废除装备栏的数量;当你体力上限不大于1时,你无法扣减体力上限.',
			//-------------------梦黎--------------//
			yb029_sanmeng: '散梦',
			...
			//-------------------书--------------//
			yb030_jiangdao: '讲道',
			// 'yb030_jiangdao_info':'(机制过于复杂,风评极其不佳,有功夫改改)出牌阶段限一次,你可以摸等同其他角色数的牌数,展示等量牌,令所有其他角色依次选择一项:<br>①获得你展示的其中一张牌;<br/>②对你使用一张杀,获得一枚<逆>标记,*拥有<逆>标记的角色无法选择①选项;<br/>③受到你造成的X点伤害,X为该角色的<逆>标记数,移除其所有<逆>标记.',
			...
			yb033_shuhui: '淑慧',
			// 'yb033_shuhui_info':'回合开始时,你可以弃置一张手牌,令一名角色回复一点体力.(追加描述:否则你令至多X名其他角色各失去一点体力,X为你本次弃牌数.)你将被此技能选中的其他角色记录为<诉>.',
			yb033_shuhui_info: '回合开始时,你可以弃置一张手牌,并令一名角色回复或失去一点体力.(追加描述:你展示牌堆顶一张牌,将隅泣任意一个数字改为该数字,不会低于原数字且至多为当前最低的数字+2).',
			yb033_yuqi: '隅泣',
			yb033_yuqi_info: '每回合限三次.当有角色受到伤害后,若你至其的距离不大于<span class=thundertext>2</span>,则你可以观看牌堆顶的<span class=firetext>3</span>张牌.你将其中至多<span class=greentext>2</span>张牌交给受伤角色,可以获得剩余牌中的至多<span class=yellowtext>2</span>张牌,并将其余牌以原顺序放回牌堆顶.',
			yb033_lvxin: '旅心',
			...
			yb034_rebifa: '笔伐',
			yb034_rebifa_info: '出牌阶段,若场上没有被夜白笔伐选择的角色,你可以展示一张手牌并交给一名其他角色,该角色不能使用或打出手牌直到此阶段结束.若被夜白笔伐选择的目标于此阶段阵亡,你摸一张牌.',
			yb034_bifa: '笔伐',
			yb034_bifa_info: '出牌阶段,若场上没有被夜白笔伐选择的角色,你可以展示一张手牌并交给一名其他角色,该角色不能使用或打出与此牌同颜色的手牌直到此阶段结束.若被夜白笔伐选择的目标于此阶段阵亡,你摸一张牌.',
			yb034_rejiandao: '剑道',
			yb034_rejiandao_info: '锁定技,你的手牌上限加一,且获得如下效果:出牌阶段限一次,你可以视为使用一张【杀】(无次数限制).',
			yb034_jiandao: '剑道',
			...
			yb035_liuwang: '流亡',
			yb035_liuwang_info: '限定技,当你进入濒死状态向自己求【桃】时,你可以回复体力至1,从游戏外抽取四张主公武将并选择其一,获得其武将牌上所有技能,将性别,势力调整至与其相同,获得技能〖威严〗.',
			yb035_weiyan: '威严',
			...
			yb036_chongzheng: '重整',
			yb036_chongzheng_info: '限定技,准备阶段或结束阶段或濒死求桃时,你可以回复一点体力,摸两张牌,并重置〖前进〗.',
			yb036_aoxiang: '翱翔',
			yb036_aoxiang_info: '你可以红牌当杀,黑牌当闪使用或打出.锁定技:当你使用牌时,你需移除一枚<进>,摸一张牌;当<进>清零时,重置〖前进〗,并可令成功所需的标记数+1或-1(至多加至8,至少减至3).',
			//-------------------梦♦️️Q--------------//
			yb037_sanmeng: '散梦',
			...
			yb037_kexie: '咳血',
			yb037_kexie_info: '锁定技,每当你弃置一张牌(红色牌/♥️️牌)时,你失去一点体力.',
			yb037_guiling: '龟灵',
			yb037_guiling_info: '锁定技,若你未装备防具,则当你受到大于1的伤害时,该伤害减为1;当你脱离濒死状态时,若你拥有〖咳血〗,则修改〖咳血〗(已修改到♥️️则改为删除);若你因〖咳血〗而进入濒死状态,则减一点体力上限并回复体力至上限.(体力上限若不大于三则不减)',
			//-------------------梦忆滕叔颖武宁--------------//
			yb038_sanmeng: '散梦',
			yb038_sanmeng_info: '梦势力技,回合开始时,你可以摸两张牌,若如此做,本回合手牌上限-1.弃牌阶段开始时,你可以弃置两张牌,令手牌上限+1.',
			yb038_quanlu: '泉路',
			yb038_quanlu_info: '锁定技,当你使用牌时,你需弃置一张手牌(无牌不弃),若你的手牌数为0,则你选择失去一点体力或体力上限,摸X张牌(X为你的体力上限且至多为5),计数.',
			yb038_shenglu: '生路',
			yb038_shenglu_info: '锁定技,当你使用牌时,你可以弃置一张牌,若你的手牌数为0,则你选择失去一点体力并增加一点体力上限<span class=firetext>或</span>失去一点体力上限并回复一点体力,摸X张牌(X为你当前体力上限且至多为5).',
			yb038_fusheng: '复生',
			yb038_fusheng_info: '觉醒技,当你进入濒死状态时,若你泉路计数小于3次,你减Y点体力上限,否则你增加(Y+1)点体力上限(Y为泉路计数-2的绝对值).回复Z点体力(Z为泉路计数-2且至少为1),失去〖泉路〗,获得〖生路〗和〖恩许〗.',
			ybtq_fusheng: '复生',
			ybtq_fusheng_info: '觉醒技,当你进入濒死状态时,立即归还因〖泉路〗而失去的体力值和体力上限.增加两点体力上限,并获得〖往愿〗和〖恩许〗,最后清除泉路计数.',
			yb038_wangyuan: '往愿',
			yb038_wangyuan_info: '锁定技,回合结束后,你归还因〖泉路〗而失去的体力值和体力上限,若你泉路计数为3及以上,你移去3点计数,增加一点体力上限.',
			yb038_enxu: '恩许',
			yb038_enxu_info: '忆势力技,出牌阶段限一次,你可以失去两点体力上限,令一名其他男性角色摸X张牌(X为你发动技能时的体力上限且至多为6),你与其体力较低的一方回复体力至与对方相等.',
			//-------------------梦查符--------------//
			yb039_sanmeng: '散梦',
			...
			//----------------------蘋姉--------------//
			yb042_sizhi: '思智',
			yb042_sizhi_info: '出牌阶段限一次,你可以弃置任意张点数之和为13的牌,摸两倍数量的牌.以此法获得的牌中,黑色牌本回合无距离和次数限制,红色牌本回合不计入手牌上限.',
			yb042_mingtui: '明退',
			yb042_mingtui_info: '当你成为牌的目标时,若此牌有点数,你可以弃置任意张点数和大于此牌的牌,跳过此牌对你的结算.',
			yb042_lisheng: '离笙',
			yb042_lisheng_info: '当<b>你阵亡时/场上其他角色阵亡时</b>,你可以令<b>一名其他角色/自己</b>从牌堆中获得每种花色的牌各一张,回复一点体力.',
			//--------------------房佳瑜--------------//
			//--------------------胡瑞航--------------//
			//--------------------高聪----------------//
			//--------------------江雪舞--------------//
			...
			//--------------------彡------------------//
			yb047_youhun: '游魂',
			yb047_youhun_info: '转换技,阴:你可以将X+Y张牌当作任意一张锦囊牌使用;阳:你可以将X+Y张牌当作任意一张基本牌使用.当此牌造成伤害后,你增加一点体力上限,Y计数+1.(X为本轮此技能使用次数且至少为0,Y初始为0,最低为0);每当你废除一个装备栏时,你令Y计数-1;',
			yb047_wanxin: '挽心',
			yb047_wanxin_info: '一名角色的回合结束时,你可以令一名本回合内受到过伤害的角色摸两张牌,你与其将武将牌重置.',
			yb047_shouqing: '守情',
			...
			yb048_wuling_info: '锁定技,若你没有〖巫女〗,你视为拥有〖巫女〗.你可以使用以下技能:<br><span class=yellowtext>出牌阶段限一次,你可以弃置任意张手牌并选择一名其他角色(不能超过该角色的牌数),令其选择一项:弃置一张牌并令你摸X张牌,或弃置X张牌并令你摸一张牌.你将你与其弃置的且位于弃牌堆中的牌以任意顺序置于牌堆顶,若你有凝元,你可改为将这些牌放在武将牌上称为<元>.</span>',
			yb048_huanjie: '幻界',
			...
			yb053_yinren: '隐忍',
			yb053_yinren_info: '锁定技,①当你受到伤害时,你需选择:弃置一张牌,或令此伤害+1;获得如下效果直至当前回合结束:②每个回合结束时,你选择回复两点体力或摸X+1张牌(X为你已损体力值且至多为3);③当你脱离濒死状态时,你升级此技能(令②效果变为常驻效果.)', //,将技能改名为【迸射】
			//--------------------悦儿----------------//
			yb054_caijin: '裁巾',
			yb054_caijin_info: '其他角色使用点数大于1的装备牌时,你可以令此牌点数-1,你获得一张点数为1的同名牌并可立即使用.当复制牌进入弃牌堆时,自动销毁,并令此牌的原型点数+1,若此牌的原型仍在场上,则区域内有该牌的角色回复一点体力.',
			// 'yb054_caijin_info':'限定技,出牌阶段,你选择一张在游戏内且点数大于1的装备牌,你将此牌移出游戏,创建两张与此牌同牌名的牌,且两张牌的点数之和等于原来的那张牌,花色与原来的牌相同.你选择一名其他角色,你与其各获得一张,且可立即使用之.标记该角色为<裁巾>.',
			yb054_xiezhi: '血指',
			yb054_xiezhi_info: '①锁定技,当你受到伤害后,你展示手牌,若其中红色手牌数不大于你体力值,你摸三张牌;<br>②当你进入濒死状态时,你可以展示手牌并弃置所有红色手牌,回复体力至所弃红色牌的数量.若如此做,此伤害结算完成后,1和2效果于本回合失效.<br>③当<裁巾>角色造成伤害时,你可选择①或②其中一项内容执行.(大饼待写)',
			yb054_chouqi: '愁泣',
			yb054_chouqi_info: '转换技,当你受到伤害后,你可以展示手牌,并制衡任意张(阴,黑色手牌;阳,红色手牌),若你以此法制衡了该颜色所有牌,你额外摸一张牌.(大饼待写)',
			yb054_zhishang: '炙伤',
			yb054_zhishang_info: '锁定技,每当你受到一次伤害后,你摸三张牌,若此伤害为属性伤害且你受伤时未处于横置状态,你减一点体力上限.',
			yb054_tongxin: '同心',
			yb054_tongxin_info: '当其他角色受到大于1点且有来源的伤害时,你可令此伤害-1,受到1点同属性无来源伤害.',
			//--------------------郑琰----------------//
			//--------------------董建超--------------//
			//--------------------孙美琪--------------//
			//--------------------孙世博--------------//
			...
			// yb059_liuxing_info:'',
			yb059_huiguang: '晖光',
			yb059_huiguang_info: '锁定技,游戏开始时,你选择一名星落四公主之一,将武将牌替换为其.当你即将阵亡时,若你仍有存活公主,则取消之,改为减少一点体力上限(至多减至1)并将武将牌替换为一名未阵亡的公主,并将你武将牌上的技能添加至新公主武将牌上,回复体力至上限.', //你视为拥有星落四公主全体成员武将牌上的所有技能.
			yb059_xingshi: '星逝',
			yb059_xingshi_info: '锁定技,每回合限一次,当你使用牌指定其他角色为唯一目标后,或成为其他角色使用牌的唯一目标后,你依次弃置你和对方的所有手牌,此牌结算完成后,你和对方各自摸等同自身当前体力值的牌数.',
			yb059_guanhong: '贯虹',
			...
			yb059_qingliu_info: '锁定技,当你使用牌时,若此牌不为你的手牌,则你重置武将牌上的技能;你摸牌阶段额外摸6-你武将牌上技能数张牌.',
			yb059_pingyu: '评雨',
			yb059_pingyu_info: '场上角色的判定阶段开始时,若其判定区没有牌,你可令其进行一次【灵雨】判定.一名角色的判定牌生效前,你可以打出一张牌替换之,若此牌与原判定牌的花色相同,你摸一张牌.',
			// yb059_pingyu_info:'场上角色的判定阶段开始时,若其判定区没有牌,你可令其进行一次【灵雨】判定.每当场上有判定牌生效后,你可以弃置自己的一张与判定结果花色相同的牌,摸两张牌.',
			// yb059_pingyu_info:'场上角色的判定阶段开始时,若其判定区没有牌,你可令其进行一次【灵雨】判定.每当场上有判定牌生效后,你可以弃置进行判定的角色一张牌,若弃置牌和判定结果花色相同,其摸两张牌,否则你可以弃置自己的一张与判定结果花色相同的牌,摸两张牌.',
			// yb059_xuanfeng:'旋风',
			// yb059_xuanfeng_info:'',
			// yb059_pingyu:'评雨',
			...
			yb067_chanqing: '缠情',
			yb067_chanqing_info: '出牌阶段限一次,你可以指定一名其他角色,{你弃置一张手牌,并令其摸一张牌(若其手牌数大于体力上限则不摸),获得其一张手牌,若此牌可以主动使用,你可以使用之},重复此流程,直到此流程执行X次,X为其体力值且至多为5.)流程结束后你可以令双方各摸Y张牌,Y为此技能实际执行次数.<i>当你使用〖缠情〗指定目标时,若目标与你上次〖缠情〗的目标:相同,你将势力改为忆并回复一点体力;不同,你将势力改为梦并摸两张牌.出牌阶段结束时,若你本阶段没有发动此技能,则移除上次目标的记录.</i>',
			yb067_kuiyi: '溃忆',
			yb067_kuiyi_info: '忆势力技,结束阶段,你可以弃置所有手牌,定义X为所弃牌数,根据所弃花色依次执行:<br/>1,令至多X名角色各摸一张牌;<br/>2,令至多X名角色各回复一点体力;<br/>3,令至多X名角色增加一点体力上限;<br/>4,令一名任意角色摸3张牌;<br/><i>若你本回合发动过〖缠情〗,则此技能指定本回合〖缠情〗角色为目标时,其在此技能流程结束时,额外执行一次被分配到的最后一项.</i>',
			//--------------------清月----------------//
			yb068_mingzhu: '明珠',
			...
			yb069_yaomian: '邀眠',
			yb069_yaomian_info: '出牌阶段限一次,你可以指定一名其它角色,若{其为男性角色且有牌,你获得其一张牌},你与其各自翻面.',
			yb069_wenhuan: '温幻',
			...
			yb070_fuyi: '傲寒',
			yb070_fuyi_info: '出牌阶段限一次或准备阶段或当你进入濒死状态时,你可以移去你列表中第一个技能,进行一次TW扶汉,势力范围为神,忆,梦,抽取数量为场上存活角色数且至少为4,{将池排除掉神夜白,神贾诩,线下神马超},若你体力值为全场最低,则顺便回复一点体力.',
			//-------------------071faraway
			ybsl_xinghen: '星痕',
			ybsl_xinghen_info: '锁定技,定义X为你<痕>标记数;你的手牌上限+X且至多+5,你摸牌阶段额外摸X张牌且至多额外摸3;当你体力值变动时,你获得等量<痕>;当你进入或脱离濒死时,你随机摸一至三张牌;结束阶段,若你的<痕>数大于手牌数加体力上限,你需弃置所有手牌,移除所有<痕>并加一点体力上限,将手牌摸至体力上限.',
			ybsl_cuixing: '淬星',
			...
			ybsl_cuixing_spade_info: '你可以将一至两张♠️️牌当作【无懈】使用或打出,属性为<span class=YB_snowtext>冰</span>.',
			...
			ybsl_xingbian: '星变',
			ybsl_xingbian_info: '锁定技,当你获得牌时,若你体力上限加体力值大于手牌数乘2,你减一点体力上限(体力上限不大于1则不减),升级〖淬星〗,此技能在洗牌之前无法使用.',
			ybsl_cuixing_change: '淬星升级',
			ybsl_cuixing_change_info: '为每种花色分配一种额外的转化目标牌,每种目标牌限添加一次.因此法添加的牌每回合限用一次.',
			//----------------------苏令燚
			yb072_ezhao: '恶兆',
			yb072_ezhao_info: '锁定技,场上其他角色回合开始时,你令其判定,若此结果与其所有<呪>花色不同,你将此牌置于其武将牌上称为<呪>,否则(置入弃牌堆,该角色可以对你发起〖投江〗).<br/>有<呪>的角色使用牌时,若其有<呪>与此牌花色相同,你可以令此牌无效或令其摸一张牌.',
			yb072_toujiang: '投江',
			yb072_toujiang_info: '所有其他角色对你进行<是否>投票,若<是>大于<否>,则你神圣死亡.其他角色对你投票时,其票数增加X,X为其<呪>数.',
			//-------------------073Al
			ybsl_duanzui: '断罪',
			ybsl_duanzui_info: '①出牌阶段限一次,你可指定一名其他角色,将其区域内一张牌置于武将牌上称为<§>(若其无牌则改为牌堆顶一张牌),若其体力上限大于1,你令其减少1点体力上限,你减少1点体力上限.<br>②你对拥有<§>标记的角色使用牌没有距离限制.<br>③拥有<§>标记的角色手牌上限加X,X为其<§>标记数.',
			ybsl_zhenhun: '镇魂',
			ybsl_zhenhun_info: '锁定技.①当你使用牌指定目标后,若目标有<§>标记,则其不可响应此牌.若你本回合内以此法获得的牌数小于2,则你摸一张牌.<br>②每回合限一次,当你造成伤害后,你可以选择获得受伤角色的一张<§>,你增加一点体力上限并摸一张牌.<br>③每当场上有<§>的角色阵亡时,你增加Y点体力上限并摸Y张牌.(Y为其<§>标记数.)',
			ybsl_kunyu: '困圄',
			ybsl_kunyu_info: '锁定技.①你的手牌上限基数等于你已损失的体力值.<br>②当你受到其他角色造成的伤害时,若你的体力上限大于1.则你防止此伤害,减一点体力上限并将一张手牌交给一名其他角色.若你拥有【断罪】,则你将伤害来源的一张牌置于其武将牌上作为<§>(若其无牌,则改为牌堆顶一张牌).', //§
			//----------------074花落隨風----------------//
			ybsl_guanxing: '观星',
			...
			yb076_zhenlie: '贞烈',
			yb076_zhenlie_info: '当你成为其他角色使用【杀】或普通锦囊牌的目标后,你可以失去一点体力并令此牌对你无效,弃置对方一张牌.',
			//-------------------梦羊祈絮--------------//
			yb077_sanmeng: '散梦',
			...
			yb080_niepan: '涅槃',
			yb080_niepan_info: '限定技,当你处于濒死状态时,你可以复原你的武将牌,将体力回复至3点并摸三张牌,最后获得技能【凤鸣】.',
			yb080_fengming: '凤鸣',
			yb080_fengming_info: '出牌阶段结束后若你于本阶段未使用过牌,或出牌阶段被跳过,你可以选择一项①本回合手牌上限+3;②视为使用一张〖凤鸣九霄〗.',
			//-------------------陈丽陈思--------------//
			yb081_lvxin: '旅心',
			...
			// yb082_youhun_info:'转换技,阴:你可以将X+Y张牌当作任意一张锦囊牌使用;阳:你可以将X+Y张牌当作任意一张基本牌使用.当此牌造成伤害后,你增加一点体力上限,Y计数+1.(X为本轮此技能使用次数且至少为0,Y初始为0,最低为0);每当你废除一个装备栏时,你令Y计数-1;',
			yb082_chameng: '诧梦',
			...
			//-------------------张汨----------------//
			yb084_xundu: '寻妒',
			yb084_xundu_info: '每回合限一次,当有其他角色于摸牌阶段外获得牌时,你可以展示之,展示手牌,若其中没有与你手牌同名的牌,你令该角色选择一项<br/>①受到你造成的一点伤害②将这些牌改为你获得之.<br/>若有同名牌,你可以弃置手牌中所有同名的牌,本次选项由你选择.',
			yb084_efei: '恶诽',
			yb084_efei_info: '每回合限一次,①当其他角色使用牌时,你可以弃置一张同名牌,令此牌无效;②当其他角色受到卡牌伤害后,你可以弃置一张与造成伤害的牌牌名相同的牌,你令此牌追加造成一点伤害.',
			yb084_pomen: '破梦',
			...
			//--------------------独孤雨-------------//
			yb085_muyuan: '慕愿',
			yb085_muyuan_info: '当你使用非装备牌指定其他角色为目标后,你可获得其一张牌,其摸一张牌.',
			yb085_cibie: '辞别',
			yb085_cibie_info: '你可以让使你脱离濒死状态的角色获得技能【慕愿】.限定技,出牌阶段,你可以失去全部体力.',
			//--------------------龚洁------------------//
			//-------------------田璐
			//-------------------
			//-------------------
			...
			//-------------------珂赛特
			yb100_lieshi: '烈誓',
			yb100_lieshi_info: '重置技,刷新列表为:["受到你造成的一点火焰伤害,废除一个随机装备栏","受到你造成的两点火焰伤害","受到你造成的三点火焰伤害,摸三张牌"].出牌阶段限一次,你可以选择一名其他角色,你令你们之一先选择列表其中一项执行,另一方执行列表中仍存的一项.',
			yb100_dianzhan: '点盏',
			yb100_dianzhan_info: '重置技,锁定技,刷新列表为:["横置自身展示手牌并重铸一种花色所有手牌","调整手牌至4张","展示手牌并弃置每种类型手牌各一张"].当你使用牌指定目标时,若此是你本回合首次指定其为目标,你横置自身并执行列表中的一项,若你不为目标,则令目标也执行此项.',
			yb100_huanyin: '还阴',
			yb100_huanyin_info: '锁定技,当你进入濒死状态时,你将【烈誓/点盏】刷新列表存在且现存列表中未仍存在的一项移至另一刷新列表,将手牌调整至与已发动选项数相同,你展示手牌,若花色各不相同,你回复体力至1.(已发动选项数,即刷新列表存在,但现存列表没有的选项)',
			ybsl_aocai: '傲才',
			ybsl_aocai2: '傲才',
			...
			sgsh_dayu: '大禹',
			sgsh_talei: '踏雷',
			//'sgsh_talei_info':'一名角色的回合开始时,你可令其进行一次判定,若结果为♠️️2~9,则该角色受到3点无来源雷电伤害.',
			sgsh_talei_info: '一名角色的回合开始时,你可令其进行一次闪电的判定.',
			sgsh_yunyuu: '孕育',
			sgsh_yunyuu_info: '一名角色的♥️️判定牌生效后,你可以摸一张牌.',
			sgsh_yuefeng: '乐风',
			sgsh_yuefeng_info: '结束阶段开始时,你可以展示牌堆顶三张牌,选择获得每种花色的牌各一张.',
			sgsh_zhisheng: '止声',
			...
			sgsh_cangling: '苍灵',
			sgsh_cangling_info: '出牌阶段结束时,若你未于本出牌阶段内使用牌指定过其他角色为目标,则你可以令一名任意角色增加一点体力上限,你回复一点体力.',
			sgsh_zongshui: '纵水',
			...
			sgsh_kunlun: '昆仑',
			sgsh_kunlun_info: '锁定技,当你成为♠️️牌的目标时,你摸两张牌,若你未受伤,你弃两张牌.',
			sgsh_huasheng: '化生',
		...
		dynamicTranslate: {
			...
			ybsl_luanming(player) {
				//鸾鸣
				if (player.storage.ybsl_luanming == true) return '转换技,每回合限一次,当你可以使用牌时,你可以弃置一黑一红共两张牌,:阴:视为使用其中的黑色牌并额外执行一次;<span class="bluetext">阳:视为使用其中的红色牌并额外执行一次.</span><br><span class=yellowtext>注意:此技能不能用于响应其他牌,更不能在别人濒死时用桃选择其为目标!</span>';
				return '转换技,每回合限一次,当你可以使用牌时,你可以弃置一黑一红共两张牌,:<span class="bluetext">阴:视为使用其中的黑色牌并额外执行一次;</span>阳:视为使用其中的红色牌并额外执行一次.<br><span class=yellowtext>注意:此技能不能用于响应其他牌,更不能在别人濒死时用桃选择其为目标!</span>';
			},
			yb001_minglun(player) {
				var str = '锁定技,回合开始时,你展示牌堆顶一张牌并放在武将牌上,至多放四张.根据<命轮>的花色,你视为拥有技能:<br>';
				var list = { spade: '♠️️:栖月', heart: '♥️️:旅心', club: '<br>♣️️:折叶', diamond: '♦️️:忆水' };
				for (var i in list) {
					var cards = player.getExpansions('yb001_minglun');
					for (var k of cards) {
						if (k.suit == i) list[i] = '<span class=YB_snowtext>' + list[i] + '</span>';
					}
					str += list[i];
					str += ';';
				}
			...
			yb004_tianqi(player) {
				//天祈
				if (!player.storage.yb004_shangyuan) {
					var str = '锁定技,当你对其他角色造成伤害后,你进行判定:若伤害不大于1,且结果为红色,你回复一点体力或摸一张牌;若伤害大于1,且结果为黑色,你失去一点体力并摸一张牌.当你受到伤害后,你进行判定,若结果为黑色,你摸x+1张牌,否则你回复x-1点体力(x为此次伤害值)';
			...
			yb006_boxue(player) {
				...
				if (player.storage.yb006_boxuex) {
					return '锁定技,当你使用非装备牌或成为非装备牌的目标时,若你:<br>①没有对应的记录,则你记录该牌名,此技能结束.<br>②有对应的记录,则你移除对应的记录,摸一张牌(若此牌的使用者不为目标,则改为摸二),此技能结束.';
				} else {
			...
			yb006_biaoshuai(player) {
				//表率
				if (player.storage.yb006_biaoshuaix) {
					return '主公技,每名其他忆势力角色每轮次各限一次.记录你回合内使用的第一张牌(覆盖上次记录).其他忆势力角色使用或打出与之同名的牌时,<span class=yellowtext>你可以摸一张牌,你可以令其摸一张牌.</span>';
				} else {
					return '主公技,每名其他忆势力角色每轮次各限一次.记录你回合内使用的第一张牌(覆盖上次记录).其他忆势力角色使用或打出与之同名的牌时,其可以令你摸一张牌,自己摸一张牌.';
				}
			},
			...
			yb016_juli(player) {
				...
				if (!player.storage.yb016_juli_add) return '当一名角色成为除其外的角色使用【杀】的目标时,若你至该角色的距离不大于' + info[1] + ',你可以重铸至多' + info[0] + '张牌,令此牌的使用者弃置一张牌,(该牌的类型须为你重铸的牌中包含的类型)否则此牌对你无效.';
				return '当一名角色成为除其外的角色使用【伤害牌】的目标时,若你至该角色的距离不大于' + info[1] + ',你可以重铸至多' + info[0] + '张牌,令此牌的使用者弃置一张牌,(该牌的类型须为你重铸的牌中包含的类型)否则此牌对你无效.';
			},
			yb033_shuhui(player) {
				//淑慧
				if (player.storage.yb033_shuhui == true) {
					return '回合开始时,你可以弃置一张手牌,并令一名角色回复或失去一点体力.<span class=yellowtext>你展示牌堆顶一张牌,将隅泣任意一个数字改为该数字,至多为当前最低的数字+2.</span>';
				} else {
					return '回合开始时,你可以弃置一张手牌,并令一名角色回复或失去一点体力.(追加描述:你展示牌堆顶一张牌,将隅泣任意一个数字改为该数字,至多为当前最低的数字+2)';
				}
			},
			yb033_yuqi(player) {
				var info = lib.skill.yb033_yuqi.getInfo(player);
				return '每回合限三次.当有角色受到伤害后,若你至其的距离不大于<span class=thundertext>' + info[0] + '</span>,则你可以观看牌堆顶的<span class=firetext>' + info[1] + '</span>张牌.你将其中至多<span class=greentext>' + info[2] + '</span>张牌交给受伤角色,可以获得剩余牌中的至多<span class=yellowtext>' + info[3] + '</span>张牌,并将其余牌以原顺序放回牌堆顶.(理论上所有具有颜色的数字至多为13,因为点数最大也才13)';
			},
			yb037_kexie(player) {
				//咳血
				var str = '锁定技,每当你弃置一张';
				...
				if (player.storage.yb037_kexie >= 2) str += '<span class=firetext>♥️️牌</span>';
				str += '时,你失去一点体力.';
				return str;
			},
			yb047_youhun(player) {
				if (player.storage.yb047_youhun == true) return '转换技,阴:你可以将X+Y张牌当作任意一张锦囊牌使用;<span class="bluetext">阳:你可以将X+Y张牌当作任意一张基本牌使用.</span>当此牌造成伤害后,你增加一点体力上限,Y计数+1.(X为本轮此技能使用次数且至少为0,Y初始为0,最低为0);每当你废除一个装备栏时,你令Y计数-1;'; //;③你持有的此技能改名为【迸射】
				return '转换技,<span class="bluetext">阴:你可以将X+Y张牌当作任意一张锦囊牌使用;</span>阳:你可以将X+Y张牌当作任意一张基本牌使用.当此牌造成伤害后,你增加一点体力上限,Y计数+1.(X为本轮此技能使用次数且至少为0,Y初始为0,最低为0);每当你废除一个装备栏时,你令Y计数-1;'; //,将技能改名为【迸射】
			},
			yb053_yinren(player) {
				// lib.translate.yb053_yinren=lib.skill.yb053_yinren.getname(player);
				// lib.translate.yb053_yinren_damage=lib.skill.yb053_yinren.getname(player);
				...
				return '锁定技,①当你受到伤害时,你需选择:弃置一张牌,或令此伤害+1;获得如下效果直至当前回合结束:②每个回合结束时,你选择回复两点体力或摸X+1张牌(X为你已损体力值且至多为3);③当你脱离濒死状态时,你令②效果变为常驻效果.'; //,将技能改名为【迸射】
			},
			yb069_wenhuan(player) {
				//温幻
				if (player.storage.yb069_wenhuan == true) return '转换技,阴,当有角色受到伤害后,你可以令其武将牌复位并令其摸一张牌.<span class="bluetext">阳,当有角色回复体力时,你可令其翻面,并令此次回复效果+1.</span>';
				return '转换技,<span class="bluetext">阴,当有角色受到伤害后,你可以令其武将牌复位并令其摸一张牌.</span>阳,当有角色回复体力时,你可令其翻面,并令此次回复效果+1.';
			},
			//071
			...
			yb100_lieshi(player) {
				...
				return str + '出牌阶段限一次,你可以选择一名其他角色,你令你们之一先选择列表其中一项执行,另一方执行列表中仍存的一项.(浅蓝色不在刷新列表中).';
			},
			yb100_dianzhan(player) {
				...
				return str + '当你使用牌指定目标时,若此是你本回合首次指定其为目标,你横置自身并执行列表中的一项,若你不为目标,则令目标也执行此项.';
			},
			// yb100_lieshi:'烈誓',
			// yb100_lieshi_info:'重置技,刷新列表为:["受到你造成的一点火焰伤害,废除一个随机装备栏","受到你造成的两点火焰伤害","受到你造成的三点火焰伤害,摸三张牌"].出牌阶段限一次,你可以选择一名其他角色,你令你们之一先选择列表其中一项执行,另一方执行列表中仍存的一项.',
			// yb100_dianzhan:'点盏',
			// yb100_dianzhan_info:'重置技,锁定技,刷新列表为:["横置自身展示手牌并重铸一种花色所有手牌","调整手牌至4张","展示手牌并弃置每种类型手牌各一张"].当你使用牌指定目标时,若此是你本回合首次指定其为目标,你横置自身并执行列表中的一项,令目标也执行此项.',
			// yb082_youhun:function(player){//单纯提供一句语音
			// 	if(player.storage.yb082_youhun==true) return '转换技,阴:你可以将X+Y张牌当作任意一张锦囊牌使用;<span class="bluetext">阳:你可以将X+Y张牌当作任意一张基本牌使用.</span>当此牌造成伤害后,你增加一点体力上限,Y计数+1.(X为本轮此技能使用次数且至少为0,Y初始为0,最低为0);每当你废除一个装备栏时,你令Y计数-1;';//;③你持有的此技能改名为【迸射】
			// 	return '转换技,<span class="bluetext">阴:你可以将X+Y张牌当作任意一张锦囊牌使用;</span>阳:你可以将X+Y张牌当作任意一张基本牌使用.当此牌造成伤害后,你增加一点体力上限,Y计数+1.(X为本轮此技能使用次数且至少为0,Y初始为0,最低为0);每当你废除一个装备栏时,你令Y计数-1;';//,将技能改名为【迸射】
			// },
		},
	};
	...
	for (var i in ybslj.character) {
		ybslj.character[i][4].push('die:ext:夜白神略/audio/die/' + i + '.mp3');
	}
	...
	lib.config.characters.add('ybslj');
