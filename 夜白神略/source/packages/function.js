...
};
{
  ...
  // }
}const characterIntro = function (name) {let str = '';if (lib.characterCopyright[name]) {//版权信息
    str += lib.characterCopyright[name];str += '<br>';}if (lib.characterCitetext[name]) {//上引文
    str += lib.characterCitetext[name];str += '<br>';}
