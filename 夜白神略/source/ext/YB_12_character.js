...
game.import('character', function (lib, game, ui, get, ai, _status) {
  ...
  const sgstrxs = {
    ...
    */
    ...
    skill: skill, //技能(必填) ……………………!…!!!【…？.!!？？？？…………
    card: card, translate: translate, //翻译(必填)
    dynamicTranslate: dynamicTranslate, characterSubstitute: { sgsxjxfzmnl_shichangshi: [['sgsxjxfzmnl_shichangshi_dead', ['YB_mjz:shichangshi_dead', 'die:shichangshi']]], sgsxjxfzmnl_scs_zhangrang: [['sgsxjxfzmnl_scs_zhangrang_dead', ['YB_mjz:scs_zhangrang_dead', 'die:shichangshi']]],
