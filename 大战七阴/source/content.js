...
export async function content(config, pack) {
	...
	lib.init.css('extension/大战七阴', 'extension');
	...
	lib.devil_characters.old_dc_list = ['xushao', 'puyuan', 'guozhao', 'dc_guansuo', 'dc_zhaoxiang', 'xin_lingtong', 're_liuzan'];
	lib.devil_characters.dc_list = ['caojinyu', 'wanglang', 'guanning', 're_sunyi', 'lvlingqi', 're_panshu', 'zhouyi', 're_nanhualaoxian', 'dc_liuba', 'dc_jiben', 'shen_jiangwei', 'shen_machao', 'tenggongzhu', 'caomao', 'zhangxuan', 'dc_zhouxuān', 'xuelingyun', 'shen_zhangfei', 'shen_zhangjiao', 'luyi', 'sunlingluan', 'wu_zhugeliang', 'wu_luxun', 'dc_xujing', 'yue_caiwenji', 'wu_guanyu', 'dc_sb_simayi', 'bailingyun', 'dc_sunchen', 'dc_liubei', 'dc_caocao', 'dc_sunquan', 'dc_sunce', 'dc_zhaoyun', 'dc_wuyi', 'chengui', 'star_caoren', 'dc_shen_huatuo', 'dc_liuye', 'zerong', 'yue_miheng', 'caoxian'];
	...
	lib.devil_characters.all_devil_list = [...lib.devil_characters.old_dc_list, ...lib.devil_characters.dc_list, ...lib.devil_characters.mobile_list, ...lib.devil_characters.ol_list, ...lib.devil_characters.other_list];
	if (lib.config.mode == 'brawl') {
		...
		const hell_characters = get7characters(Object.keys(lib.characterPack.大战七阴));
