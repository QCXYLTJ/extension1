...
const brawl = {
    ...
    intro: [
        ...
        '盟军默认拥有技能【祀邪】（准备阶段，你可以从随机三个技能中获得一个技能，若你的非【祀邪】技能数大于3，则你选择失去一个非【祀邪】的技能）',
        ...
        var pack = {
            ...
            skill: {
                _HuNv_revive: {
                    ...
                    filter(event, player) {
                        return player == game.HuNv && player.isDead() && (game.players.length == 1 || event.player.seatNum == 2);
                    },
                    forceDie: true,
                    direct: true,
                    lastDo: true,
            ...
            translate: {
                ...
                boss_qingnv3: '九尾狐',
                HuNv_sixie: '祀邪',
                HuNv_sixie_info: '准备阶段，你可以从随机三个技能中获得一个技能，若你的技能数超过三个，则你须选择失去一个技能。',
                HuNv_duomo: '堕魔',
                ...
                HuNv_duanwei: '断尾',
                HuNv_duanwei_info: '判定阶段开始时，若你的判定区有牌，则你可以弃置两张手牌，弃置你判定区的一张牌。',
            },
        };
    ...
    content: {
        ...
        chooseCharacterBefore() {
            ...
            for (var i of game.players) {
                ...
                i.seatNum = game.players.indexOf(i) + 1;
