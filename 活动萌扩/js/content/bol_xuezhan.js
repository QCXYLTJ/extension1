...
const brawl = {
    ...
    init() {
        ...
        lib.element.content.loseMaxHp = game.kongfunc;
        lib.element.content.gainMaxHp = game.kongfunc;
    ...
    content: {
        ...
        chooseCharacterBefore() {
            ...
            for (var target of game.players) {
                ...
                target.seatNum = game.players.indexOf(target) + 1;
                ...
                if (list.length == 1) {
                    ...
                    if (game.fanzhongNum[0] >= 2) game.over(game.me.identity == 'fan');
                        ...
                        for (var target of game.players.sortBySeat(game.zhu)) {
                            target.seatNum = game.players.sortBySeat(game.zhu).indexOf(target) + 1;
