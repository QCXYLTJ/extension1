...
const brawl = {
    ...
    init() {
        ...
        var translate = {
            ...
            fanZomble_xunmeng_info: '锁定技，你使用【杀】造成的伤害+1，若你的体力值大于1，你失去1点体力。',
            ...
            neiZomble: '尸化·内奸',
            neiZomble_shishi: '噬尸',
            neiZomble_shishi_info: '锁定技，当你令一名角色尸变或击杀一名角色后，你加1点体力上限并回复1点体力。',
            _zhu_tuizhi: '退治',
        };
            ...
            game.bilibili_wuhuang = {
                ...
                dieAfter2() {
                    ...
                    if (player.identity == 'zhu') {
                        next = game.createEvent('setNewZhu', false, _status.event.parent);
                        next.player = this;
                        next.forceDie = true;
                        ...
                        next = game.createEvent('setNewZomble', false, _status.event.parent);
                        next.player = this;
                        next.forceDie = true;
                        next.setContent(function () {
                            'step 0'
