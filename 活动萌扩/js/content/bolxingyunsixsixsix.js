...
const brawl = {
    ...
    intro: [
        '五人军争模式',
        '游戏中，每当有一名角色使用或打出一张点数为6的牌时，可从幸运牌堆中抽取一张卡牌，立即执行其效果。',
        '幸运牌结算完成后移出幸运牌堆，直到幸运牌堆最后一张牌被抽取后，将6张幸运牌重新洗混形成新的幸运牌堆。',
        '幸运牌堆：<br>' +
        '&nbsp&nbsp<img width="65" src="extension/活动萌扩/image/bolxingyun_tao.png">' +
        ' <img width="65" src="extension/活动萌扩/image/bolxingyun_tao.png">' +
        ' <img width="65" src="extension/活动萌扩/image/bolxingyun_wuzhong.png">' +
        ' <img width="65" src="extension/活动萌扩/image/bolxingyun_wuzhong.png">' +
        ' <img width="65" src="extension/活动萌扩/image/bolxingyun_zhuanyun.png">' +
        ' <img width="65" src="extension/活动萌扩/image/bolxingyun_tianqian.png">'
    ],
    showcase(init) {
    ...
    init() {
        ...
        lib.skill._bolxingyunsixsixsix = {
            ...
            filter(event, player) {
                return event.card && event.card.number == 6;
            },
            direct: true,
            priority: Infinity,
            content() {
