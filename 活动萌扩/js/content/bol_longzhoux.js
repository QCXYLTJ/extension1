...
const brawl = {
    name: '龙舟会战<br>2023',
    mode: 'identity',
    intro: ['本模式为复刻OL龙舟会战2023年版本，单将模式，禁用手气卡', '模式规则：本模式共分两关' + '<br>敌人数目：2/6（不同势力之间均为敌对关系，但会优先攻击玩家方）' + '<br>敌人初始等阶：第一关随机3，4阶，第二关随机3，4，5阶' + '<br>三关均通过后游戏胜利。', '牌堆替换：【酒】替换为【雄黄酒】，【五谷丰登】和【桃园结义】替换为【力争上游】，【无中生有】替换为【同舟共济】，【南蛮入侵】和【万箭齐发】替换为【逆水行舟】。', '关于选将：' + '<br>选将框中会随机挑选五张势力相同的武将牌供玩家选择，选将势力可在扩展页面自由选择' + '<br>此模式中神武将的势力和玩家选择的势力相同', '武将等阶特权（等阶可在扩展页面自由选择）：' + '<br>一阶：无特权' + '<br>二阶：初始手牌数+1' + '<br>三阶：初始手牌数+1，初始体力/体力上限+1，使用【杀】的额定次数+1' + '<br>四阶：初始手牌数+2，初始体力/体力上限+1，使用【杀】的额定次数+1' + '<br>五阶：初始手牌数+2，初始体力/体力上限+2，使用【杀】的额定次数+1，获得技能【重生】（仅玩家方获得，重生：限定技，当你处于濒死状态时，你可以弃置判定区内的所有牌，复原你的武将牌，摸五张牌，将体力回复至体力上限（至多为5））', '本模式中所有武将都拥有特殊的家族技能：' + '<br>魏·魏业：回合开始时，你可以弃置一张牌并指定一名敌方角色，该角色须弃置一张牌，否则你摸一张牌。' + '<br>蜀·蜀义：出牌阶段结束时，若你于此阶段使用【杀】次数不少于2，摸一张牌。' + '<br>吴·吴耀：回合结束时，若你的手牌数不等于你的体力值，则你摸一张牌。' + '<br>群·群心：锁定技，弃牌阶段开始时，若你的手牌数比体力值多2或更多，你本回合手牌上限+1；若你已损失体力值大于1，你手牌上限+1' + '<br>晋·晋势：回合开始时，你可以弃置一张牌，从牌堆中随机获得一张与此牌花色相同的牌。', '队友死亡后，会激活势力专属城池技能：' + '<br>魏·许昌：锁定技，当你受到伤害后，你摸一张牌。' + '<br>蜀·成都：锁定技，当你使用【杀】造成伤害后，你摸一张牌。' + '<br>吴·武昌：锁定技，当你使用装备牌时，你摸一张牌。' + '<br>群·邺城：锁定技，当你使用锦囊牌指定其他角色为目标后，你摸一张牌。' + '<br>晋·洛阳：锁定技，结束阶段，若你手牌中的花色数小于3，则你摸一张牌。', '击杀奖惩：击杀不同势力的角色和队友各摸一张牌；击杀队友的角色弃置所有牌。', '禁用将池：左慈，布骘，蔡文姬，大乔，徐晃，黄皓(OL)，灵雎，SP贾诩(OL)，司马师(手杀)，神貂蝉，神邓艾，标袁术(OL)', '2023年龙舟会战新机制：粽子' + '<br>①所有角色于游戏开始时获得2个“粽”标记，玩家方随机使用一张装备牌，所有角色每造成1点伤害获得1个“棕”标记，击杀其他角色可获得该角色的所有“棕”标记' + '<br>②每一整局龙舟会战会随机进行一个有关“棕”标记的全局效果' + '<br>·大快朵颐：使用锦囊牌时失去2个“棕”标记，摸一张牌。' + '<br>·五味俱全：造成伤害时失去4个“棕”标记，令此伤害+1。' + '<br>·回味无穷：使用【杀】造成伤害后失去2个“棕”标记，摸一张牌。' + '<br>·珠翠之珍：使用装备牌时失去1个“棕”标记，摸一张牌。' + '<br>·津津有味：使用【桃】回复体力后失去4个“棕”标记，回复1点体力。' + '<br>·珍馐美馔：摸牌阶段开始时失去所有“棕”标记，摸X张牌（X为移去的“棕”标记数的一半，向下取整）。' + '<br>·垂涎欲滴：结束阶段失去所有“棕”标记，摸X张牌（X为移去的“棕”标记数的一半，向下取整）。' + '<br>·酒足饭饱：①若你的“棕”标记数：不小于2，摸牌阶段多摸一张牌；不小于4，使用牌无距离限制；不小于6，使用【杀】的额定次数+1。②结束阶段，你失去X个“棕”标记（X为你的“棕”标记数，向下取整）'],
    init() {
        ...
        var pack = {
            ...
            translate: {
                ...
                LZ_chongsheng: '重生',
                LZ_chongsheng_info: '限定技，当你处于濒死状态时，你可以弃置判定区内的所有牌，复原你的武将牌，摸五张牌，将体力回复至体力上限（至多为5）。',
                _lz_zong_mark: '粽',
                lz_dakuaiduoyi: '大快朵颐',
                lz_wuweijuquan: '五味俱全',
        ...
        cardPile() {
            for (var i = 0; i < lib.card.list.length; i++) {
                switch (lib.card.list[i][2]) {
                    ...
                    case 'nanman':
                    case 'wanjian':
                        lib.card.list[i][2] = 'nishuixingzhou';
                        break;
                    case 'bingliang':
                    case 'lebu':
                    case 'shandian':
        ...
        chooseCharacterBefore() {
                ...
                if (
                    ...
                    if (list.length == 1) {
                        if (game.RElongzhou) game.over(true);
                            ...
                            if (fellow && game.me.seatNum > fellow.seatNum) fellow.dataset.position = 7;
                            while (
                                game.dead.filter(function (target) {
                                ...
                                if (target) {
                                    ...
                                    target.dataset.position = tempNum - game.me.seatNum;
                                    tempNum++;
                            ...
                            for (var num = 1; num <= 4; num++) {
                                var listx = [],
                                    identityxx = groupList[num <= 2 ? 1 : 2];
                                for (var name of _status.characterlist) {
                                    if (lib.character[name][1] == identityxx) listx.push(name);
                                }
                                var character = listx.randomGet();
                                _status.characterlist.remove(character);
                                var target = game.addFellow(tempNum - game.me.seatNum, character);
                            ...
                            while (![game.me, fellow].includes(current)) {
                                current.seatNum = current.previous.seatNum + 1;
                                current.setNickname(get.cnNumber(current.previous.seatNum + 1, true) + '号位');
                                current = current.next;
                            }
                            //新的开始
            ...
            game.chooseCharacter = function () {
                ...
                next.setContent(function () {
                    ...
                    var list = ['使用锦囊牌时失去2个“棕”标记，摸一张牌。', '造成伤害时失去4个“棕”标记，令此伤害+1。', '使用【杀】造成伤害后失去2个“棕”标记，摸一张牌。', '使用装备牌时失去1个“棕”标记，摸一张牌。', '使用【桃】回复体力后失去4个“棕”标记，回复1点体力。', '摸牌阶段开始时失去所有“棕”标记，摸X张牌（X为移去的“棕”标记数的一半，向下取整）。', '结束阶段失去所有“棕”标记，摸X张牌（X为移去的“棕”标记数的一半，向下取整）。', '①若你的“棕”标记数：不小于2，摸牌阶段多摸一张牌；不小于4，使用牌无距离限制；不小于6，使用【杀】的额定次数+1。②结束阶段，你失去X个“棕”标记（X为你的“棕”标记数，向下取整）'];
                    ...
                    for (var i of game.players) {
                        if (i.identity != game.me.identity) {
                            var character = _status.characterlist
                    ...
                    var getNum = function (name) {
                        ...
                        if (name == 'chunyuqiong')
                            num = 7.5; //淳于琼
                        else if (name == 'boss_zhaoyun')
                            num = 10; //高达一号
                        else if (name == 'jin_simashi')
                            num = 4; //晋司马师
                        else
                    ...
                    game.me
                        .chooseButton(createDialog, lib.config.singleControl ? 2 : 1, true)
                        .set('onfree', true)
