...
const brawl = {
    name: '龙舟会战',
    mode: 'identity',
    intro: ['本模式为复刻OL经典模式龙舟会战，单将模式，禁用手气卡', '模式规则：本模式共分三关' + '<br>敌人数目：2/4/6（不同势力之间均为敌对关系，但会优先攻击玩家方）' + '<br>敌人初始手牌数：4/5/5' + '<br>敌人初始体力/体力上限加成：0/1/1' + '<br>三关均通过后游戏胜利。', '牌堆替换：【桃】替换为【粽】，【酒】替换为【雄黄酒】，【五谷丰登】和【桃园结义】替换为【力争上游】，【无中生有】替换为【同舟共济】，【南蛮入侵】和【万箭齐发】替换为【逆水行舟】，【诸葛连弩】替换为【连弩】。', '关于选将：' + '<br>选将框中会随机挑选五张势力相同的武将牌供玩家选择，选将势力可在扩展页面自由选择' + '<br>此模式中神武将的势力和玩家选择的势力相同', '武将等阶特权（等阶可在扩展页面自由选择）：' + '<br>一阶：无特权' + '<br>二阶：初始手牌数+1' + '<br>三阶：初始手牌数+1，初始体力/体力上限+1' + '<br>四阶：初始手牌数+2，初始体力/体力上限+1' + '<br>五阶：初始手牌数+2，初始体力/体力上限+2，获得技能【艾叶】（艾叶：限定技，当你处于濒死状态时，你可以弃置所有牌，复原你的武将牌，摸两张牌，将体力回复至2点）', '本模式中所有武将都拥有特殊的家族技能：' + '<br>魏·魏业：回合开始时，你可以弃置一张牌并指定一名敌方角色，该角色须弃置一张牌，否则你摸一张牌。' + '<br>蜀·蜀义：你使用【杀】上限+1；出牌阶段结束时，若你于此阶段使用【杀】次数不少于2，摸一张牌。' + '<br>吴·吴耀：回合结束时，若你的手牌数不等于你的体力值，则你摸一张牌。' + '<br>群·群心：锁定技，弃牌阶段开始时，若你的手牌数比体力值多2或更多，你本回合手牌上限+1；若你已损失体力值大于1，你手牌上限+1' + '<br>晋·晋势：摸牌阶段结束时，你可以展示你于此阶段内因摸牌而获得的牌。若这些牌的花色均不同，则你摸一张牌。', '队友死亡后，会激活势力专属城池技能：' + '<br>魏·许昌：锁定技，当你受到伤害后，你摸一张牌。' + '<br>蜀·成都：锁定技，当你使用【杀】造成伤害后，你摸一张牌。' + '<br>吴·武昌：锁定技，当你使用装备牌时，你摸一张牌。' + '<br>群·邺城：锁定技，当你使用锦囊牌指定其他角色为目标后，你摸一张牌。' + '<br>晋·洛阳：锁定技，结束阶段，若你手牌中的花色数小于3，则你摸一张牌。', '击杀奖惩：击杀不同势力的角色和队友各摸一张牌；击杀队友的角色弃置所有牌。', '禁用将池：左慈，布骘，蔡文姬，大乔，徐晃，黄皓，灵雎，SP贾诩(OL)，司马师(手杀)，神貂蝉，神邓艾，标袁术(OL)'],
    init() {
        ...
        var pack = {
            ...
            translate: {
                ...
                LZ_aiye: '艾叶',
                LZ_aiye_info: '限定技，当你处于濒死状态时，你可以弃置所有牌，复原你的武将牌，摸两张牌，将体力回复至2点。',
                liannu: '连弩',
                liannu_skill: '连弩',
                ...
                if (
                    ...
                    if (list.length == 1) {
                        if (game.statusNum == 3) game.over(true);
                            ...
                            var tempNum = 3;
                            if (fellow && game.me.seatNum > fellow.seatNum) fellow.dataset.position = game.statusNum * 2 + 1;
                            while (
