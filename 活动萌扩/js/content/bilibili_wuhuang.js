...
const brawl = {
    ...
    intro: [
        ...
        '双方选择一至两名武将作为自己的武将牌，进行1v1对决，双将体力上限和体力值均为和-3',
            ...
            game.bilibili_wuhuang = {
                ...
                dieAfter2() {
                    ...
                    if (target == game.me || _status.characterMap[game.me.enemy.identity].length) {
                        next = game.createEvent('replacePlayerSingle', false, _status.event.parent);
                        next.player = this;
                        next.forceDie = true;
                        ...
                        next = game.createEvent('challengeWuHuang', false, _status.event.parent);
                        next.player = game.me;
                        next.target = target;
                        next.setContent(function () {
                            'step 0'
