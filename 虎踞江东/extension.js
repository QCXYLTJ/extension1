          ...
          skill: {
              ...
              ai: {
                result: {
                  target(player, target, card) {
                    if (player.hp <= 1 && player.countCards('h', 'shan') && player.countCards('h') <= 2) return 0;
            ...
            心忆: {
              ...
              content() {
                ...
                if (player.identity != 'zhu') fellow.identity = player.identity;else
                ...
                if (player.identity != 'zhu') fellow1.identity = player.identity;else
              ...
              ai: {
                ...
                result: {
                  player(player) {
                    ...
                    if (player.hp >= 3) return num - 2;else
                    return num - 1;
                  }
                }
              }
            ...
            夺刀: {
              ...
              content() {
                ...
                for (var i = 0; i < ui.discardPile.childNodes.length; i++) {
                  ...
                  if (get.subtype(current) != 'equip1') continue;else
                  {
                    card3 = current;
                    break;
                  }
            ...
            zhugejin明哲: {
              ...
              content() {
                player.draw(2);
                if (player == _status.currentPhase) lib.skill.zhugejin明哲.usable = 3;else
                if (lib.skill.zhugejin明哲.usable) delete lib.skill.zhugejin明哲.usable;
              },
              ai: {
                threaten: 0.7
              }
            ...
            过论: {
              ...
              content() {
                ...
                player.chooseCard('he', true).ai = function (card) {
                  ...
                  if (card.number < numt) return 20 - get.value(card);else
                  if (card.number == numt) return 15 - get.value(card);
              ...
              ai: {
                ...
                result: {
                  target(player, target) {
                    ...
                    var players = game.filterPlayer();
                    for (var i = 0; i < players.length; i++) {
                      if (get.attitude(player, players[i]) > 0) list1.push(players[i]);else
                      if (get.attitude(player, players[i]) < 0) list2.push(players[i]);
                    }
            ...
            戮嗜: {
              ...
              subSkill: {
                begin: {
                  ...
                  content() {
                    'step 0';
                    if (trigger.player.storage.sunchenlushi > 1) trigger.player.storage.sunchenlushi--;else
                    {
            ...
            除害: {
              ...
              content() {
                ...
                if (result.targets?.length) {
                  ...
                  for (var i = 0; i < ui.discardPile.childNodes.length; i++) {
                    var current = ui.discardPile.childNodes[i];
                    if (get.type(current) != 'basic') continue;else
                    {
                      card3 = current;
                      break;
                    }
                  ...
                  for (var i = 0; i < ui.discardPile.childNodes.length; i++) {
                    var current = ui.discardPile.childNodes[i];
                    if (get.type(current, 'trick') != 'trick') continue;else
                    {
                      card4 = current;
                      break;
                    }
                  ...
                  for (var i = 0; i < ui.discardPile.childNodes.length; i++) {
                    var current = ui.discardPile.childNodes[i];
                    if (get.type(current) != 'equip') continue;else
                    {
                      card5 = current;
                      break;
                    }
                ...
                'step 2';
                if (result.bool) {
                  if (event.card0) player.gain(game.createCard(event.card0), 'gain2');else
                  player.gain(game.createCard(event.card3), 'gain2');
                  if (event.card1) player.gain(game.createCard(event.card1), 'gain2');else
                  player.gain(game.createCard(event.card4), 'gain2');
                  if (event.card2) player.gain(game.createCard(event.card2), 'gain2');else
                  player.gain(game.createCard(event.card5), 'gain2');
                }
              }
            },
            合击: {
              ...
              content() {
                ...
                for (var i = 0; i < ui.discardPile.childNodes.length; i++) {
                  var current = ui.discardPile.childNodes[i];
                  if (get.color(current) != 'red') continue;else
                  {
                    card1 = current;
                    break;
                  }
                ...
                'step 1';
                if (event.card0) player.gain(game.createCard(event.card0), 'gain2');else
                player.gain(game.createCard(event.card1), 'gain2');
                'step 2';
            ...
            安政: {
              ...
              content() {
                ...
                if (result.cards?.length) {
                  ...
                  if (get.type(card, false) == 'delay') trigger.player.addJudge(card);else
            ...
            固谏: {
              ...
              content() {
                ...
                'step 1';
                var num = event.target.countCards('h', function (card) {
                  return get.type(card) == 'equip';
                });
            ...
            不屈mzt: {
              ...
              content() {
                ...
                for (var i = 0; i < player.storage.不屈mzt.length - 1; i++) {
                  if (event.card.number && event.card.number == player.storage.不屈mzt[i].number) return;else
                  event.finish();
                }
            ...
            忠壮: {
              ...
              content() {
                if (player.hp < 3) trigger.num += 2;else
            ...
            quanjipi: {
              ...
              check(event, player) {
                ...
                if (att > 0 && event.player.countCards('j', 'lebu') && event.player.countCards('h') > event.player.hp + 1) return true;
                return false;
              },
              logTarget: 'player',
              filter(event, player) {
            ...
            huangyinpi: {
              ...
              content() {
                ...
                player.showHandcards();
                'step 1';
                if (player.countCards('h', { color: 'black' }) >= player.countCards('h', { color: 'red' })) player.useCard({ name: 'jiu' }, player);
              },
              ai: {
                order: 10,
                result: {
                  player(player) {
                    ...
                    if (player.countCards('h', { color: 'black' }) >= player.countCards('h', { color: 'red' })) return 3;
                    return 0;
                  }
                }
              }
            ...
            cangji青云鸢飞: {
              ...
              forced: true,
              filter(event, player) {
                return event.player.countCards('h', { type: 'basic' }) > 0;
              },
              content() {
                'step 0';
                trigger.player.
                chooseToDiscard('是否发动【藏机】？', [1, trigger.player.countCards('h', { type: 'basic' })], 'h', function (card) {
                  return get.type(card) == 'basic';
                }).
                set('ai', function (card) {
                ...
                dialog() {
                  ...
                  for (var i = 0; i < lib.inpile.length; i++) {
                    ...
                    if (name == 'sha') {
                      ...
                      list.push(['基本', '', 'sha', 'fire']);
                      list.push(['基本', '', 'sha', 'thunder']);
                    } else if (get.type(name) == 'trick') list.push(['锦囊', '', name]);else
                    if (get.type(name) == 'basic') list.push(['基本', '', name]);else
                    if (get.type(name) == 'delay') list.push(['延时锦囊', '', name]);
                  }
            ...
            狼枭: {
              ...
              async content(event, trigger, player) {
                ...
                player.chooseTarget(get.prompt('狼枭')).set('ai', (target) => -get.attitude(player, target)).forResult();
                if (result.targets?.length) {
                  var t = result.targets[0];
            ...
            暴征董卓: {
              ...
              content() {
                ...
                if (player.identity != 'zhu') fellow2.identity = player.identity;else
                ...
                if (player.identity != 'zhu') fellow3.identity = player.identity;else
                fellow3.identity = 'zhong';
                ...
                if (player.identity != 'zhu') fellow4.identity = player.identity;else
                fellow4.identity = 'zhong';
                ...
                if (player.identity != 'zhu') fellow5.identity = player.identity;else
                fellow5.identity = 'zhong';
                ...
                if (player.identity != 'zhu') fellow6.identity = player.identity;else
                fellow6.identity = 'zhong';
                ...
                if (player.identity != 'zhu') fellow7.identity = player.identity;else
                fellow7.identity = 'zhong';
                ...
                if (player.identity != 'zhu') fellow8.identity = player.identity;else
                fellow8.identity = 'zhong';
                ...
                if (player.identity != 'zhu') fellow9.identity = player.identity;else
                fellow9.identity = 'zhong';
                ...
                if (player.identity != 'zhu') fellow10.identity = player.identity;else
                fellow10.identity = 'zhong';
                ...
                if (player.identity != 'zhu') fellow11.identity = player.identity;else
                fellow11.identity = 'zhong';
                ...
                if (player.identity != 'zhu') fellow12.identity = player.identity;else
                fellow12.identity = 'zhong';
                ...
                if (player.identity != 'zhu') fellow13.identity = player.identity;else
                fellow13.identity = 'zhong';
            ...
            福龙: {
              ...
              async content(event, trigger, player) {
                //QQQ
                await game.mp40('fulong福龙');const result = await
                player.chooseTarget(get.prompt('福龙'), [1, 4], true).set('ai', (target) => get.attitude(player, target)).forResult();
                var Q = result.targets.slice();
                for (var i of Q) {const result = await
                  i.chooseButton(['从游戏外获得所选择牌名相同的牌', player.getCards('he')], [0, 2]).set('ai', (button) => get.value(button.link)).forResult();
                  if (result.links?.length) {
            ...
            水龙: {
              ...
              async content(event, trigger, player) {
                //QQQ
                await game.mp40('shuilong水龙');const result = await
                player.chooseTarget(get.prompt('水龙'), [1, 4], true).set('ai', (target) => -get.attitude(player, target)).forResult();
                if (result.targets?.length) {
            ...
            火龙: {
              ...
              async content(event, trigger, player) {
                //QQQ
                await game.mp40('huolong火龙');const result = await
                player.chooseTarget(get.prompt('火龙'), [1, 4], true).set('ai', (target) => get.attitude(player, target)).forResult();
                if (result.targets?.length) {
                  await result.targets.forEach((i) => i.gain([game.createCard({ name: 'sha', nature: 'fire' }), game.createCard('huogong'), game.createCard('huoshaolianying')], 'draw'));const result = await
                  player.chooseControl('弃两张红色牌', '受到你的一点火焰伤害').forResult();const result1 = await
                  player.chooseTarget(get.prompt('火龙'), [1, 4], true).set('ai', (target) => -get.attitude(player, target)).forResult();
            ...
            re_rende: {
              ...
              check(card) {
                ...
                if (player.hp == player.maxHp || player.storage.rerende < 0 || player.countCards('h') <= 1) {
                  for (var i = 0; i < game.players.length; i++) {
                    if (game.players[i].getCards('s').includes('haoshi') && !game.players[i].isTurnedOver() && !game.players[i].countCards('j', 'lebu') && get.attitude(player, game.players[i]) >= 3 && get.attitude(game.players[i], player) >= 3) {
              ...
              ai: {
                ...
                result: {
                  target(player, target) {
                    ...
                    if (target.countCards('j', 'lebu')) return 0;
                    var nh = target.countCards('h');
            ...
            曹婴伏间: {
              ...
              async content(event, trigger, player) {
                //QQQ
                const result = await player.chooseTarget('观看一名其他角色的手牌,你可以获得其中至多两张牌,并对其造成一点伤害', (card, player, target) => player != target).set('ai', (target) => target.isEnemiesOf(player)).forResult();
                if (result.targets?.length) {
                  var Q = result.targets[0];
                  if (Q.countCards('h')) {const result = await
                    player.chooseButton(['获得其中至多两张牌', Q.getCards('h')], [1, 2]).set('ai', (button) => get.value(button.link)).forResult();
                    if (result.links?.length) {
                  ...
                  }))
                  {
                    switch (button.link[2]) {
                      ...
                      case 'sha':
                        ...
                        if (button.link[3] == 'fire') return 2.92;else
                        return 2.9;
                    }
                  }
                  return 0;
            ...
            占梦: {
              ...
              async content(event, trigger, player) {
                //QQQ
                const result = await player.chooseTarget(get.prompt('占梦')).set('ai', (target) => -get.attitude(player, target)).forResult();
                if (result.targets?.length) {
                  var Q = result.targets[0];
                  if (Q.countCards('he')) await player.gainPlayerCard(Q, 'he', true);
                  if (player.countCards('he')) {const result = await
                    player.chooseCard('选择1张牌置于牌堆顶', 1, true, 'he').forResult();
                    if (result.cards?.length) {
                  ...
                  Q.judge().forResult();
                  if (result.color == 'black') Q.loseHp();else
                  Q.recover();
                }
              }
            },
            解卜: {
              ...
              async content(event, trigger, player) {
                //QQQ
                const result = await player.chooseTarget(get.prompt('解卜')).set('ai', (target) => -get.attitude(player, target)).forResult();
                if (result.targets?.length) {
                  var Q = result.targets[0];
                  if (Q.countCards('he')) await player.gainPlayerCard(Q, 'he', true);
                  if (player.countCards('he')) {const result = await
